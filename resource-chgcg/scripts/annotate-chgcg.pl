...
#?? is headline treated differently in English?
  s/^\((IP |IP-HLN |IP-IMP |IP-Q |IP-IJ |UCP |CP )/\(V /;
  s/^\((NP-HLN |NP )/\(N /;
  s/^\((PP-ADV )/\(R-bV /;
  #s/^\((CP-Q )/\(K /;
  s/^\((CP-Q )/\(V /;
...
#  
  ...
  while ( $_ =~ /\^/ ) {
    ...
    if (
        debug($step, ".. $_") ||
	#PRN
#	s/\^([^ ]*) +<[^ ]* +([^>]*)> +<PRN +(\[PU[^\]]*\]) \[(N[^ ]*)([^>]*)\]>(.*)\^/\^\1 <\1 \2> <N \3 \[\4\5\]>\6\^/&&($j=prn1)||
#	s/\^([^ ]*) +<[^ ]* +([^>]*)> +<PRN +(\[PU[^\]]*\]) \[(V[^ ]*)([^>]*)\]>(.*)\^/\^\1 <\1 \2> <V-aN \3 \[\4\5\]>\6\^/&&($j=prn2)||
	s/\^([^ ]*) +<[^ ]* +([^>]*)> +<PRN +(\[PU[^\]]*\]) \[(N[^ ]*)([^>]*)\]>\^/\^\1 <\1 \2> <N \3 \[\4\5\]>\^/&&($j=prn1)||
	s/\^([^ ]*) +<[^ ]* +([^>]*)> +<PRN +(\[PU[^\]]*\]) \[(V[^ ]*)([^>]*)\]>\^/\^\1 <\1 \2> <V-aN \3 \[\4\5\]>\^/&&($j=prn2)||
 	s/\^(V|V-aN) +(<ADVP[^>]*>) +(<FLR \[SP 的话\]>) +(.*)\^/\^\1 <R-bV \2 \3> <\1 \4>\^/&&($j=893)||
 	#s/\^(V|V-aN) +(.*) +(<FLR [^>]*>) +(.*)\^/\^\1 <R-bV \2 \3> <\1 \4>\^/&&($j=893)||
	s/\^(R-bV) +<(PP[^ ]*|ADVP|LCP-TMP) +([^>]*)> +<FLR +([^>]*)>\^/\^\1 <R-bV \3> <R-bV-a{R-bV} \4>\^/&&($j=894)||
	s/\^(R-bV) +<NP[^ ]* +([^>]*)> +<FLR +([^>]*)>\^/\^\1 <N \2> <R-bV-aN \3>\^/&&($j=894)||

	#RNR

	s/\^(V-aN-gN) +<VP +([^>]*)> <NP[^ ]* +([^>]*)>\^/\^\1 <V-aN-gN \2> <N \3>\^/&&($j=rnr4)||

	s/\^(V[^ ]*) +<(VP +[^>]*)\[(NP[^ ]*) +(\[-NONE- \*RNR\*-)(\d+)([^>]*)> +(<CC +[^>]*>|<PU +[^>]*>) +<(VP +[^>]*)(\[\3-\5 [^>]*)>\^/<\1 [VP [\2\[\3 \4\5\6] \7 [\8\[\3 \4\5\6]] \9>/&&($j=rnr1)||
	s/\^(V[^ ]*) +<VP +(\[VV[^\]]*\]) \[(IP-OBJ[^ ]*) +(\[-NONE- \*RNR\*-)(\d+)([^>]*)> +(<CC +[^>]*>|<PU +[^>]*>) +<VP +(\[VV[^\]]*\]) (\[\3-\5 [^>]*)>\^/<\1 [VP [VP \2 \7 \8] \9]>/&&($j=rnr1)||
	s/\^(V[^ ]*) +<VP +(\[VV[^\]]*\]) \[(NP-OBJ[^ ]*) +(\[-NONE- \*RNR\*-)(\d+)([^>]*)> +<VP +(\[VV[^\]]*\]) (\[\3-\5 [^>]*)>\^/<\1 [VP [VP \2 \7] \8]>/&&($j=rnr1)||
	...
	s/\^(Q-bN|Q) +<(QP +[^>]*)\[(CLP[^ ]*) +(\[-NONE- \*RNR\*-)(\d+)([^>]*)> +<(QP[^ ]* +[^>]*)(\[\3-\5 [^>]*)>\^/<\1 [QP [\2\[\3 \4\5\6] [\7\[\3 \4\5\6]] \8>/&&($j=rnr5)||
	...
	#correcting nonexsiting gapping structure
	...
	#V (IP..)...(PU...) --> S-fIP(V..)(PU... )
	s/\^(V) +(<LCP[^ ]* [^>]*>) (.*)\^/\^V <R-bV \2> <\1 \3>\^/&&($j=927)||

	s/\^(R-bV) +<V ([^>]*)>\^/\^\1 <V \2>\^/&&($j=928)||
	s/\^(R-bV) +<V[^ ]* ([^>]*)>\^/\^\1 <V-aN \2>\^/&&($j=928)||
	...
	s/\^(V-aN) +(<CC +[^>]*>) +(<VA[^>]*>) +(<CC[^>]*>)(.*)\^/\^\1 <\1-d{\1} \2> <\1 \3 \4\5>\^/&&($j=964)||
	s/\^(V-aN-d{V-aN}) +<CC +([^>]*)>\^/<\1 \2>/&&($j=965)||
	s/\^(V) +(<IP +[^>]*>) +(<PU[^>]*>) +(<PP[^ ]* +[^>]*>)\^/\^\1 <\1 \2 \3> <R-bV \4>\^/&&($j=541)||

	s/\^(V) +<(IP +[^>]*)> +(<PU[^>]*>) (.*)\^/\^\1 <\1 [\2]> <V-cV \3 \4>\^/&&($j=14)||
	s/\^(V) +(<NP +[^>]*>) +(<PU[^>]*>) +(<IP[^>]*>) +(<PU[^>]*>) +(<PU 、>)(.*)\^/\^\1 <\1 \2 \3 \4 \5> <\1-cV \6\7>\^/&&($j=950)||
	s/\^(V) +(<NP +[^>]*>|<DP +[^>]*>) +(<PU[^>]*>) +(<IP[^>]*>)(.*)\^/\^\1 <R-bV \2> <\1 \3 \4\5>\^/&&($j=951)||
	s/\^(V) +<(IP +[^>]*)> +(<IP[^>]*>)(.*)\^/\^\1 <\1 [\2]> <V-cV \[\1 \3\4\]>\^/&&($j=355)||
	...
	s/\^(V) +<IP +([^>]*)> +<ETC +([^>]*)>\^/\^\1 <\1 \2> <V-cV \3>\^/&&($j=557)||

	s/\^(V) +<IP[^ ]* +([^>]*)> +(<IP[^ ]* +[^>]*>)(.*)\^/\^\1 <\1 \2> <V-cV \3\4>\^/&&($j=343)||
	#PP-DIR as coordinated V-aN
	s/\^(V-aN) +<PP-DIR +([^>]*)> +<PP-DIR +([^>]*)>\^/\^\1 <\1 \2> <\1-c{\1} \[\1 \3]>\^/&&($j=vcor1)||
	s/\^(N) +<PP-DIR +([^>]*)> +<PP-DIR +([^>]*)>\^/\^\1 <\1 \2> <N-cN \[\1 \3]>\^/&&($j=vcor1)||
	s/\^(V-aN) +<(P|PP) +([^>]*)> +<QP +([^>]*)>\^/\^\1 <R-bV \3> <\1 \[Q \4]>\^/&&($j=490)||
	s/\^(N) +<(P[^ ]*|PP[^ ]*) +([^>]*)> +<NP +([^>]*)>\^/\^\1 <R-bV \3> <\1 \4>\^/&&($j=496)||
#	s/\^(N) +<(DP) +([^>]*)> +(<CP +[^>]*DEC[^>]*>)(.*)\^/\^\1 <A-bN \3> <\1 \4\5>\^/&&($j=964)||
	s/\^(V-aN) +<(PP[^ ]*|DFL|AD) +([^>]*)>\^/<\1 \3>/&&($j=491)||
	s/\^(V-c{V}|V-cV) +<IP +([^>]*)>\^/\^\1 <V \2>\^/&&($j=344)||
	s/\^(V) +<CP +([^>]*)> +(<PU[^>]*>) +(<CP +[^>]*>)(.*)\^/\^\1 <\1 \2> <V-cV \3 \4\5>\^/&&($j=407)||
	s/\^(V-gN[^ ]*) +<(IP[^ ]*|CP[^ ]*) +([^>]*)> +(<PU[^>]*>) +(<IP +[^>]*>)(.*)\^/\^\1 <\1 \3> <\1-c{\1} \4 \5\6>\^/&&($j=413)||
	s/\^(V) +<(IP[^ ]*|CP[^ ]*) +([^>]*)> +(<PU[^>]*>) +(<IP +[^>]*>)(.*)\^/\^\1 <\1 \3> <V-cV \4 \5\6>\^/&&($j=413)||
	#delete empty subject
	s/\^(V) +<(NP[^ ]*SBJ +\[-NONE- \*pro\*[^>]*)> +<VP +([^>]*)>\^/\^\1 <V-aN \3>\^/&&($j=149)||
	#V --> N V-aN
	s/\^(V) +<NP-[^ ]*TPC +([^>]*)> +<VP (\[NP-SBJ[^>]*)>\^/\^\1 <N \2> <V-gN-fTPC \3>\^/&&($j=942)||
	...
	s/\^(V) +(<QP-SBJ \[-NONE-[^>]*>|<NP-SBJ \[-NONE-[^>]*>|<QP-SBJ \[NP \[-NONE- [^ ]*\]\]>) (.*)\^/\^\1 <V-aN \3>\^/&&($j=162)||
	s/\^([^ ]*) +(<QP-SBJ \[-NONE-[^>]*>|<QP-SBJ \[NP \[-NONE- [^ ]*\]\]>|<NP-SBJ \[-NONE-[^>]*>) (<VP [^>]*>)\^/\^\1 <V \[V-aN  \3\]>\^/&&($j=162)||
	s/\^(V) +(<QP-SBJ[^>]*>) (.*)\^/\^\1 <N \2> <V-aN \3>\^/&&($j=162)||
        s/\^(V|V-gN) +<(IP-SBJ)([^>]*)> (.*)\^/\^\1 <N [\2\3]> <V-aN \4>\^/&&($j=3)||
	#propogation of V-gN
	s/\^(V-gN) +(<NP[^ ]*-SBJ \[-NONE- \*T\*[^>]*>) +(.*)\^/\^\1 <V-aN \3>\^/&&($j=186)||
	s/\^(V-gN) +(<VV +[^>]*>) +(<NP[^ ]*-OBJ \[-NONE- \*T\*[^>]*>)\^/\^\1 <V-aN-bN \2>\^/&&($j=858)||
	s/\^(V-g{R-bV}) +<NP[^ ]*-SBJ +([^>]*)> +(.*)\^/\^\1 <N \2> <V-aN-g{R-bV} \3>\^/&&($j=260)||
	s/\^(V-aN-g{R-bV}) +<PP +\[-NONE-[^>]*> +<VP +([^>]*)>\^/\^\1 <V-aN \2>\^/&&($j=249)||
	s/\^(V-gN) +(<IP[^>]*\[-NONE- \*T\*[^>]*>) +(.*)(<IP[^>]*\[-NONE- \*T\*[^>]*>)\^/\^\1 <\1 \2> <\1 \3\4>\^/&&($j=815)||

	#s/\^(V-gN) +<(NP[^ ]*-SBJ)([^>]*)> +(.*)\^/\^\1 <N\3> <V-aN-gN \4>\^/&&($j=61)||
        s/\^(V-aN-gN) +<(VP[^ ]*|VV|VSB|VRD|VCD|VE) +([^>]*)> +(<NP[^ ]*-OBJ[^ ]* \[-NONE- \*[^>]*>|<NP [^>]*-NONE- \*[^>]*>)\^/\^\1 <V-aN-bN \3>\^/&&($j=187)||
        s/\^(V-aN-gN) +(<VP[^ ]* +[^>]*\*RNR\*[^>]*>) +(<PU[^>]*>) +(<VP[^ ]* +[^>]*-NONE- \*T\*[^>]*>)\^/\^\1 <V-aN-bN \2 \3 \4>\^/&&($j=614)||

        s/\^(V-aN-gN) +(<VV +[^>]*>) +(<AD +[^>]*>) +(<VV +[^>]*>) +(<NP[^ ]*-OBJ \[-NONE- \*[^>]*>)\^/\^\1 <V-aN-bN \2 \3 \4>\^/&&($j=465)||
        s/\^(V-aN-gN) +(<VV +[^>]*>) +(<VV +[^>]*>) +(<NP[^ ]*-OBJ \[-NONE- \*[^>]*>)\^/\^\1 <V-aN-bN \2 \3>\^/&&($j=465)||
        s/\^(V-aN-gN) +(<VV +[^>]*>) +<IP[^ ]*-OBJ (\[NP-SBJ \[-NONE- \*PRO\*\]\][^>]* \[-NONE- \*T[^>]*)>\^/\^\1 <V-aN-b{V-aN} \2> <V-aN-gN \3>\^/&&($j=930)||        
	s/\^(V-aN-gN) +(<VV +[^>]*>) +<IP[^ ]*-OBJ (\[NP-SBJ \[-NONE- \*pro\*\]\][^>]* \[-NONE- \*T[^>]*)>\^/\^\1 <V-aN-b{V-aN} \2> <V-aN-gN \3>\^/&&($j=930)||
	s/\^(V-aN-gN) +(<VV +[^>]*>) +<IP[^ ]*-OBJ (\[NP-SBJ \[-NONE- \*T\*-\d\]\][^>]*)>\^/\^\1 <V-aN-bV \2> <V-gN \3>\^/&&($j=931)||
        s/\^(V-aN-gN) +(<VV +[^>]*>) +<IP[^ ]*-OBJ ([^>]*\[NP-OBJ \[-NONE- \*T[^>]*)>\^/\^\1 <V-aN-bV \2> <V-gN \3>\^/&&($j=932)||
        s/\^(V-aN-gN) +(<VV +[^>]*>) +<IP[^ ]*-OBJ ([^>]*\[-NONE- \*T[^>]*)>\^/\^\1 <V-aN-b{V-aN}-gN \2> <V-aN \3>\^/&&($j=547)||
	...
	s/\^(V-aN-bN) +<VRD +([^>]*)> +(<NP[^ ]*-OBJ +\[-NONE- \*RNR\*[^>]*>|<NP[^ ]*-OBJ[^ ]* +\[-NONE- \*T\*[^>]*>)\^/\^\1 <\1 \2>\^/&&($j=515)||
	s/\^(V-aN-bN) +(<VV +[^>]*>|<VRD[^>]*>) +(<NP[^ ]*-IO +[^>]*>)\^/\^\1 <V-aN-bN-bN \2> <N \3>\^/&&($j=431)||
	s/\^(V-aN-bN) +(<VV +[^>]*>) +(<AS +[^>]*>) +(<NP[^ ]* +[^>]*>)\^/\^\1 <V-aN-bN-bN \2 \3> <N \4>\^/&&($j=438)||
	s/\^(V-aN-bN) +(<VV +[^>]*>) +(<AS +[^>]*>) +(<VV[^ ]* +[^>]*>)\^/\^\1 <\1 \2 \3> <\1-c{\1} \4>\^/&&($j=822)||
	s/\^(V-aN-bN-bN) +<VV +([^>]*)> +<VV +(给)>\^/\^\1 <V-aN-bN \2> <V-aN-bN-bN-a{V-aN-bN} \3>\^/&&($j=498)||
	#problematic?
	s/\^(V-gN) +(<QP-SBJ[^>]*>) +<VP([^>]*\*T\*[^>]*)>\^/\^\1 <N \2> <V-aN-gN\3>\^/&&($j=208)||
        s/\^(V-aN-g{A-bN}) +(<VP[^ ]* +[^>]*>|<VV +[^>]*>|<VE +[^>]*>) +(<NP-OBJ \[NP \[CP[^>]*-NONE-[^>]*>) +<NP-EXT \[-NONE- \*T\*[^>]*>\^/\^\1 <V-aN \2 \3>\^/&&($j=2091)||
        s/\^(V-aN-g{A-bN}) +<(VP[^ ]*|VV|VE) +([^>]*)> +<NP-OBJ[^>]*-NONE-[^>]*> +<NP-EXT \[-NONE- \*T\*[^>]*>\^/\^\1 <V-aN \[V-aN-bN \3\]>\^/&&($j=2091)||
	...
	s/\^(R-bV) +<CC +([^>]*)> +(<PP +[^>]*>.*)\^/\^\1 <R-bV-d{R-bV} \2> <\1 \3>\^/&&($j=902)||
	s/\^(R-bV) +<QP[^ ]* +([^>]*)>\^/\^\1 <Q \2>\^/&&($j=903)||
	s/\^(R-bV) +(<QP[^ ]* +[^>]*> +.* +<NP[^ ]* +[^>]*>)\^/\^\1 <N \2>\^/&&($j=906)||
	s/\^(R-bV) +(<[^>]*>) +<FLR +([^>]*)>\^/\^\1 <\1 \2> <R-bV \3>\^/&&($j=904)||
	s/\^(V[^ ]*) +<FLR +([^>]*)> (.*)\^/\^\1 <R-bV \2> <\1 \3>\^/&&($j=905)||
	...
	s/\^(V-aN[^ ]*|E-aN[^ ]*) +<MSP +(来)> +(<VP +[^>]*>)\^/\^\1 <\1-b{\1} \2> <\1 \3>\^/&&($j=896)||
	s/\^(V[^ ]*|E-aN[^ ]*|B-[^ ]*) +<MSP +([^>]*)> +(<VP +[^>]*>)\^/\^\1 <R-bV \2> <\1 \3>\^/&&($j=306)||
	...
	s/\^(V[^ ]*) +(<IP-TPC[^ ]* +[^>]*>)(.*) +(<NP[^ ]*SBJ[^>]*>|<NP-PN[^>]*>) +(<VP[^>]*-NONE- \*T[^>]*>)\^/\^\1 <V \2\3> <V-gV \4 \5>\^/&&($j=822)||
	s/\^(V[^ ]*) +<(IP-TPC[^ ]*) +([^>]*)> +(<PU[^>]*>) +(.*)(<NP[^ ]*SBJ[^>]*>) +(<VP[^>]*-NONE- \*T[^>]*>)\^/\^\1 <V \3 \4> <V-gV \5\6 \7>\^/&&($j=828)||
	s/\^(V-gV) +(<NP[^ ]*SBJ[^>]*>|<NP-PN[^>]*>) +(<VP[^>]*-NONE- \*T[^>]*>)\^/\^\1 <N \2> <V-aN-gV \3>\^/&&($j=823)||
	s/\^(V-aN-gV) +(<VV[^>]*>) +(<IP[^>]*-NONE- \*T[^>]*>)\^/\^\1 <V-aN-bV \2>\^/&&($j=824)||
	...
	s/\^(V-gN) +<NP-[^ ]*TPC +([^>]*-NONE- \*T\*[^>]*)> +(.*)(<IP +[^>]*>)(.*)\^/\^\1 <V-gN-fTPC \3\4\5>\^/&&($j=815)||
	s/\^(V-gN-gN-fTPC) +(<NP-[^ ]*SBJ +[^>]*\[-NONE- \*T\*[^>]*>) +<VP +([^>]*)>\^/\^\1 <N-gN [N \2]> <V-aN \3>\^/&&($j=447)||
	s/\^(V-gN-gN-fTPC) +(<NP-[^ ]*SBJ +[^>]*>) +(<VP +[^>]*\[-NONE- \*T\*[^>]*>)\^/\^\1 <N-gN [N \2]> <V-gN \3>\^/&&($j=857)||
#	s/\^(V-gN-fTPC) +(<QP-SBJ +[^>]*>) +(<VP +[^>]*>)\^/\^\1 <N-gN [N \2]> <V-aN \3\4>\^/&&($j=824)||
	s/\^(V-gN-fTPC) +(<QP-SBJ +[^>]*>|<NP[^ ]*SBJ +[^>]*-NONE- \*T[^>]*>) +(<VP +[^>]*>)\^/\^\1 <N-gN [N \2]> <V-aN \3\4>\^/&&($j=824)||
	s/\^(V-gN) +<NP-[^ ]*TPC +([^>]*)> +(.*)(<NP[^ ]*SBJ +[^>]*>) +(<VP +[^>]*-NONE- \*T\*[^>]*>)\^/\^\1 <N \2> <\1-gN-fTPC \3\4 \5>\^/&&($j=856)||
	#s/\^(N-gN) +<CP +([^>]*-NONE- \*T[^>]*)>\^/\^\1 <V-gN \2>\^/&&($j=825)||
	s/\^(N-gN) +<CP +([^>]*-NONE- \*T[^>]*)>\^/<\1 \2>/&&($j=825)||
	
	s/\^(N-gN) +<WHNP[^ ]* +[^>]*-NONE-[^>]*> <IP +([^>]*-NONE- \*T[^>]*)>\^/<V-gN \2>/&&($j=826)||
	s/\^(N-gN) +<WHNP[^ ]* +[^>]*-NONE-[^>]*> <CP +([^>]*-NONE- \*T[^>]*)>\^/<\1 \2>/&&($j=827)||
	s/\^(V-gN-fTPC) +(<NP[^ ]*SBJ +[^>]*-NONE-[^>]*>) +(<VP +[^>]*>)\^/\^\1 <V-aN \3\4>\^/&&($j=865)||
	s/\^(N-gN) +<IP +([^>]*-NONE- \*T[^>]*)> +<DEC +([^>]*)>\^/\^D-gN <V-gN \2> <D-aV \3>\^/&&($j=828)||
	s/\^(V-gN-fTPC) +(<QP-SBJ +[^>]*>|<NP[^ ]*SBJ +[^>]*>) +(<VP +[^>]*>)\^/\^\1 <N-gN [N \2]> <V-aN \3\4>\^/&&($j=420)||
	s/\^(V-gN-fTPC) +(<QP-SBJ +[^>]*>|<NP[^ ]*SBJ +[^>]*>) +(.*)(<VP +[^>]*>)\^/\^\1 <N-gN [N \2]> <V-aN \3\4>\^/&&($j=812)||
	...
	s/\^(V) +<NP-[^ ]*TPC +([^>]*)> +(.*)(<NP[^ ]*SBJ +[^>]*>.*<VP +[^>]*>|<QP-SBJ +[^>]*>.*<VP +[^>]*>)\^/\^\1 <N \2> <V-gN-fTPC \3\4>\^/&&($j=891)||
	s/\^(V[^ ]*) +(<N +[^>]*>) +(<N-gN +[^>]*>) +(<V-aN +[^>]*>)\^/\^\1 <N \2> <V-gN \4 \5>\^/&&($j=183)||
	s/\^(V[^ ]*) +<NP-[^ ]*TPC +([^>]*)> +<IP +([^>]*)>\^/\^\1 <N \2> <V-gN-fTPC \3>\^/&&($j=206)||	
	s/\^(V[^ ]*) +<NP-[^ ]*TPC +([^>]*)> +(<NP-TMP +[^>]*>) +(<IP +[^>]*>)\^/\^\1 <N \2> <V-gN-fTPC \3 \4>\^/&&($j=890)||	
	s/\^(V[^ ]*) +<NP-[^ ]*TPC +([^>]*)> +(.*)(<IP +[^>]*>)\^/\^\1 <N \2> <V-gN-fTPC \3\4>\^/&&($j=891)||	
...
#	s/\^(V[^ ]*) +<NP-[^ ]*TPC +\[-NONE- \*PRO\*[^>]*> +(<PP[^ ]* +[^>]*>|<NP-LOC +[^>]*>|<ADVP[^ ]* +[^>]*>)(.*)\^/\^\1 <\1 \2\3>\^/&&($j=559)||	
	...
	s/\^(V[^ ]*) +<NP-[^ ]*TPC +([^>]*)> +(<PU[^>]*>) +(<PP[^ ]* +[^>]*>|<NP-LOC +[^>]*>|<ADVP[^ ]* +[^>]*>)(.*)\^/\^\1 <N \2> <\1-gN-fTPC \3 \4\5>\^/&&($j=812)||	
	...
	s/\^(N) +(<DP[^>]*>) +(<CP +\[WHNP[^>]*\[-NONE- \*T\*[^>]*>) +(<NP[^>]*>)\^/\^\1 <Q \2 \3 \4>\^/&&($j=953)||
	s/\^(Q) +<DP ([^>]*)> +(<CP +\[WHNP[^>]*\[-NONE- \*T\*[^>]*>) +(<NP[^>]*>)\^/\^\1 <Q-bN \2> <N \3 \4>\^/&&($j=953)||
	s/\^(N) +(<CP +\[WHNP[^>]*\[-NONE- \*T\*[^>]*>) +(<PU[^>]*>) +(<CP[^>]*>)(.*)\^/\^\1 <N \2> <N-cN \3 \4\5>\^/&&($j=954)||
	s/\^(N-cN|N-c{N}) +(<PU[^>]*>) +(<CP +\[WHNP[^>]*\[-NONE- \*T\*[^>]*>)(.*)\^/\^\1 \2  <N \3\4>\^/&&($j=955)||
	s/\^(N-c{N}) +(<PU[^>]*>) +(<IP-APP [^>]*>)(.*)\^/\^\1 \2  <N \[V \3\4\]>\^/&&($j=956)||
	...
	s/\^(Q) +<CP +(\[WHNP[^>]*\[QP-TMP[^ ]* \[-NONE- \*T\*[^>]*)> +(.*)(<QP[^>]*>)\^/\^\1 <D-g{R-bV} \2> <Q \3\4>\^/&&($j=862)||

	s/\^(Q) +<CP +(\[WHPP[^>]*\[PP[^ ]* \[-NONE- \*T\*[^>]*)> +(.*)(<QP[^>]*>)\^/\^\1 <D-g{R-bV} \2> <Q \3\4>\^/&&($j=relq)||
	s/\^(Q) +<CP +(\[WHNP[^>]*\[-NONE- \*T\*[^>]*DEC[^>]*)> +(.*)(<QP[^>]*>)\^/\^\1 <D-gN \2> <Q \3\4>\^/&&($j=relq1)||
	...
	s/\^(D-gN) +(<IP +[^>]*>)(.*) +<DEC +([^>]*)>\^/\^\1 <V-gN \2\3> <D-aV \4>\^/&&($j=918)||
	s/\^(D-gN) +<NP[^>]*-NONE-[^>]*> +<CP +([^>]*)>\^/<\1 \2>/&&($j=926)||
	s/\^(D-g{R-bV}) +(<IP +[^>]*>)(.*) +<DEC +([^>]*)>\^/\^\1 <V-g{R-bV} \2\3> <D-aV \4>\^/&&($j=919)||
	s/\^(D-gN) +(<IP +[^>]*>) +(<PU[^>]*>)(.*) +(<DEC +[^>]*>)\^/\^\1 <V-gN \2 \3\4> <D-aV \5>\^/&&($j=916)||
	s/\^(D-gN) +<IP +([^>]*)> +<NP \[DEC +([^>]*)\]>\^/\^\1 <V-gN \2> <D-aV \3>\^/&&($j=916)||
	s/\^(D-gN) +(<NP[^ ]*-TPC +[^>]*\*T\*[^>]*>) +(<IP +[^>]*>) +<DEC +([^>]*)>\^/\^\1 <V-gN \2 \3> <D-aV \4>\^/&&($j=907)||
	s/\^(D-gN) +(<WHNP[^ ]* +[^>]*NONE[^>]*>) +(<IP +[^>]*>) +<DEC +([^>]*)>\^/\^\1 <V-gN \3> <D-aV \4>\^/&&($j=908)||

	s/\^(D-gN) +<IP +([^>]*)> +(<CP +\[WHNP[^>]*\[DEC[^>]*>)\^/\^\1 <\1 \2\3> <\1-c{\1} \[\1 \4\]>\^/&&($j=561)||

	s/\^(N[^ ]*) +<CP +(\[WHNP[^>]*\[NP-TMP[^ ]* \[-NONE- \*T\*[^>]*)(\[DEC[^>]*)> +(<DP[^>]*>|<NP[^>]*>)\^/\^\1 <D-g{R-bV} \2\3> <N \4\5>\^/&&($j=865)||
	...
	s/\^(N[^ ]*) +<CP +(\[WHNP[^>]*\*T[^>]*)> +(.*)(<NP[^>]*>|<QP[^>]*>)(.*)\^/\^\1 <D-gN \2> <N \3\4\5>\^/&&($j=82)||
	...
	s/\^(D-gN|D-g{A-bN}|D-g{R-bV}) +(<WHNP[^>]*>) +(<CP +[^>]*>) +(<DEC +[^>]*>)\^/<\1 \3 \4>/&&($j=240)||
	...
	s/\^(V-gN) +<NP[^ ]* ([^>]*\[CP [^>]*-NONE- \*T\*[^>]*)> +<VP +([^>]*)>\^/\^\1 <N \2> <V-aN-gN \3>\^/&&($j=19)||
	s/\^(V-gN) +<NP[^ ]* (\[CP [^>]*-NONE- \*T\*[^>]*)> +<VP +([^>]*)>\^/\^\1 <N \2> <V-aN-gN \3>\^/&&($j=19)||
	...
	s/\^(V) +(<IP[^ ]* +[^>]*>) +(<CP +[^>]*>)(.*)\^/\^\1 <\1 \2> <V-cV \3\4>\^/&&($j=956)||
	s/\^(V) +(<CP +[^>]*>)(.*) +(<INTJ[^>]*>)\^/\^\1 <V \2\3> <R-bV \4>\^/&&($j=957)||
	s/\^(V-cV|V-c{V}) +(<CP[^ ]* +[^>]*>)(.*)\^/\^\1 <V \2\3>\^/&&($j=957)||
	...
	s/\^(D-g{R-bV}) +(<WHPP[^>]*>) +<CP +([^>]*)>\^/\^\1 <V-g{R-bV} \3>\^/&&($j=rel2)||
	
	s/\^(D-gN|D-g{R-bV}|D-g{A-bN}) +<CP +([^>]*\[DEC[^>]*)>\^/<\1 \2>/&&($j=125)||
	s/\^(D-gN|D-g{R-bV}) +<CP +([^>]*)> +(<DEC +[^>]*>)\^/<\1 \2 \3>/&&($j=241)||
	...
	s/\^(A-bN) +(<QP[^ ]* +[^>]*>) +(<DEG[^>]*>|<DEC[^>]*>)\^/\^\1 <N \2> <A-bN-aN \3>\^/&&($j=236)||
	s/\^(A-bN) +(<ADJP[^ ]* +[^>]*>)(.*) +(<DEG[^>]*>|<DEC[^>]*>)\^/\^\1 <V-aN \2\3> <A-bN-a{V-aN} \4>\^/&&($j=921)||
	...
	s/\^(A-bN) +(<NP[^ ]* +[^>]*>)(.*) +(<DEG +[^>]*>)\^/\^\1 <N \2\3> <A-bN-aN \4>\^/&&($j=914)||

	s/\^(A-bN) +(<NP[^ ]* +[^>]*>)(.*) +(<PU +[^>]*>)\^/\^\1 <\1 \2\3> \4\^/&&($j=575)||
	s/\^(A-bN) +<NP[^ ]* +([^>]*)> +(.*)\^/\^\1 <R-bV \[N \2\]> <\1 \3>\^/&&($j=575)||
	s/\^(A-bN) +<IP[^ ]* +([^>]*)>\^/\^\1 <V \2>\^/&&($j=805)||
	s/\^(A-bN) +(<PU +[^>]*>) +(.*)\^/\^\1 \2 <\1 \3>\^/&&($j=806)||
	s/\^(A-bN) +(.*) +(<PU +[^>]*>)\^/\^\1 <\1 \2> \3\^/&&($j=807)||

	s/\^(A-bN) +<(ADJP[^ ]*|JJ) +([^>]*)> +(<ADJP[^ ]* +[^>]*>|<JJ +[^>]*>)(.*)\^/\^\1 <A-bN \3> <\1-c{\1} \4\5>\^/&&($j=520)||
	s/\^(A-bN) +<(ADJP[^ ]*|JJ) +([^>]*)> +(<PU[^>]*>|<CC[^>]*>) +(<ADJP[^ ]* +[^>]*>|<JJ +[^>]*>)(.*)\^/\^\1 <A-bN \3> <\1-c{\1} \4 \5\6>\^/&&($j=522)||
	s/\^(A-bN-c{A-bN}) +(<ADJP[^ ]* +[^>]*>|<JJ +[^>]*>)(.*)\^/\^\1 <A-bN \2\3>\^/&&($j=521)||
	s/\^(A-bN-c{A-bN}) +(<PU +[^>]*>) +(<ADJP[^ ]* +[^>]*>|<JJ +[^>]*>)(.*)\^/\^\1 \2 <A-bN \3\4>\^/&&($j=523)||
	s/\^(A-bN-c{A-bN}) +<CC +([^>]*)> +(<ADJP[^ ]* +[^>]*>|<JJ +[^>]*>)(.*)\^/\^\1 <\1-d{A-bN} \2> <A-bN \3\4>\^/&&($j=524)||

	#this should actually be relative clause (A-bN (ADJP (JJ 新)) (DEC 的)) (N 隐忧))
	s/\^(A-bN) +<ADJP[^ ]* +([^>]*)> +<DEC +([^>]*)>\^/\^\1 <V-aN \2> <A-bN-a{V-aN} \3>\^/&&($j=520)||
	s/\^(A-bN) +<JJ[^ ]* +([^>]*)> +<DEC +([^>]*)>\^/\^\1 <V-aN \2> <A-bN-a{V-aN} \3>\^/&&($j=520)||
	s/\^(A-bN-a{V-aN}) +<(DEC|DEG) +([^>]*)>\^/<\1 \3>/&&($j=922)||
	s/\^(A-bN-aN) +<(DEC|DEG|CD|SP) +([^>]*)>\^/<\1 \3>/&&($j=923)||
	s/\^(A-bN) +<(DP) +([^>]*)>\^/<\1 \3>/&&($j=924)||
	...
	s/\^(A-bN) +<DNP +([^>]*)> +(<PU +[^>]*>.*)\^/\^\1 <A-bN \2> <A-bN-c{A-bN} \3>\^/&&($j=801)||
	s/\^(A-bN) +<DNP +([^>]*)> +(<CC +[^>]*>) +(<[^>]*>)\^/\^\1 <A-bN \2> <A-bN-c{A-bN} \3 \4>\^/&&($j=801)||
	s/\^(A-bN-c{A-bN}) +(<PU +[^>]*>) +(<DNP +[^>]*>.*)\^/\^\1 \2 <A-bN \3>\^/&&($j=802)||
	s/\^(A-bN-c{A-bN}) +<CC +([^>]*)> +<(DNP|NP) +([^>]*)>\^/\^\1 <A-bN-c{A-bN}-d{A-bN} \2> <A-bN \4>\^/&&($j=802)||
	...
	s/\^(A-bN) +(<IP +[^>]*>) +(<DEG +[^>]*>)\^/\^\1 <V \2> <A-bN-aV \3>\^/&&($j=803)||
	s/\^(A-bN-aV) +<DEG +([^>]*)>\^/<\1 \2>/&&($j=804)||
	#UCP
	s/\^(A-bN) +<(UCP) +(\[ADJP[^>]*)> +<DEG +([^>]*)>\^/\^\1 <A-bN \3> <A-bN-a{A-bN} \4>\^/&&($j=849)||
	s/\^(A-bN) +<(ADJP) +([^>]*)> +(<CC +[^>]*>)(.*)\^/\^\1 <A-bN \3> <A-bN-c{A-bN} \4\5>\^/&&($j=850)||

	s/\^(A-bN) +<(UCP|NT|PN) +([^>]*)> +<DEG +([^>]*)>\^/\^\1 <N \3> <A-bN-aN \4>\^/&&($j=224)||
	s/\^(R-bV) +<P +([^>]*)> +<UCP +([^>]*)>\^/\^\1 <\1-bN \2> <N-fUCP \3>\^/&&($j=462)||
	s/\^(N) +<NP +([^>]*)> +<UCP +([^>]*)>\^/\^\1 <A-bN \2> <N \3>\^/&&($j=225)||
	s/\^(N) +<(UCP-APP|UCP) +([^>]*)> +<NP +([^>]*)>\^/\^\1 <A-bN \[NUCP \3\]> <N \4>\^/&&($j=499)||
	s/\^(N) +<(UCP-APP|UCP) +([^>]*)> +(<NP +[^>]*>|<QP +[^>]*>)(.*)\^/\^\1 <A-bN \[NUCP \3\]> <N \4\5>\^/&&($j=860)||
	s/\^(A-bN) +<(NUCP) +([^>]*)>\^/\^\1 <N \3>\^/&&($j=857)||
	s/\^(V-aN) +<VC +([^>]*)> +<UCP-PRD +([^>]*)>\^/\^\1 <V-aN-bN \2> <N \3>\^/&&($j=321)||
	s/\^(V-aN) +<VC +([^>]*)> +<DNP-PRD +([^>]*)>\^/\^\1 <V-aN-b{A-bN} \2> <A-bN \3>\^/&&($j=421)||
	s/\^(V-aN) +<VV +([^>]*)> +<(UCP-OBJ) +(\[CP[^>]*)>\^/\^\1 <V-aN-bV \2> <V \4>\^/&&($j=964)||
	s/\^(V-aN) +<VV +([^>]*)> +<(UCP-OBJ|NP-PN|LCP-LOC) +([^>]*)>\^/\^\1 <V-aN-bN \2> <N \4>\^/&&($j=417)||
	s/\^(N-c{N}) +(<PU +[^>]*>) +(<IP +[^>]*>)(.*)\^/\^\1 \2 <N \3\4>\^/&&($j=322)||
	s/\^(N-cN) +(<PU +[^>]*>) +(<IP[^ ]* +[^>]*>)(.*)\^/\^\1 \2 <N \3\4>\^/&&($j=322)||
	s/\^(N) +(<IP +[^>]*>) +(<PU [^>]*>) +(.*)\^/\^\1 <N \2> <N-cN \3 \4>\^/&&($j=323)||
	s/\^(N) +(<IP-NOM +[^>]*>) +(<NP[^>]*>)\^/\^\1 <A-bN \[V \2\]> <\1 \3>\^/&&($j=964)||
	s/\^(V-aN) +(<QP-PRD +[^>]*>) +(<SP[^>]*>)\^/\^\1 <\1 \2> <R-bV \3>\^/&&($j=965)||
	s/\^(V) +<DP-TPC-[^ ]* ([^>]*)> +(<NP-SBJ[^>]*>) +(<VP[^>]*>)\^/\^\1 <N \2> <V-gN \3 \4>\^/&&($j=966)||
	s/\^(V-aN-gN) +(<VV[^ ]* +[^>]*>) +(<DP-OBJ[^>]*-NONE-[^>]*>)\^/\^\1 <V-aN-bN \2>\^/&&($j=966)||
	s/\^(V-aN-gN) +(<NP \[PN 自己\]>) +(<VP[^ ]* +[^>]*-NONE-[^>]*>)\^/\^\1 <R-bV \2> <\1 \3>\^/&&($j=967)||
	s/\^(V) +(<IP [^>]*>) +(<VP[^ ]* [^>]*>)\^/\^\1 <N \2> <V-aN \3>\^/&&($j=968)||
	s/\^(V-aN-gN) +(<VV [^>]*>) +(<NP-OBJ[^ ]* +[^>]*-NONE-[^>]*>) +<VP-EXT ([^>]*)>\^/\^\1 <\1 \2 \3> <R-bV \4>\^/&&($j=969)||
	s/\^(V-aN) +<PRN ([^>]*)> +(<NP-FOC[^>]*>) +(<VP[^ ]* [^>]*>)\^/\^\1 <R-bV \2> <V-aN \3 \4>\^/&&($j=970)||
	s/\^(V) +(<NP-TPC[^>]*>) +(<NP-SBJ[^>]*>) +(<VP[^ ]* [^>]*>) +(<SP[^>]*>)\^/\^\1 <\1 \2 \3 \4> <R-bV \5>\^/&&($j=971)||
	s/\^(V-aN-gN) +<VP ([^>]*)> +(<VP [^>]*-NONE-[^>]*>)\^/\^\1 <V-aN-b{V-aN} \2> <V-aN-gN \3>\^/&&($j=972)||
	s/\^(V-c{V}|V-cV) +<INTJ[^ ]* ([^>]*)>\^/\^\1 <V \2>\^/&&($j=973)||
	s/\^(V-aN) +(<VV [^>]*>) +(<AS[^>]*>) +(<VP [^>]*>)\^/\^\1 <V-aN-b{V-aN} \2 \3> <V-aN \4>\^/&&($j=974)||
	s/\^(V-aN-bN) +(<VV [^>]*>) +(<LCP-LOC[^>]*>)\^/\^\1 <\1 \2> <R-bV \3>\^/&&($j=975)||
	s/\^(V) +(<CP [^>]*>) +(<PU[^>]*>)(.*)\^/\^\1 <\1 \2> <V-cV \3\4>\^/&&($j=976)||
	s/\^(V-aN-gV) +<VE ([^>]*)> +<IP-OBJ ([^>]*-NONE-[^>]*)>\^/\^\1 <V-aN-bV \2> <V-gV \3>\^/&&($j=977)||
	s/\^(V-aN) +<IP-TPC[^ ]* ([^>]*)> +(.*)\^/\^\1 <V \2> <V-aN-gV \3>\^/&&($j=978)||
	s/\^(V-aN-gN) (.*) (<VP-EXT[^>]*>)\^/\^\1 <\1 \2> <R-bV \3>\^/&&($j=979)||
	s/\^(V-aN-gN) (<VV[^>]*>) (<DER[^>]*>) (<NP-OBJ \[-NONE-[^>]*>)\^/\^\1 <V-aN-bN \2 \3>\^/&&($j=980)||
	s/\^(V-aN-bN) <VV ([^>]*)> <DER ([^>]*)>\^/\^\1 <\1 \2> <\1-a{\1} \3>\^/&&($j=981)||
	s/\^(N) <WHNP([^>]*)> <CP ([^>]*)>\^/\^\1 <D-gN \3>\^/&&($j=982)||
	s/\^(V-aN-gN) (<VV[^>]*>) (<DER[^>]*>) (<VP-EXT[^>]*>) (<NP-OBJ \[-NONE-[^>]*>)\^/\^\1 <V-aN-bN \2 \3 \4>\^/&&($j=983)||
	s/\^(V-aN-gN) (<VA[^>]*>) (<DER[^>]*>) <IP-OBJ ([^>]*-NONE-[^>]*)>\^/\^\1 <V-aN-b{V-aN} \2 \3> <V-aN-gN \4>\^/&&($j=984)||
	s/\^(V-aN-gN) (<VA[^>]*>) (<NP-OBJ [^>]*-NONE-[^>]*>)\^/\^\1 <V-aN-bN \2>\^/&&($j=985)||
	s/\^(V-aN-bN) <VA ([^>]*)>\^/<\1 \2>/&&($j=986)||
	s/\^(V-aN) (<VV[^>]*>) (<NP-OBJ [^>]*>) (<AS[^>]*>)\^/\^\1 <V-aN \2 \3> <R-bV \4>\^/&&($j=987)||
	s/\^(V-c{V}|V-cV) (<NP-SBJ[^>]*>) (<VP [^>]*>)\^/\^\1 <V \2 \3>\^/&&($j=988)||
	s/\^(V) (<CP [^>]*>) (.*)\^/\^\1 <V \2> <V-cV \3>\^/&&($j=989)||
	s/\^(V-c{V}|V-cV) (<IP[^>]*>) (.*)\^/\^\1 <V \2 \3>\^/&&($j=990)||
#	s/\^(V) (<IP[^>]*>) (.*)\^/\^\1 <V \2> <V-cV \3>\^/&&($j=990)||
	#s/\^(N) +<CP +([^>]*)>\^/\^\1 <V \2>\^/&&($j=823)||
	#FW
	s/\^(N) +<(NN) +([^>]*)> +<FW +([^>]*)>\^/\^\1 <A-bN \3> <N \4>\^/&&($j=272)||
	#appositive clause
	s/\^(B-aN-aN[^ ]*) +(<V[^ ]*[^>]*>)(.*) +<(LCP-OBJ|NP-OBJ) ([^>]*)>\^/\^\1 <B-aN-aN-bN \2\3> <N \5>\^/&&($j=181)||
	s/\^(B-aN-aN[^ ]*) +(<V[^ ]*[^>]*>)(.*) +<(LCP-OBJ|NP-OBJ) ([^>]*)>\^/\^\1 <B-aN-aN-bN \2\3> <N \5>\^/&&($j=181)||
	s/\^(N[^ ]*) +(<CP [^>]*-NONE-[^>]*\[DEC[^>]*>)(.*) +(<QP[^>]*>) +(<NP[^>]*>|<NN[^>]*>)\^/\^\1 <D-gN \2\3> <N \4 \5>\^/&&($j=916)||
	s/\^(N[^ ]*) +(<CP [^>]*-NONE-[^>]*\[DEC[^>]*>) +(<NP[^>]*>|<NN[^>]*>)(.*)\^/\^\1 <D-gN \2> <N \3\4>\^/&&($j=917)||

	s/\^(N[^ ]*) +<(CP-APP|CP) +([^>]*\[DEC[^>]*)> +(.*)(<NP[^>]*>|<NN[^>]*>)\^/\^\1 <D \3> <N-aD \4\5>\^/&&($j=128)||
	s/\^(N[^ ]*) +<IP[^ ]*APP +([^>]*)> +<NP[^ ]* +([^>]*)>\^/\^\1 <V \2> <N-aV \3>\^/&&($j=186)||
	s/\^(N[^ ]*) +<IP-APP +([^>]*)> +(.*)(<NP[^ ]* +[^>]*>)\^/\^\1 <V \2> <N-aV \3\4>\^/&&($j=249)||
	s/\^(D) +(.*) +<(DEC|DEG) +([^>]*)>\^/\^\1 <V \2> <D-aV \4>\^/&&($j=129)||
	...
	s/\^(D) +<CP[^ ]* +([^>]*)>\^/<\1 \2>/&&($j=918)||
	s/\^(D) +<IP +([^>]*)>\^/\^\1 <V \2>\^/&&($j=859)||
	s/\^(D) +<WH[^ ]*[^>]*-NONE-[^>]*> <CP +([^>]*)>\^/<\1 \2>/&&($j=806)||
	s/\^(Q) +<(IP-APP) +([^>]*)> +<QP +([^>]*)>\^/\^\1 <D [V \3]> <Q-aD \4>\^/&&($j=574)||
	s/\^(Q-aD) +<OD +([^>]*)> +<CLP +([^>]*)>\^/\^\1 <C \2> <\1-aC \3>\^/&&($j=575)||
	s/\^(A-bN) +<PRN +([^>]*)>\^/<\1 \2>/&&($j=832)||
	s/\^(A-bN) +<(PRN|PN) +([^>]*)>\^/\^\1 <N \3>\^/&&($j=220)||
	s/\^(V-aN) +(<CC +[^>]*>) +(<VP[^>]*>) +(<CC[^>]*>) +(<VP[^>]*>)\^/\^\1 <\1 \2 \3> <\1-c{\1} \4 \5>\^/&&($j=833)||
	#PRN, S means "source"?--> PRN for verb headed is R-bV
	s/\^(N) +(<PRN +[^>]*>) +(<NP[^ ]* +[^>]*>|<NR +[^>]*>|<NT +[^>]*>)(.*)\^/\^\1 <A-bN \2> <N \3\4>\^/&&($j=331)||
	s/\^(N) +(<N[^ ]* +[^>]*>) +(<PRN +[^>]*>) +(<N[^ ]* +[^>]*>)(.*)\^/\^\1 <N \2 \3> <N-cN \[N \4\5\]>\^/&&($j=839)||
	s/\^(V-aN) +<VA +([^>]*)> +<PRN +([^>]*)>\^/\^\1 <\1 \2> <R-bV \3>\^/&&($j=612)||
	s/\^(V-aN) +(<VV +[^>]*>) +(<DEC +[^>]*>) +(<AD[^>]*>)\^/\^\1 <\1 \2> <R-bV \3 \4>\^/&&($j=946)||
	s/\^(R-bV) +<DEC +([^>]*)> +<AD ([^>]*)>\^/\^\1 <\1-b{V-aN} \2> <V-aN \3>\^/&&($j=947)||
	s/\^(V-aN) +<NP-MNR +([^>]*)> (.*)\^/\^\1 <R-bV \2> <\1 \3>\^/&&($j=942)||
#	s/\^(S) +(<PU +[^>]*>) +<IP +([^>]*)>\^/\^\1 \2 <V \3>\^/&&($j=613)||
#	s/\^(V-aN) +<PRN +([^>]*)>\^/\^\1 <\1 \2> <S \3>\^/&&($j=612)||
#	s/\^(S) +<(NP[^ ]*) +([^>]*)>\^/\^\1 <N \3>\^/&&($j=616)||
#	s/\^(S) +<(VP[^ ]*) +([^>]*)>\^/\^\1 <V-aN \3>\^/&&($j=618)||
	s/\^(V-aN) +<PRN +([^>]*)> +<VP +([^>]*)>\^/\^\1 <R-bV \2> <\1 \3>\^/&&($j=617)||
	s/\^(V) +<PRN +([^>]*)> +(.*)\^/\^\1 <R-bV \2> <\1 \3>\^/&&($j=809)||
#	s/\^(S) +<IP +([^>]*)>\^/\^\1 <V \2>\^/&&($j=810)||
	s/\^(V) +(<IP[^>]*>) +(<SP[^>]*>) +<PRN +([^>]*)>\^/\^\1 <\1 \2 \3> <R-bV \4>\^/&&($j=823)||
	s/\^(V) +(<IP[^>]*>) +<PRN +([^>]*)>\^/\^\1 <\1 \2> <R-bV \3>\^/&&($j=861)||
	s/\^(N) +<CP +([^>]*)>\^/\^\1 <V \2>\^/&&($j=834)||
	...
	#parenthesis
	s/\^(N) +(<NP[^ ]* +[^>]*>|<NN +[^>]*>|<NT +[^>]*>) +<PRN +([^>]*)>\^/\^\1 <N \2> <A-bN \3>\^/&&($j=218)||
	s/\^(N) +<PRN +([^>]*)> +(.*)(<NP +[^>]*>|<NN +[^>]*>|<NR[^>]*>)\^/\^\1 <A-bN \2> <N \3\4>\^/&&($j=416)||
	s/\^([^ ]*) +<[^ ]* +([^>]*)> +<PRN +(\[PU[^\]]*\]) \[(IP[^ ]*|CP[^ ]*)([^>]*)\]>\^/\^\1 <\1 \2> <V \3 \[\4\5\]>\^/&&($j=prn)||
	s/\^([^ ]*) +<PU +(（)> +(<[^ ]* +[^>]*>) +(<PU ）>)\^/\^\1 <PU \2> <\1 \3 \4>\^/&&($j=620)||
	s/\^([^ ]*) +(<[^ ]* +[^>]*>) +(<PU ）>)\^/\^\1 <\1 \2> \3\^/&&($j=621)||
	...
	s/\^(NUCP) +<NP[^ ]* +([^>]*)> +(.*)\^/\^N <N \2> <N-c{N} \3>\^/&&($j=ucp2)||

	s/\^(N[^ ]*) +<N[^ ]*([^>]*)> +(<CC[^>]*>) +(.*)\^/\^\1 <N\2> <N-c{N} \3 \4>\^/&&($j=46)||
	s/\^(N[^ ]*) +(<N[^ ]*[^>]*> +<N[^C]*) +(<CC[^>]*>) +(.*)\^/\^\1 <N \2> <N-c{N} \3 \4>\^/&&($j=84)||
	s/\^(N[^ ]*) +(<NP +[^>]*>|<NN +[^>]*>|<NT +[^>]*>|<NR +[^>]*>)(.*) +(<PU[^>]*>) (<PRN[^>]*>)\^/\^\1 <\1 \2\3> <A-bN \4 \5>\^/&&($j=832)||
	s/\^(N-gN) +(<NP +[^>]*>|<NN +[^>]*>|<NT +[^>]*>|<NR +[^>]*>) +(<PU[^>]*>)(.*)\^/\^\1 <\1 \2> <\1-c{\1} \3\4>\^/&&($j=941)||
	s/\^(N[^ ]*) +(<NP +[^>]*>|<NN +[^>]*>|<NT +[^>]*>|<NR +[^>]*>) +(<PU[^>]*>)(.*)\^/\^\1 <\1 \2> <N-c{N} \3\4>\^/&&($j=75)||
	s/\^(N[^ ]*) +(<NP +[^>]*>|<NN +[^>]*>|<NT +[^>]*>) +(.*)(<PU ，>) +(<CC +[^>]*>)(.*)\^/\^\1 <\1 \2 \3\4> <N-c{N} \5\6>\^/&&($j=440)||
	s/\^(N[^ ]*) +(<NP +[^>]*>|<NN +[^>]*>|<NT +[^>]*>) +(.*) +(<PU ，>)\^/\^\1 <\1 \2 \3> \4\^/&&($j=441)||
	s/\^(N[^ ]*) +(<NP[^>]*>|<NN +[^>]*>|<NT +[^>]*>)(.*) +(<PU[^>]*>)\^/\^\1 <\1 \2\3> \4\^/&&($j=475)||

	s/\^(N[^ ]*) +(<NP[^ ]*[^>]*>|<PN[^>]*>|<NN[^>]*>) +(<CC[^>]*>) +(<NN[^>]*>|<NR[^>]*>|<NP[^>]*>)\^/\^\1 <N \2> <N-c{N} \3 \4>\^/&&($j=929)||

	s/\^(N[^ ]*) +(<NP[^ ]*[^>]*>|<PN[^>]*>|<NN[^>]*>) +(.*)(<NN[^>]*>|<NR[^>]*>)\^/\^\1 <A-bN \2> <N \3\4>\^/&&($j=6)||
	s/\^(N[^ ]*) +(<NP[^>]*>) +(<QP[^>]*>) +(<NN[^>]*>)\^/\^\1 <A-bN \2> <N \3 \4>\^/&&($j=346)||
	s/\^(N[^ ]*) +(<NN[^>]*>|<NP[^>]*>|<NR[^>]*>|<NT[^>]*>) +(<NN[^>]*>|<NR[^>]*>|<NT[^>]*>)(.*)\^/\^\1 <A-bN \2> <N \3\4>\^/&&($j=41)||
	s/\^(N[^ ]*) +(<NR[^>]*>|<NT[^>]*>) +(<NN[^>]*>)(.*)\^/\^\1 <A-bN \2> <N \3\4>\^/&&($j=99)||
	s/\^(N[^ ]*) +(<NP[^>]*>) +(<ADVP[^>]*>)\^/\^\1 <N \2> <R-bV \3>\^/&&($j=852)||
	s/\^(N[^ ]*) +(<NP[^>]*>) +(<QP[^>]*>)\^/\^\1 <N \2> <A-bN \3>\^/&&($j=853)||
	...
	s/\^(N) +(<NP[^>]*>) +<NP[^ ]* (\[ADVP \[AD 如[^>]*)>\^/\^\1 <N \2> <R-bV \3>\^/&&($j=828)||
	s/\^(N) +(<NP[^>]*>|<NN[^>]*>) +(<NP[^>]*>)\^/\^\1 <A-bN \2> <N \3>\^/&&($j=50)||
	s/\^(N[^ ]*) +(<NP[^>]*>) +(<QP[^>]*> +<NP[^>]*>)\^/\^\1 <A-bN \[N \2\]> <N \3>\^/&&($j=80)||
	s/\^(N[^ ]*) +(<NP[^ ]*[^>]*>) +(<ADJP[^>]*> +<NP[^>]*>)\^/\^\1 <A-bN \2> <N \3>\^/&&($j=86)||
	s/\^(N[^ ]*) +(<NP[^>]*>|<NR[^>]*>|<NN[^>]*>)(.*) +(<ETC[^>]*>)\^/\^\1 <N \2\3> <N-c{N} \4>\^/&&($j=85)||
	s/\^(N[^ ]*) +<IP +([^>]*)> +(<ETC[^>]*>)\^/\^\1 <N \[V \2\]> <N-c{N} \3>\^/&&($j=446)||
	#UPC
	s/\^(N[^ ]*) +(<IP[^>]*>)(.*)(<NP[^>]*>) +(<ETC[^>]*>)\^/\^\1 <N \2\3\4> <N-c{N} \5>\^/&&($j=316)||
	s/\^(N[^ ]*) +(<IP +[^>]*>) +(<PU[^>]*>)(.*)(<NP[^>]*>)\^/\^\1 <N \2> <N-c{N} \3\4\5>\^/&&($j=317)||
#	s/\^(N) +<IP +([^>]*\[DEC  的\][^>]*)>\^/\^\1 <V \2>\^/&&($j=968)||
	s/\^(N[^ ]*) +<IP +([^>]*)>\^/\^\1 <V \2>\^/&&($j=318)||
	s/\^(N[^ ]*) +(<IP +[^>]*>) +(<CC[^>]*>) +(<NP[^>]*>)\^/\^\1 <N \2> <N-c{N} \3 \4>\^/&&($j=319)||
	...
	s/\^(Q[^ ]*) +(<ADVP[^ ]* +[^>]*>) +(.*)\^/\^\1 <R-bV \2> <\1 \3>\^/&&($j=841)||
	s/\^(Q[^ ]*) +(<ADJP[^ ]* +[^>]*>) +(.*)\^/\^\1 <A-bN \2> <\1 \3>\^/&&($j=842)||
	s/\^(Q) +<QP +([^>]*)> +<LC +([^>]*)>\^/\^\1 <Q \2> <Q-bQ \3>\^/&&($j=453)||
	s/\^(N[^ ]*) +(<N[^>]*>) +(<LCP[^>]*>)\^/\^\1 <A-bN \2> <N \3>\^/&&($j=908)||
	s/\^(N) +(<LCP[^>]*>) +(<PU[^>]*>) +(<LCP[^>]*>)\^/\^\1 <N \2> <N-c{N} \3 \4>\^/&&($j=909)||
	s/\^(N-c{N}) +(<PU[^>]*>) +(<LCP[^>]*>)\^/\^\1 \2 <N \3>\^/&&($j=910)||
	#localizer
	s/\^(N[^ ]*) +(<NP[^>]*>|<QP[^>]*>|<LCP[^>]*>) +(<LC[^>]*>)\^/\^\1 <N \2> <N-aN \3>\^/&&($j=101)||
	s/\^(N[^ ]*) +(<NP[^>]*>|<QP[^>]*>|<LCP[^>]*>) +(<CC[^>]*>) +(<NP[^>]*>|<QP[^>]*>|<LCP[^>]*>)\^/\^\1 <N \2> <N-c{N} \3 \4>\^/&&($j=863)||
	s/\^(N[^ ]*) +<IP +([^>]*)> +<LC +([^>]*)>\^/\^\1 <V \2> <N-aV \3>\^/&&($j=190)||
	
        #QP
	s/\^(N[^ ]*) +<QP +(\[NP[^>]*)> +(<NP[^ ]*[^>]*>|<NN[^ ]*[^>]*>)\^/\^\1 <A-bN \[Q \2\]> <N \3>\^/&&($j=509)||
	s/\^(N[^ ]*) +(<QP[^ ]*[^>]*>) +(<CC[^>]*>) +(<NP[^ ]*[^>]*>|<NN[^ ]*[^>]*>)\^/\^\1 <N \2> <N-c{N} \3 \4>\^/&&($j=861)||

	s/\^(N-gN) +(<QP[^ ]*[^>]*>) +(<NP[^ ]*[^>]*-NONE-[^>]*>)\^/\^\1 <Q-gN \[Q-bN \2\]>\^/&&($j=949)||
	s/\^(N[^ ]*) +(<QP[^ ]*[^>]*>) +(.*)(<NP[^ ]*[^>]*>|<NN[^ ]*[^>]*>)\^/\^\1 <Q \2 \3\4>\^/&&($j=64)||
	s/\^(N[^ ]*) +(<NN[^>]*>) +(<NN[^>]*>)([^CC]*)\^/\^\1 <A-bN \2> <N \3\4>\^/&&($j=65)||
	s/\^(N[^ ]*) +(<NN[^>]*>) +(<NN[^>]*>) +<ETC +([^>]*)>\^/\^\1 <N \2 \3> <N-c{N} \4>\^/&&($j=230)||
	s/\^(N[^ ]*) +<ADVP[^ ]*([^>]*)> +<DP[^ ]*([^>]*)>\^/\^\1 <R-bV\2> <N\3>\^/&&($j=54)||
	s/\^(N[^ ]*) +<ADVP[^ ]* +([^>]*)> +<NP[^ ]* +([^>]*)>\^/\^\1 <A-bN \2> <N \3>\^/&&($j=830)||
	s/\^(N[^ ]*) +<DT[^ ]*([^>]*)> +<QP[^ ]*([^>]*)>\^/\^\1 <N-bQ\2> <Q\3>\^/&&($j=56)||
	s/\^(A-bN) +(<DT[^ ]*[^>]*>) +(<QP[^ ]*[^>]*>)\^/\^\1 <N-bN \2 \3>\^/&&($j=224)||
	s/\^(A-bN) +<QP[^ ]* +([^>]*)>\^/\^\1 <Q \2>\^/&&($j=621)||
	...
	s/\^(N-c[^ ]*) +<CC[^ ]*([^>]*)> +(.*)\^/\^\1 <N-c{N}-d{N} \2> <N \3>\^/&&($j=47)||
	s/\^(N-c{N}) +(<PU +[^>]*>) +(<CC +[^>]*>) +(.*)\^/\^\1 \2 <\1 \3 \4>\^/&&($j=215)||
	#QP coordination
	s/\^(Q[^ ]*) +<QP[^ ]*([^>]*)> +(<CC[^>]*>) +(.*)\^/\^\1 <Q\2> <Q-cQ \3 \4>\^/&&($j=237)||
	s/\^(Q-c[^ ]*) +<CC[^ ]*([^>]*)> +(.*)\^/\^\1 <Q-cQ-dQ \2> <Q \3>\^/&&($j=238)||
	s/\^(Q) +<QP +([^>]*)> +<QP +\2>\^/\^\1 <Q \2> <Q-cQ [Q \2]>\^/&&($j=609)||
	s/\^(Q) +<QP +([^>]*)> +<QP +([^>]*)>\^/\^\1 <Q \2> <Q-cQ [Q \3]>\^/&&($j=830)||

#	s/\^(Q) +<QP +([^>]*)> +<QP +([^>]*)>\^/\^\1 <Q-bN \2> <N \3>\^/&&($j=259)||
	#R-bV coordination
	s/\^(R-bV) +<(AD +[^>]*)> +(<PU[^>]*>) +(<AD +[^>]*>)\^/\^\1 <\1 [\2]> <\1-c\{\1\} \3 \4>\^/&&($j=192)||
	s/\^(R-bV) +(<AD +[^>]*>) +(<PU[^>]*>|<CC[^>]*>) +(<AD +[^>]*>)(.*)\^/\^\1 <\1 \2> <\1-c\{\1\} \3 \4\5>\^/&&($j=816)||
	s/\^(R-bV)-c([^ ]*) +<(PU[^>]*)> +<AD +([^>]*)>\^/\^\1-c\2 <\3> <\1 \4>\^/&&($j=193)||
	s/\^(R-bV)-c([^ ]*) +(<PU[^>]*>) +(<AD +[^>]*>)(.*)\^/\^\1-c\2 \3 <\1 \4\5>\^/&&($j=817)||
	s/\^(R-bV)-c([^ ]*) +<CC +([^>]*)> +(<AD +[^>]*>)(.*)\^/\^\1-c\2 <R-bV-c{R-bV}-d{R-bV} \3> <R-bV \4\5>\^/&&($j=818)||
	...
	s/\^(R-bV) +<(ADVP[^ ]*) ([^>]*)> +<NP[^ ]* +([^>]*)>\^/\^\1 <R-bV-bN \3> <N \4>\^/&&($j=829)||
	s/\^(R-bV) +(<DP +[^>]*>) +<LC +([^>]*)>\^/\^\1 <N \2> <R-bV-aN \3>\^/&&($j=605)||

	s/\^(R-bV) +(<DP +[^>]*>|<ADJP +[^>]*>) +(<NP +[^>]*>)\^/\^\1 <N \2 \3>\^/&&($j=368)||
	s/\^(R-bV) +<IP +([^>]*)> +<DEV +([^>]*)>\^/\^\1 <V \2> <\1-aV \3>\^/&&($j=605)||
	s/\^(R-bV) +(<IP +[^>]*>) +(<SP +[^>]*>)\^/\^\1 <V \2 \3>\^/&&($j=907)||
	s/\^(R-bV) +(<IP +[^>]*>)\^/\^\1 <V \2>\^/&&($j=908)||
	s/\^(R-bV) +<N[^ ]* +([^>]*)> <DEV +([^>]*)>\^/\^\1 <N \2> <R-bV-aN \3>\^/&&($j=927)||
	s/\^(R-bV) +(<N[^ ]* +[^>]*>.*)\^/\^\1 <N \2>\^/&&($j=909)||
	s/\^(R-bV) +(<CP[^ ]* +[^>]*WHNP[^>]*>) +(<NP[^>]*>)\^/\^\1 <N \2 \3>\^/&&($j=910)||
	s/\^(R-bV) +(<VV[^ ]* +[^>]*>.*) +(<NP-OBJ[^>]*>.*)\^/\^\1 <V-aN \2 \3>\^/&&($j=912)||
	s/\^(R-bV) +(<CP[^ ]* +[^>]*WHNP[^>]*>)\^/\^\1 <N \2>\^/&&($j=911)||
	s/\^(R-bV) +<(CD|OD) +([^>]*)>\^/\^\1 <C \3>\^/&&($j=843)||

	#elided subject
	s/\^(V) +<(VP) ([^>]*)>\^/\^\1 <V-aN \3>\^/&&($j=286)||

        #(N (ADJP ..) (...)) --> N (A-bN N)
	s/\^(N) +<UCP-APP +([^>]*)> +(<CP[^>]*>) +(<NP[^>]*>)\^/\^\1 <N \2> <N-c{N} \[N \3 \4\]>\^/&&($j=316)||
	s/\^(NUCP) +<ADJP +([^>]*)> +(<CC +[^>]*>) +(<NP +[^>]*>)\^/\^N <N \2> <N-c{N} \3 \4>\^/&&($j=ucp1)||

	s/\^(N[^ ]*) <(ADJP[^ ]*|JJ) +([^>]*)> (.*)\^/\^\1 <A-bN \3> <N \4>\^/&&($j=36)||
#	s/\^(N) +(<JJ +[^>]*>) +(<N[^>]*>) +(.*)\^/\^\1 <A-bN \[N \2 \3\]> <N \4>\^/&&($j=859)||
	s/\^(N) +(<ADVP +[^>]*>) +(<ADJP +[^>]*>) +(<NP +[^>]*>|<NN +[^>]*>)\^/\^\1 <A-bN \2 \3> <\1 \4>\^/&&($j=604)||

	s/\^(N|N-gN) (.*) +(<PU[^>]*>)\^/\^\1 <\1 \2> \3\^/&&($j=831)||

	s/\^(N|N-gN) +<(PP|ADVP[^ ]*|LCP) +([^>]*)> +(.*)(<NP[^ ]* +[^>]*>|<NN +[^>]*>)\^/\^\1 <R-bV \3> <\1 \4\5>\^/&&($j=150)||
	s/\^(N) +<(PP|ADVP[^ ]*) +([^>]*)> +(<PP +[^>]*>) +(<NP +[^>]*>)\^/\^\1 <R-bV \3> <N \4 \5>\^/&&($j=227)||
	s/\^(N[^ ]*) +(<DNP[^>]*>) +(<DEG[^>]*>) +(<NP[^>]*>)\^/\^\1 <A-bN \2 \3> <\1 \4>\^/&&($j=844)||
	s/\^(A-bN) +<DNP +([^>]*)> +<DEG +([^>]*)>\^/\^\1 <N \2> <A-bN-aN \3>\^/&&($j=845)||
	s/\^(N[^ ]*) +<(DNP[^ ]*) +([^>]*)> (.*)\^/\^\1 <A-bN \3> <\1 \4>\^/&&($j=44)||
	s/\^(N[^ ]*) +<(NP[^ ]*) +([^>]*)> +<DEG +([^>]*)>\^/\^\1 <N \3> <N-aN \4>\^/&&($j=927)||
	...
	s/\^(N) +(<NP[^>]*>|<NR[^>]*>) +(<PU[^>]*>) +(<NP[^>]*>|<NR[^>]*>)(.*)\^/\^\1 <\1 \2> <N-c{N} \3 \4\5>\^/&&($j=255)||
	s/\^(N) +<NR +([^>]*)> +(<NR +[^>]*>)\^/\^\1 <N \2> <N-c{N} \3>\^/&&($j=576)||

	s/\^(N) +<NR-SHORT +([^>]*)> +(<NR[^>]*>)\^/\^\1 <\1 \2> <\1-cN \[N \3\]>\^/&&($j=596)||

	s/\^(N[^ ]*) +(<NP[^ ]* +[^>]*>) +(<PRN[^>]*>) +(<CC +[^>]*>) +(<NP[^ ]* +[^>]*>) +(<PRN [^>]*>)\^/\^\1 <N \2 \3> <N-c{N} \4 \5 \6>\^/&&($j=619)||
	s/\^(N) +(<NP[^>]*>|<NR[^>]*>|<NT[^>]*>) +(<PRN +[^>]*>)\^/\^\1 <\1 \2> <A-bN \3>\^/&&($j=833)||

	s/\^(N[^ ]*) +(<NP[^>]*>|<NR[^>]*>)(.*) +(<CC[^>]*>) +(<NP[^>]*>|<NR[^>]*>)\^/\^\1 <\1 \2\3> <N-c{N} \4 \5>\^/&&($j=930)||
	
	s/\^(N[^ ]* )(<NP[^>]*>|<NR[^>]*>) +(.*)(<NP[^>]*>|<NR[^>]*>)\^/\^\1<A-bN \2> <N \3\4>\^/&&($j=124)||
	s/\^(A-bN) +<PU ([^>]*)> +<NP[^ ]* +([^>]*)>\^/\^\1 <A-bN-bN \2> <N \3>\^/&&($j=290)||
	s/\^(A-bN) +<CP ([^>]*)> +<DEG +([^>]*)>\^/\^\1 <D-gN \2> <\1-a{D-gN} \3>\^/&&($j=591)||
	s/\^(D-gN) +<PU ([^>]*)> +(.*)\^/\^\1 <PU \2> <\1 \3>\^/&&($j=592)||
	s/\^(D-gN) (.*) +(<PU [^>]*>)\^/\^\1 <\1 \2> \3\^/&&($j=807)||
	...
	s/\^(V-aN) +<(VE|VP|VV)([^>]*)> +(<NP-OBJ[^ ]* +[^>]*> +<QP-EXT[^ ]* +[^>]*>)\^/\^\1 <V-aN-bN\3> <N \4>\^/&&($j=213)||
	...
	s/\^(V-aN) +<(ADJP|AD) +([^>]*)> +<VP +([^>]*)>\^/\^\1 <R-bV \3> <\1 \4>\^/&&($j=610)||
	...
	s/\^(V-aN[^ ]*|E-aN[^ ]*|B-aN[^ ]*) +<(DVP) +([^>]*)> +(.*)\^/\^\1 <R-bV \3> <\1 \4>\^/&&($j=536)||
	s/\^(V-aN) +<(P) +([^>]*)> +<IP +([^>]*)>\^/\^\1 <V-aN-bV \3> <V \4>\^/&&($j=537)||
	s/\^(V-aN) +(<VV +[^>]*>) +(<PU +[^>]*>) +(<PU +[^>]*>) +(<IP +[^>]*>)\^/\^\1 <V-aN-bV \2 \3> <V \4 \5>\^/&&($j=858)||
	s/\^(V-aN) +<(VA) +([^>]*)> +<AS +([^>]*)>\^/\^\1 <\1 \3> <R-bV \4>\^/&&($j=538)||
	s/\^(V-aN) +<(VA) +([^>]*)> +<IP-OBJ +(\[NP-SBJ \[-NONE- \*PRO[^>]*)>\^/\^\1 <V-aN-b{V-aN} \3> <V-aN \4>\^/&&($j=539)||

	s/\^(R-bV) +<QP-ADV +([^>]*)>\^/\^\1 <Q \2>\^/&&($j=222)||
	s/\^(R-bV) +<(LCP[^ ]*|PN|LST|DP) +([^>]*)>\^/<\1 \3>/&&($j=222)||
	s/\^(R-bV) +(<[^ ]* +[^>]*>) (<PU[^>]*>) (.*)\^/\^\1 <\1 \2> <\1-c{\1} \3 \4>\^/&&($j=948)||
	s/\^(R-bV-c{R-bV}) +(<PU[^>]*>) (.*)\^/\^\1 \2 <R-bV \3>\^/&&($j=949)||
	s/\^(N) +<(LCP[^ ]*) +([^>]*)>\^/<\1 \3>/&&($j=864)||
	#order subject control verb rule before 43
	s/\^(V-aN) +<(VV|VSB|VPT)([^>]*)> +<(IP[^ ]*) +(\[NP-SBJ +\[-NONE- \*PRO\*[^>]*)>\^/\^\1 <V-aN-b{V-aN}\3> <V-aN \5>\^/&&($j=147)||
	s/\^(V-aN-gN) +<(VV|VSB|VPT)([^>]*)> +<(IP[^ ]*) +(\[NP-SBJ +\[-NONE- \*PRO\*[^>]*)>\^/\^\1 <V-aN-b{V-aN}\3> <V-aN-gN \5>\^/&&($j=948)||
	s/\^(V-aN-gN) +(<VE[^>]*>) +(<QP[^>]*>) +(<NP-OBJ[^>]*>)\^/\^\1 <V-aN-bN \2> <N-gN \3 \4>\^/&&($j=949)||
	s/\^(V-aN-gN) +<(VV)([^>]*)> +<(IP[^ ]*) +(\[NP-SBJ +\[-NONE- \*PRO\*[^>]*-NONE- \*T\*-[^>]*)>\^/\^\1 <V-aN-b{V-aN}\3> <V-aN-gN \5>\^/&&($j=506)||
	s/\^(V-aN-gN) +<(VC) +([^>]*)> +<VP[^ ]* +([^>]*\*T[^>]*)>\^/\^\1 <V-aN-b{V-aN} \3> <V-aN-gN \4>\^/&&($j=940)||
	s/\^(V-aN[^ ]*) +<(VC) +([^>]*)> +<VP[^ ]* +([^>]*)>\^/\^\1 <V-aN-b{V-aN} \3> <V-aN \4>\^/&&($j=189)||
	s/\^(V-aN|V-aN-gN) +<NP-SBJ +\[-NONE- \*PRO\*][^>]*> +(<VP[^>]*>)\^/<\1 \2>/&&($j=148)||
	s/\^(V-aN) +(<VV[^>]*>|<VSB[^>]*>|<VPT[^>]*>) +(<NP-OBJ[^ ]* +[^>]*>) +(<IP[^ ]* +[^>]*>)\^/\^\1 <\1-bV \2 \3> <V \4>\^/&&($j=947)||
	s/\^(V-aN-bV) +(<VV[^>]*>|<VSB[^>]*>|<VPT[^>]*>) +(<NP-OBJ[^ ]* +[^>]*>)\^/\^\1 <\1-bN \2> <N \3>\^/&&($j=947)||
	s/\^(V-aN|V-aN-gN) +<NP-SBJ +\[-NONE- \*pro\*][^>]*> +(<VP[^>]*>)\^/<\1 \2>/&&($j=933)||
#	s/\^(V-aN|V-aN-gN) +(<N[^ ]* +[^>]*>) +<V[^ ]* +[^>]*\[-NONE-[^>]*>)\^/\^\1 <N \2> <\1 \2>\^/&&($j=148)||
	s/\^(V-aN-gN) +<VV +([^>]*)> +<IP +([^>]*\*T\*[^>]*)>\^/\^\1 <V-aN-bV \2> <V-gN \3>\^/&&($j=429)||
	s/\^(V-aN-gN) +(<VRD +[^>]*>|<VV +[^>]*>) +(<AS[^>]*>) +(<NP[^ ]* +[^>]*-NONE-[^>]*>)\^/\^\1 <V-aN-bN \2 \3>\^/&&($j=943)||
	s/\^(V-aN-gN) +<VP +([^>]*)> +(<SP[^>]*>)\^/\^\1 <\1 \2> <R-bV \3>\^/&&($j=948)||
	s/\^(V-aN-gN) +(<VC +[^>]*>|<VV +[^>]*>) +(<NP[^ ]* +[^>]*-NONE-[^>]*>)\^/\^\1 <V-aN-bN \2>\^/&&($j=947)||
	s/\^(V-aN-gN) +(<VE +[^>]*>|<VV +[^>]*>) +(<AS[^>]*>) +(<NP[^ ]* +[^>]*-NONE-[^>]*>)\^/\^\1 <V-aN-bN \2 \3>\^/&&($j=958)||
	s/\^(V-aN-gN|V-aN-gV) +<VV +([^>]*)> +<VP +([^>]*-NONE-[^>]*)>\^/\^\1 <V-aN-b{V-aN} \2> <\1 \3>\^/&&($j=942)||
	s/\^(V-aN) +<(VV|VE|VRD|VSB|VP|VPT) +([^>]*)> +<(IP[^ ]*) ([^>]*)>\^/\^\1 <V-aN-bV \3> <V \5>\^/&&($j=43)||
	s/\^(V-aN) +(<VV[^>]*>) +(<NP-OBJ[^>]*>) +(<VP[^>]*>)\^/\^\1 <V-aN \2 \3> <V-aN-c{V-aN} \[V-aN \4\]>\^/&&($j=945)||
	s/\^(V-aN) +(<VV [^>]*>) +(<PU[^>]*>) +(<PU[^>]*>) +(<IP-OBJ[^>]*>)\^/\^\1 <V-aN-bV \2 \3> <V \4 \5>\^/&&($j=497)||
	s/\^(V-aN) +(<VA [^>]*>) +(<PP[^>]*>)\^/\^\1 <\1 \2> <R-bV \3>\^/&&($j=497)||

 	s/\^(V) +<IP-MNR ([^>]*)> +(.*)\^/\^\1 <R-bV \[V \2\]> <\1 \3>\^/&&($j=944)||
	...
	s/\^(V-gN[^ ]*) +(<NP-TMP[^>]*-NONE- \*T[^>]*>) +(.*)\^/\^\1 <V \3>\^/&&($j=800)||

	s/\^(V-aN[^ ]*|V-gN[^ ]*) +<NP-TMP \[-NONE- \*T\*[^>]*> +(.*)\^/<\1 \2>/&&($j=866)||
	...
	s/\^(V-aN[^ ]*) +(<VV[^>]*>|<VCD[^>]*>) +(<NP-IO[^>]*>) +(<PU[^>]*>) +(<IP-OBJ[^>]*>|<IP-Q-OBJ[^>]*>)\^/\^\1 <V-aN-bV \[V-aN-bV \2 \3\] \4> <V \5>\^/&&($j=402)||
	s/\^(V-aN[^ ]*) +(<VV[^>]*>|<VCD[^>]*>) +(<NP-IO[^>]*>) +(<IP-OBJ[^>]*>)\^/\^\1 <V-aN-bV \2 \3> <V \4>\^/&&($j=557)||
	s/\^(V-aN[^ ]*) +(<VV[^>]*>|<VCD[^>]*>) +(<NP-IO[^>]*>) +(<QP-OBJ[^>]*>|<NP-OBJ[^>]*>)\^/\^\1 <V-aN-bN \2 \3> <N \4>\^/&&($j=819)||
	...
	s/\^(V|V-aN) +<CP-CND +([^>]*)> +(<PU[^>]*>) +(.*)\^/\^\1 <R-bV \[V \2\] \3> <\1 \4>\^/&&($j=401)||
	s/\^(V|V-aN) +<CP-CND +([^>]*)> +(.*)\^/\^\1 <R-bV \2> <\1 \3>\^/&&($j=900)||
	s/\^(V) +<CP-CND +([^>]*)> +(.*)\^/\^\1 <R-bV \2> <\1 \3>\^/&&($j=534)||
	s/\^(R-bV) +<(IP-CND|CP-CND) +([^>]*)> +(<PU[^>]*>)\^/\^\1 <R-bV \3> \4\^/&&($j=326)||
	s/\^(R-bV) +<(IP-CND|CP-CND|AS) +([^>]*)>\^/<\1 \3>/&&($j=553)||
	s/\^(V-aN) +<(DEF|AD) +([^>]*)>\^/<\1 \3>/&&($j=947)||
#	s/\^(R-bV) +<NP-SBJ[^ ]* +([^>]*)> +<VP +([^>]*CS[^>]*)>\^/\^\1 <N \2> <R-bV-aN \3>\^/&&($j=327)||
	...
	s/\^(R-bV) +<ADVP[^ ]* +([^>]*CS[^>]*)> +<CP +([^>]*)>\^/\^\1 <R-bV-bV \2> <V \3>\^/&&($j=901)||
	s/\^(R-bV) +<IP +([^>]*)> +<SP (的话)>\^/\^\1 <V \2> <R-bV-aV \3>\^/&&($j=413)||
	#s/\^(R-bV) +(<ADVP +[^>]*>) +(.*)\^/\^\1 <\1 \2> <\1 \3>\^/&&($j=892)|	
        #norminalizer DE
	#?
	s/\^(V-aN) +(<VV[^>]*>) +(<PU [^>]*>) +<CP-OBJ +([^>]*SP[^>]*)>\^/\^\1 <\1-bV \2 \3> <V \4>\^/&&($j=367)||
#	s/\^(V-aN) +(<VV[^>]*>) +(<PU [^>]*>) +<CP-OBJ +([^>]*SP[^>]*)>\^/<\1 \2 \4>/&&($j=367)||
	s/\^(V-aN) +<VV +([^>]*)> +<CP-OBJ +([^>]*)>\^/\^\1 <V-aN-bV \2> <V \3>\^/&&($j=374)||
	s/\^(V-aN) +<VC +([^>]*)> +<(CP-PRD|CP) +([^>]*SP 的[^>]*)>\^/\^\1 <V-aN-bN \2> <N \4>\^/&&($j=536)||
	...
	s/\^(V-aN) +(<VA +[^>]*>.*) +<ADVP[^ ]* +([^>]*)>\^/\^\1 <\1 \2> <R-bV \3>\^/&&($j=901)||
	s/\^(V-aN) +(<VV +[^>]*>) +(<AD[^>]*>) +(<VA[^>]*>)\^/\^\1 <V-aN-bN \2> <V-aN-a{V-aN-bN} \3 \4>\^/&&($j=953)||
	s/\^(V-aN-a{V-aN-bN}) +<VA ([^>]*)>\^/<\1 \2>/&&($j=954)||
	
	#? nominalization de

	s/\^(N) +(.*)(<VP[^>]*>)(.*) +<SP ([^>]*)>\^/\^\1 <V-aN \2\3\4> <N-a{V-aN} \5>\^/&&($j=371)||
	...
	#negation 
	s/\^(V-aN[^ ]*) +<(VV) +([^>]*)> +(<AD 不>) +(<VV [^>]*>)\^/\^\1 <\1 \3> <\1-a{\1} \4 \5>\^/&&($j=372)||
	s/\^(V-aN[^ ]*) +<AD +([^>]*)> +<(VV|VC|VE) +([^>]*)>\^/\^\1 <R-bV \2> <\1 \4>\^/&&($j=373)||
	
	#A-not-A question: polar question
	s/\^(V-aN[^ ]*) +<(VV|VC|VE) +([^>]*)> +(<AD 不>|<AD 没>) +(<\2 +\3>)\^/\^\1 <\1 \3> <\1-c{\1} [\1 \4 \5]>\^/&&($j=436)||
	s/\^(V-aN[^ ]*) +<(VE) +([^>]*)> +<VE +(没有)>\^/\^\1 <\1 \3> <\1-c{\1} [\1 \4]>\^/&&($j=613)||
	#s/\^(K) +(.*) +(<PU [^>]*>)\^/\^\1 <\1 \2> \3\^/&&($j=903)||
	
	#s/\^(K) +<IP[^ ]* +([^.]*)> +<SP ([^>]*)>\^/\^\1 <V \2> <K-aV \3>\^/&&($j=904)||
	
	#adverbial DER:V-aN-b{V-aN}-a{V-aN} or V-aN-b{V-aN}-bN-a{V-aN} 
	s/\^(V-aN|B-aN-aN|V-aN-bN) +(<VV +[^>]*>|<VA +[^>]*>)(.*) +(<DER +[^>]*>) +<(VV|VP-EXT|VA|VP|PP-EXT) +([^>]*)>\^/\^\1 <\1-b{V-aN} \2\3 \4> <V-aN \6>\^/&&($j=374)||
	s/\^(V-aN|B-aN-aN|V-aN-bN) +(<VV +[^>]*>|<VA +[^>]*>)(.*) +(<DER +[^>]*>) +<(IP) +([^>]*)>\^/\^\1 <\1-bV \2\3 \4> <V \6>\^/&&($j=374)||
	s/\^(V-aN-b{V-aN}|V-aN-bN-b{V-aN}) +(<VV +[^>]*>) +<DER +([^>]*)>\^/\^\1 <V-aN-bN \2> <\1-a{V-aN-bN} \3>\^/&&($j=375)||
	s/\^(V-aN-b{V-aN}) +(<VA +[^>]*>) +<DER +([^>]*)>\^/\^\1 <V-aN \2> <\1-a{V-aN} \3>\^/&&($j=587)||
	s/\^(V-aN-bV) +(<VV +[^>]*>) +<DER +([^>]*)>\^/\^\1 <V-aN \2> <\1-a{V-aN} \3>\^/&&($j=945)||
	s/\^(B-aN-aN-b{V-aN}) +(<VV +[^>]*>|<VA +[^>]*>) +<DER +([^>]*)>\^/\^\1 <V-aN-bN \2> <\1-a{V-aN-bN} \3>\^/&&($j=577)||
	s/\^(V-aN) +(<VV +[^>]*>|<VA +[^>]*>) +(<DER +[^>]*>) +<(IP-EXT|CP-EXT) +([^>]*)>\^/<\1 \2 \3 \5>/&&($j=571)||
	...
	s/\^(V-aN) +(<VV +[^>]*>)(.*) +<NP-OBJ[^ ]* +([^>]*)>\^/\^\1 <V-aN-bN \2\3> <N \4>\^/&&($j=929)||
...
#	s/\^(R-bV) +<DER +([^>]*)> +<VV +([^>]*)>\^/\^\1 <\1-b{V-aN} \2> <V-aN \3>\^/&&($j=556)||
	...
	s/\^(V-aN[^ ]*) +(<BA[^>]*>) +(<IP-OBJ[^>]*>) +(<SP[^>]*>)\^/\^\1 <\1 \2 \3> <R-bV \4>\^/&&($j=912)||
	s/\^(V-aN[^ ]*) +(<BA[^>]*>) +(<IP-OBJ[^>]*>) +(<PU[^>]*>) +(<PP[^>]*>)\^/\^\1 <\1 \2 \3 \4> <R-bV \5>\^/&&($j=913)||
	s/\^(V-aN[^ ]*) +<BA +([^>]*)> +<IP +([^>]*)>\^/\^\1 <V-aN-b{B-aN} \2> <B-aN \3>\^/&&($j=611)||
	s/\^(B-aN[^ ]*) +<NP[^ ]*([^>]*)> +<VP([^>]*)>\^/\^\1 <N\2> <B-aN-aN\3>\^/&&($j=110)||
	s/\^(B-aN[^ ]*) +(<NP[^ ]* +[^>]*>) +(<PU +[^>]*>) +<VP +([^>]*)>\^/\^\1 <N \2 \3> <B-aN-aN \4>\^/&&($j=805)||

	s/\^(B-aN[^ ]*) +<IP-SBJ +([^>]*)>(.*) +<VP([^>]*)>\^/\^\1 <N [V \2\3]> <B-aN-aN\4>\^/&&($j=342)||
	s/\^(B-aN-aN) +(<VV +[^>]*>|<VRD +[^>]*>|<VSB +[^>]*>) +(<AS +[^>]*>) +(<NP[^ ]*[^>]*>)\^/\^\1 <V-aN-bN \2 \3 \4>\^/&&($j=437)||
	s/\^(B-aN-aN) +(<VV +[^>]*>|<VRD +[^>]*>|<VSB +[^>]*>) +(<AS +[^>]*>)(.*) +(<NP[^ ]*[^>]*>)(.*)\^/\^\1 <V-aN-bN \2 \3\4 \5\6>\^/&&($j=915)||
	# a very general rule!
	s/\^(B-aN-aN) +(<VRD +[^>]*>|<VSB +[^>]*>) (<IP-OBJ[^>]*>)\^/\^\1 <B-aN-aN-bN \2> <N \3>\^/&&($j=924)||
	s/\^(B-aN-aN) +(<VV +[^>]*>|<VRD +[^>]*>|<VSB +[^>]*>)(.*)\^/\^\1 <V-aN-bN \2\3>\^/&&($j=916)||	
	s/\^(N) +(<IP[^>]*>)\^/\^\1 <V \2>\^/&&($j=925)||

	s/\^(B-aN-aN) +<VV +([^>]*)>\^/\^\1 <V-aN-bN \2>\^/&&($j=454)||
	s/\^(B-aN-aN) +(<VV +[^>]*>) +(<NP-IO[^>]*>|<NP-PN-IO[^>]*>) +<NP-OBJ +\[-NONE-[^>]*>\^/\^\1 <V-aN-bN \2 \3>\^/&&($j=597)||
	s/\^(B-aN-aN) +(<VV +[^>]*>|<VRD +[^>]*>|<VCD +[^>]*>|<VSB +[^>]*>) +<ADVP[^ ]* +([^>]*)>\^/\^\1 <\1 \2> <R-bV \3>\^/&&($j=805)||

	s/\^(B-aN-aN) +<(VRD|VCD|VSB) +([^>]*)>\^/<\1 \3>/&&($j=470)||
	s/\^(B-aN-aN) +<VV +([^>]*)> +<VV +([^>]*)>\^/\^\1 <V-aN-bN \2> <V-aN-bN-c{V-aN-bN} \3>\^/&&($j=471)||
	...
	s/\^(B-aN-aN-c{B-aN-aN}) +(<PU[^>]*>) +(<V[^ ]* +[^>]*>)(.*)\^/\^\1 \2 <B-aN-aN \3\4>\^/&&($j=915)||
	s/\^(E-aN-gN-c{E-aN-gN}) +(<PU[^>]*>) +(<ADVP[^ ]* +[^>]*>|<PP-LOC +[^>]*>) +(<VP +[^>]*>)\^/\^\1 \2 <E-aN-gN \3 \4>\^/&&($j=808)||
	...
	s/\^(B-aN-aN) +<V[^ ]* ([^>]*)> +<NP[^ ]* \[-NONE- \*.*>\^/\^\1 <V-aN-bN \2>\^/&&($j=801)||

	s/\^(B-aN-aN[^ ]*) +<V[^ ]* ([^>]*)> +<NP[^ ]* \[-NONE-[^>]*>\^/<\1 \2>/&&($j=959)||
	...
	s/\^(B-aN-aN) +(<V[^ ]*[^>]*>) +<(IP-OBJ|CP-OBJ|IP-PRD) +([^>]*NP[^>]*\*pro\*[^>]*)>\^/<\1 \2 \4>/&&($j=578)||
	...
	s/\^(B-aN-aN[^ ]*) +(<V[^ ]*[^>]*>)(.*) +(<NP-SBJ [^>]*>) +(<VP[^>]*>)\^/\^\1 <B-aN-aN-bN \2\3> <N \[V \4 \5\]>\^/&&($j=922)||
	...
	s/\^(V-aN-bN) +<VV +([^>]*)> +(<VV +为>|<VC +为>)\^/\^\1 <V-aN \2> <V-aN-bN-a{V-aN} \3>\^/&&($j=370)||
	s/\^(V-aN-bN) +<VV +([^>]*)> +<VA +([^>]*)>\^/\^\1 <V-aN-bN \2> <V-aN-bN-a{V-aN-bN} \3>\^/&&($j=468)||
	s/\^(V-aN-bN) +<(VA|VV) +([^>]*)> +(<VV +到>)\^/\^\1 <V-aN \3> <V-aN-bN-a{V-aN} \4>\^/&&($j=411)||
	...
	s/\^(V[^ ]*) +<(LCP-MNR|LCP-TMP) +([^>]*)> +(.*)\^/\^\1 <R-bV \3> <\1 \4>\^/&&($j=865)||
...
#	s/\^(E-aN-gN) +(<VV +[^>]*>|<VRD +[^>]*>) +(<NP[^ ]* +\[-NONE-[^>]*>)(.*)\^/\^\1 <V-aN-gN \2 \3\4>\^/&&($j=409)||
	...
	s/\^(V[^ ]*) +(<LB[^ ]* +[^>]*>) +(<IP[^ ]* +[^>]*>) +(<SP +[^>]*>)\^/\^\1 <\1 \2 \3> <R-bV \4>\^/&&($j=913)||
	s/\^(V-aN) +(<LB +[^>]*>) +<(IP-OBJ|CP-OBJ|CP|IP) +([^>]*)>\^/<\1 \2 \4>/&&($j=b1)||
	s/\^(V-aN) +(<LB +[^>]*>) +(<NP-[^ ]*SBJ +[^>]*>) +<VP +([^>]*)>\^/\^\1 <V-aN-b{E-aN-gN} \2 \3> <E-aN-gN \4>\^/&&($j=b2)||
	s/\^(V-aN) +(<LB +[^>]*>) +(<NP-TPC[^>]*-NONE- \*T[^>]*>) +(<NP-[^ ]*SBJ +[^>]*>) +<VP +([^>]*)>\^/\^\1 <V-aN-b{E-aN-gN} \2 \4> <E-aN-gN \5>\^/&&($j=b2)||
	...
	s/\^(E-aN-gN) +(<VRD +[^>]*>|<VV +[^>]*>|<VSB +[^>]*>|<VCP +[^>]*>|<VA +[^>]*>|<VP +[^>]*>)(.*) +(<NP-OBJ +[^>]*>|<NP[^ ]* +[^>]*>|<LCP-OBJ[^ ]* +[^>]*>|<QP-OBJ[^ ]* +[^>]*>)\^/\^\1 <E-aN-aN \2\3 \4>\^/&&($j=b4)||
	s/\^(E-aN-gN) +(<VRD +[^>]*>|<VV +[^>]*>|<VSB +[^>]*>) +(<AS[^>]*>) +(<NP[^ ]*OBJ +[^>]*>)\^/\^\1 <E-aN-aN \2 \3 \4>\^/&&($j=527)||

	s/\^(E-aN-aN) +(<VRD +[^>]*>|<VV +[^>]*>|<VSB +[^>]*>|<VCP +[^>]*>)(.*) +(<NP[^ ]*[^>]*>|<LCP-OBJ[^>]*>|<QP-OBJ[^>]*>)\^/\^\1 <E-aN-aN-bN \2\3> <N \4>\^/&&($j=b5)||

	s/\^(E-aN-gN) +(<VV +[^>]*>) +(<NP[^ ]*OBJ +[^>]*-NONE-[^>]*>) +<IP[^ ]* +([^>]*)>\^/\^\1 <E-aN-b{V-aN}-gN \2 \3> <V-aN \4>\^/&&($j=528)||
	s/\^(E-aN-gN) +(<VRD +[^>]*>|<VCP +[^>]*>|<VCD +[^>]*>|<VPT +[^>]*>|<VSB +[^>]*>|<VV +[^>]*>)(.*) +<IP[^ ]* +([^>]*)>\^/\^\1 <\1 \2\3 \4>\^/&&($j=925)||
	s/\^(E-aN-gN) +(<PU[^>]*>) +(<VV +[^>]*>)(.*)\^/\^\1 \2 <\1 \3\4>\^/&&($j=528)||
	...
	s/\^(E-aN-aN-bN) +(<VV +[^>]*>)(.*) +<NP[^>]*>\^/\^\1 <B-aN-aN-bN \2\3>\^/&&($j=b7)||
	s/\^(E-aN-b{V-aN}-bN) +<(VRD|VV|VSB) +([^>]*)>\^/\^\1 <V-aN-b{V-aN}-bN \3>\^/&&($j=529)||
	s/\^(E-aN-gN) +(<VRD +[^>]*>|<VV +[^>]*>|<VSB +[^>]*>|<VCD +[^>]*>)(.*) +(<NP-OBJ +[^>]*-NONE- \*[^>]*>)\^/\^\1 <E-aN-bN \2\3>\^/&&($j=b15)||
	s/\^(E-aN-gN) +(<VRD +[^>]*>|<VV +[^>]*>|<VSB +[^>]*>|<VCD +[^>]*>)(.*) +(<NP-OBJ +[^>]*-NONE- \*[^>]*>)(.*) +<NP-EXT +([^>]*)>\^/\^\1 <\1 \2\3 \4\5> <R-bV \6>\^/&&($j=825)||
	s/\^(E-aN-gN) +(<VRD +[^>]*>|<VV +[^>]*>|<VSB +[^>]*>|<VCD +[^>]*>)(.*) +(<NP-OBJ +[^>]*-NONE- \*[^>]*>)(.*) +<VP +([^>]*)>\^/\^\1 <E-aN-b{V-aN}-gN \2\3 \4\5> <V-aN \6>\^/&&($j=827)||
	...
	s/\^(E-aN-gN) +(<VV +[^>]*>|<VRD +[^>]*>|<VCP +[^>]*>|<VCD +[^>]*>|<VPT +[^>]*>|<VSB +[^>]*>) +(<NP-OBJ \[-NONE- \*pro\*+[^>]*>|<NP-SBJ \[-NONE- \*[^>]*>) +<VP +([^>]*)>\^/\^\1 <E-aN-b{V-aN}-gN \2 \3> <V-aN \4>\^/&&($j=b8)||
	s/\^(E-aN-b{V-aN}-gN) +(<VV +[^>]*>|<VRD +[^>]*>|<VCP +[^>]*>|<VCD +[^>]*>|<VPT +[^>]*>|<VSB +[^>]*>) +(<NP-OBJ \[-NONE- \*pro\*+[^>]*>|<NP-SBJ \[-NONE- \*[^>]*>)\^/\^\1 <E-aN-b{V-aN}-bN \2>\^/&&($j=b9)||
...
#	s/\^(E-aN-gN) +(<VV +[^>]*>|<VCD [^>]*>) +(<AS +[^>]*>) +(<NP[^ ]*OBJ +[^>]*>)\^/\^\1 <\1 \2 \3>\^/&&($j=526)||
	...
	s/\^(V-aN) +(<VV[^>]*>|<VSB[^>]*>|<VRD[^>]*>|<VE[^>]*>) +(<NP[^ ]*-OBJ[^>]*>|<LCP[^ ]*-OBJ[^>]*>) +(<IP[^>]*\*PRO\*[^>]*>)\^/\^\1 <V-aN-b{V-aN} \2 \3> <V-aN \4>\^/&&($j=119)||
	s/\^(V-aN-gN) +(<VV[^>]*>|<VSB[^>]*>|<VRD[^>]*>|<VE[^>]*>) +(<NP[^ ]*-OBJ[^>]*>) +(<IP[^>]*\*PRO\*[^>]*-NONE- \*T\*[^>]*>)\^/\^\1 <V-aN-b{V-aN} \2 \3> <V-aN-gN \4>\^/&&($j=615)||
	s/\^(V-aN-gN) +<(IP) +([^>]*\*PRO\*[^>]*-NONE- \*T\*[^>]*)>\^/<\1 \3>/&&($j=616)||
	s/\^(V-aN-gN) +(<VP[^>]*>) +(<ADVP[^>]*>)\^/\^\1 <\1 \2> <R-bV \3>\^/&&($j=953)||
	s/\^(V-aN-gN) +(<VV[^>]*>) +(<VA[^>]*>) +(<AS[^>]*>) +(<NP-OBJ[^>]*-NONE-[^>]*>)\^/\^\1 <V-aN-bN \2 \3 \4>\^/&&($j=954)||
	s/\^(V-aN-bN) +(<VV[^>]*>) +(<VA[^>]*>) +(<AS[^>]*>)\^/\^\1 <V-aN-bN \2 \3> <R-bV \4>\^/&&($j=955)||
	...
	s/\^(V-aN-b{V-aN}) +<(VV|VSB|VRD|VE)([^>]*)> +(<NP[^ ]*-OBJ[^>]*>|<LCP[^ ]*-OBJ[^>]*>)\^/\^\1 <V-aN-b{V-aN}-bN\3> <N \4>\^/&&($j=120)||
	s/\^(V-aN-b{V-aN}) +<VP[^ ]* ([^>]*)> +<NP[^ ]* ([^>]*)>\^/\^\1 <V-aN-b{V-aN}-bN \2> <N \3>\^/&&($j=143)||
	s/\^(V-aN) +<NP +\[-NONE- \*PRO[^>]*> +(<VP +[^>]*>)\^/<\1 \2>/&&($j=554)||
	s/\^(V-aN) +(<VV[^>]*>) +(<NP-IO[^>]*>) +(<PU[^>]*>) +(<CP[^ ]* +[^>]*>|<IP[^ ]* +[^>]*>)\^/\^\1 <\1-bV \2 \3 \4> <V \5>\^/&&($j=959)||
	s/\^(V-c{V}|V-cV) +(<CC[^>]*>) +(<IP[^ ]* +[^>]*>)\^/\^\1 <\1-d{V} \2> <V \3>\^/&&($j=960)||
	s/\^(V-c{V}-d{V}|V-cV-dV) +<CC ([^>]*)>\^/<\1 \2>/&&($j=962)||
	s/\^(V-aN-gN) +<SKIP ([^>]*)> +(<VP[^ ]* +[^>]*-NONE-[^>]*>)\^/\^\1 <R-bV \2> <\1 \3>\^/&&($j=961)||
	s/\^(V) +<UCP ([^>]*)> +(<IP[^ ]* +[^>]*>)(.*)\^/\^\1 <V \2> <V-cV \[V \3\4\]>\^/&&($j=961)||
	

        #focus structure
	s/\^(V-aN[^ ]*) +<NP-FOC[^ ]* +([^>]*)> +(.*)\^/\^\1 <N \2> <\1-gN \3>\^/&&($j=foc1)||
	s/\^(V-aN[^ ]*) +<NP-FOC +([^>]*)> +<VP +([^>]*)>\^/\^\1 <R-bV \2> <\1 \3>\^/&&($j=467)||
	...
	s/\^(V-aN) +(<VC[^>]*>) +(<IP-PRD[^>]*>) +(<SP 的>)\^/\^\1 <V-aN-bN \2> <N \3 \4>\^/&&($j=941)||
	s/\^(N) +<IP-PRD ([^>]*)> +<SP (的)>\^/\^\1 <V \2> <N-aV \3>\^/&&($j=942)||
	...
	s/\^(V-aN[^ ]*|E-aN[^ ]*|B-aN[^ ]*) +(<VA[^>]*>|<VV[^>]*>|<VRD[^>]*>)(.*) +<(LCP-EXT[^>]*|QP-EXT[^>]*)>\^/\^\1 <\1 \2\3> <R-bV [\4]>\^/&&($j=30)||
	...
	s/\^(V-aN-bN) +(<VRD +[^>]*>|<VV +[^>]*>) +(<AS +[^>]*>)(.*) +(<NP-OBJ +[^>]*-NONE-[^>]*>)\^/<\1 \2 \3\4>/&&($j=809)||
	s/\^(V-aN) +<(VP|VV) +([^>]*)> +(<VP-PRP +[^>]*>|<PP[^ ]* +[^>]*>)\^/\^\1 <\1 \3> <R-bV \4>\^/&&($j=226)||
	s/\^(R-bV) +<VP-PRP +([^>]*)>\^/\^\1 <V-aN \2>\^/&&($j=227)||
	s/\^(R-bV) +<P +([^>]*)> +<QP-PN ([^>]*)>\^/\^\1 <R-bV-bN \2> <N \3>\^/&&($j=954)||
	...
	s/\^(Q) +(<CD[^>]*>|<OD[^>]*>)(.*) +<(CLP[^ ]*) +([^>]*)>\^/\^Q <C \2\3> <Q-aC \5>\^/&&($j=830)||
	...
	s/\^(Q-bN) +(<CD[^>]*>|<OD[^>]*>)(.*) +<(CLP) +([^>]*)>\^/\^\1 <C \2\3> <Q-bN-aC \5>\^/&&($j=843)||
	s/\^(Q-bN) +(<CD[^>]*>|<OD[^>]*>)(.*) +<(NP) +(\[M[^>]*)>\^/\^\1 <C \2\3> <Q-bN-aC \5>\^/&&($j=859)||
	s/\^(Q-bN) +(<NP +[^>]*>) +<(QP) +([^>]*)>\^/\^\1 <A-bN \2> <\1 \4>\^/&&($j=530)||
	s/\^(Q) +(<LCP +[^>]*>) +<(QP) +([^>]*)>\^/\^\1 <R-bV \2> <\1 \4>\^/&&($j=845)||
	s/\^(Q) +(<NP +[^>]*>) +(.*)(<DP +[^>]*>)\^/\^\1 <A-bN \2> <\1 \3\4>\^/&&($j=846)||
	s/\^(Q) +<DP +([^>]*)>\^/<Q \2>/&&($j=847)||
	s/\^(Q) +<DT +([^>]*)> +<QP +([^>]*)>\^/\^\1 <A-bN \2> <\1 \3>\^/&&($j=848)||
	s/\^(Q) +(<QP +[^>]*>) +(<QP +[^>]*>)(.*)\^/\^\1 <\1 \2> <Q-cQ [\1 \3\4]>\^/&&($j=849)||
#	s/\^(Q-bN) +<CD +([^>]*)> +<(NP) +([^>]*)>\^/\^\1 <\1-bN \2> <N \4>\^/&&($j=601)||

	s/\^(Q-bN) +<QP +([^>]*)> +(<QP +[^>]*>)\^/\^\1 <\1 \2> <\1-c{\1} \3>\^/&&($j=546)||
	s/\^(Q-bN-c{Q-bN}) +(<QP +[^>]*>)\^/\^\1 <Q-bN \2>\^/&&($j=547)||

	s/\^(Q-bN) +<(QP|CD|OD) +([^>]*)> +(<CC +[^>]*>|<PU[^>]*>) +(<QP +[^>]*>|<CD +[^>]*>|<OD +[^>]*>)(.*)\^/\^\1 <\1 \3> <\1-c{\1} \4 \5\6>\^/&&($j=531)||
	
	s/\^Q-bN-c{(Q-bN)} +(<CC +[^>]*>) +(<QP +[^>]*>|<CD +[^>]*>|<OD +[^>]*>)(.*)\^/\^\1-c{\1} <\1-c{\1}-d{\1} \2> <\1 \3\4>\^/&&($j=532)||       
	s/\^Q-bN-c{(Q-bN)} +(<PU +[^>]*>) +(<QP +[^>]*>|<CD +[^>]*>|<OD +[^>]*>)(.*)\^/\^\1-c{\1} \2 <\1 \3\4>\^/&&($j=846)||       
	s/\^(Q-bN[^ ]*) +(<CD +[^>]*>) +(<CC +[^>]*>) +(<CD +[^>]*>) +<(CLP)([^>]*)>\^/\^\1 <C \2 \3 \4> <Q-bN-aC\6>\^/&&($j=372)||
	s/\^(C) +<(CD|OD) +([^>]*)> +(<CC +[^>]*>|<PU +[^>]*>) +(<CD +[^>]*>|<OD +[^>]*>)(.*)\^/\^\1 <C \3> <C-cC \4 \5\6>\^/&&($j=373)||
	s/\^(C) +<(CD|OD) +([^>]*)> +(<CD +[^>]*>|<OD +[^>]*>)(.*)\^/\^\1 <C \3> <C-cC \[C \4\5\]>\^/&&($j=373)||
	s/\^(Q) +(<CD +[^>]*>) +(<CC +[^>]*>|<PU +[^>]*>) +(<CD +[^>]*>)(.*)\^/\^\1 <C \2 \3 \4\5>\^/&&($j=456)||
#	s/\^(Q) +(<CD +[^>]*>) +(<CC +[^>]*>) +(<CD +[^>]*>)\^/\^\1 <C \2 \3 \4>\^/&&($j=456)||
	s/\^(C-cC) +<CC +([^>]*)> +<(CD|OD) +([^>]*)>\^/\^\1 <C-cC-dC \2> <C \4>\^/&&($j=374)||
	s/\^(C-cC) +(<PU +[^>]*>) +(<CD +[^>]*>)(.*)\^/\^\1 \2 <C \3\4>\^/&&($j=810)||
	...
	s/\^(V-aN[^ ]*) +<(NP-PRD) +([^>]*)>\^/\^\1 <N \3>\^/&&($j=862)||

	s/\^(V-aN[^ ]*) +<(VP|VRD|VSB|PP-PRD|VPT|NP-PRD|VP-WH|JJ|VNV|VC) +([^>]*)>\^/<\1 \3>/&&($j=7)||
	s/\^(V-aN) +<(NP) +(\[QP[^>]*)>\^/\^ \1 <Q \3>\^/&&($j=516)||
	s/\^(E-gN|B-aN[^ ]*) +<(VP) +([^>]*)>\^/<\1 \3>/&&($j=453)||
	#collaps N (NP ...) --> N
	s/\^(N-c{N}) +<NR +([^>]*)>\^/\^\1 <N \2>\^/&&($j=577)||
#	s/\^(N-gN) +<NP-SBJ +([^>]*-NONE- \*T[^>]*)>\^/\^\1 <\1 \2>\^/&&($j=827)||

       	s/\^(N[^ ]*) +<(NN|NR|NP-PN[^ ]*|NP-OBJ[^ ]*|NT|NP-TTL|LCP|NP-PRD|PN|NP|NP-WH-PRD|NP-EXT|LCP-OBJ|LCP-SBJ|FW|LC|NP-IO|NP-SBJ[^ ]*|NP-APP|NP[^ ]*PN|DP-OBJ|DP|DT|NP-WH-OBJ|LCP-PRD|URL|NP[^ ]*|AD|ADJP) ([^>]*)>\^/<\1 \3>/&&($j=20)||
	s/\^(N) +<(ADVP) ([^>]*)> +<LC ([^>]*)>\^/\^\1 <R-bV \3> <N-a{R-bV} \4>\^/&&($j=929)||
	s/\^(N) +<(AD|ADVP) ([^>]*)> +(.*)\^/\^\1 <R-bV \3> <\1 \4>\^/&&($j=928)||

	#collaps V-aN
	s/\^(V-aN-b{V-aN}-gN) +<(VV) ([^>]*)>\^/\^\1 <V-aN-b{V-aN}-bN \3>\^/&&($j=548)||

#	s/\^(V-aN-gN) +<(VV) ([^>]*)>\^/\^\1 <V-aN-bN \3>\^/&&($j=837)||

	s/\^(V[^ ]*) +<(VV) ([^>]*)>\^/<\1 \3>/&&($j=21)||
	s/\^(V-aN-bN) +<(VE|VC|VCP) ([^>]*)>\^/<\1 \3>/&&($j=158)||
	...
	s/\^(Q-aC[^ ]*) +<(M|NN|CLP) ([^>]*)>\^/<\1 \3>/&&($j=33)||
	s/\^(N-bQ[^ ]*) +<(DT) ([^>]*)>\^/<\1 \3>/&&($j=91)||
	s/\^(N-aN) +<(LC) ([^>]*)>\^/<\1 \3>/&&($j=102)||
	s/\^(Q-bN[^ ]*) +<(CD|OD|CLP|DT) ([^>]*)>\^/<\1 \3>/&&($j=81)||
	s/\^(Q-bN-aC[^ ]*) +<(M) ([^>]*)>\^/<\1 \3>/&&($j=73)||	
	s/\^(N-c{N}[^ ]*) +<(JJ|ETC|DT) ([^>]*)>\^/<\1 \3>/&&($j=37)||
	s/\^(A-bN) +<(NR|NT) +([^>]*)>\^/\^\1 <N \3>\^/&&($j=560)||

	s/\^(A-bN) +<(JJ|DT|AD|ADJP|LKK|DNP|IJ) ([^>]*)>\^/<\1 \3>/&&($j=51)||
	s/\^(N) +<(NOI) ([^>]*)>\^/<\1 \3>/&&($j=961)||
	s/\^(V) +<(INTJ|IJ) ([^>]*)>\^/<\1 \3>/&&($j=961)||
	s/\^(A-bN) +<PP[^ ]* ([^>]*)>\^/\^\1 <R-bV \2>\^/&&($j=914)||
	s/\^(A-bN-bN) +<(AD) ([^>]*)>\^/<\1 \3>/&&($j=51)||
	s/\^(A-bN-aN[^ ]*|A-bN-a{A-bN}|A-bN-a{R-bV}) +<(DEG) ([^>]*)>\^/<\1 \3>/&&($j=48)||
	s/\^(R-bV[^ ]*) +<(AD|LCP-TMP|LCP|CS|LCP-EXT|ADVP[^ ]*|NP|VP|VV|CC|DT|JJ|VA|INTJ|IJ) +([^>]*)>\^/<\1 \3>/&&($j=55)||
	s/\^(R-bV[^ ]*) +<(PP[^ ]*) ([^>]*)>\^/<\1 \3>/&&($j=67)||
	s/\^(R-bV-a{R-bV}|R-bV-aN) +<(SP[^ ]*) ([^>]*)>\^/<\1 \3>/&&($j=895)||
	s/\^(C) +<(CD|OD) +([^>]*)>\^/<\1 \3>/&&($j=826)||
...
#	s/\^(V-aN-g{R-bV}) +<(PP[^ ]*|NP-MNR[^ ]*|NP-PRP[^ ]*) +[^>]*-NONE- \*T\*[^>]*> +(.*<VP[^>]*>)\^/\^\1 <V-aN \3>\^/&&($j=315)||
	...
	s/\^(V|V-aN) +(.*) +(<FLR \[SP 的话\]>) +(<PU[^>]*>) (.*)\^/\^\1 <R-bV \2 \3 \4> <\1 \5>\^/&&($j=891)||
#	s/\^(V|V-aN) +(.*) +(<FLR \[SP 的话\]>) +(.*)\^/\^\1 <R-bV \2 \3> <\1 \4>\^/&&($j=897)||
	s/\^(V) +<FLR ([^>]*)> +(.*)(<NP-SBJ[^>]*>) +(<VP[^>]*>)(.*)\^/\^\1 <R-bV \2> <\1 \3\4 \5\6>\^/&&($j=816)||
	s/\^(N) +<FLR ([^>]*)> +(<NP +[^>]*>|<NT +[^>]*>|<NP-PN[^>]*>)(.*)\^/\^\1 <A-bN \2> <\1 \3\4>\^/&&($j=836)||

	s/\^(V|V-aN[^ ]*|V-g[^ ]*|E-[^ ]*|B-aN[^ ]*) +<(ADVP[^ ]*|PP[^ ]*|IP-ADV|IP-TMP|IP-CND|CP-ADV|LCP-ADV|AD) +([^>]*)> (.*)\^/\^\1 <R-bV [\2 \3]> <\1 \4>\^/&&($j=10)||
	s/\^(V-aN[^ ]*|V-g[^ ]*) +(<VV +[^>]*>)(.*) +(<(ADVP[^ ]*|PP[^ ]*) +[^>]*>)\^/\^\1 <\1 \2\3> <R-bV \4>\^/&&($j=380)||
	...
	s/\^(R-bV) +<IP +([^>]*)>\^/\^\1 <V \2>\^/&&($j=853)||
	s/\^(R-bV) +(<QP +[^>]*>) +(<NP +[^>]*>)\^/\^\1 <N \2 \3>\^/&&($j=242)||
	s/\^(R-bV) +<ADVP[^ ]* +([^>]*)> +<LC +([^>]*)>\^/\^\1 <R-bV \2> <\1-a{R-bV} \3>\^/&&($j=604)||
	s/\^(R-bV) +<P +([^>]*)> +<(LCP[^ ]*|NN) +([^>]*)>\^/\^\1 <R-bV-bN \2> <N \4>\^/&&($j=605)||
	s/\^(R-bV) +<PP[^ ]* +([^>]*)> +<LC[^ ]* +([^>]*)>\^/\^\1 <\1 \2> <\1-a{\1} \3>\^/&&($j=607)||
	s/\^(R-bV) (.*) +(<PU[^>]*>)\^/\^\1 <\1 \2> \3\^/&&($j=892)||
	s/\^(R-bV) +<PP[^ ]* +([^>]*)> +(<CC +[^>]*>.*)\^/\^\1 <\1 \2> <\1-c{\1} \3>\^/&&($j=903)||
	s/\^(R-bV) +<PP[^ ]* +([^>]*)> +(.*)\^/\^\1 <\1 \2> <\1 \3>\^/&&($j=606)||
	s/\^(R-bV) +(<PU[^>]*>) +(.*)\^/\^\1 \2 <\1 \3>\^/&&($j=892)||
	s/\^(R-bV) +<QP[^ ]* +([^>]*)> +<DEV +([^>]*)>\^/\^\1 <Q \2> <R-bV-aQ \3>\^/&&($j=608)||
	...
	s/\^(N) +(<LCP-TMP +[^>]*>|<LCP +[^>]*>|<QP-TMP +[^>]*>) +(<DNP[^>]*>) +(<NP[^>]*>)\^/\^\1 <R-bV \2> <\1 \3 \4>\^/&&($j=838)||
	s/\^(N) +(<LCP +[^>]*>) +<LC +([^>]*)>\^/\^\1 <N \2> <N-aN \3>\^/&&($j=851)||
	s/\^(N) +<MSP +([^>]*所[^>]*)> +<(VP) +([^>]*)>\^/\^\1 <N-b{V-aN} \2> <V-aN \4>\^/&&($j=852)||
	s/\^(N) +(<LCP +[^>]*>) +(<CC[^>]*>) +(<LCP[^>]*>)\^/\^\1 <\1 \2> <N-c{N} \3 \4>\^/&&($j=839)||
	s/\^(N) +(<IP +[^>]*>) +(<CC[^>]*>) +(<NP[^>]*>)(.*)\^/\^\1 <\1 \[V \2\]> <N-c{N} \3 \4\5>\^/&&($j=850)||
	s/\^(N) +(<IP +[^>]*>) +(<NP[^>]*>)\^/\^\1 <V \2> <N-aV \3>\^/&&($j=851)||
#	s/\^(V-aN-gN) +(<NP-TMP +\[-NONE- \*T\*[^>]*>) +(<VP[^>]*>)\^/\^\1 <\1 \3>\^/&&($j=865)||
	s/\^(V-aN|V-aN-gN) +(<LCP-TMP +[^>]*>|<LCP +[^>]*>|<QP-TMP +[^>]*>|<PP-BNF[^>]*>|<PP[^ ]* +[^>]*>) +(.*)(<VP[^>]*>)\^/\^\1 <R-bV \2> <\1 \3\4>\^/&&($j=473)||
	...
	s/\^(V) +(<NP[^ ]*SBJ +[^>]*>) +(<[^ ]*-TMP[^>]*>) +(<VP +[^>]*>)\^/\^\1 <N \2> <V-aN \3 \4>\^/&&($j=842)||
	s/\^(V) +(<NP[^ ]*SBJ +[^>]*>) +(<FLR[^>]*>)(<VP +[^>]*>)\^/\^\1 <N \2> <V-aN \3\4>\^/&&($j=917)||
	s/\^(V-aN) +(<VV +[^>]*>) +(<FLR[^>]*>) +(<NP[^ ]*OBJ +[^>]*>)\^/\^\1 <V-aN-bN \2 \3> <N \4>\^/&&($j=918)||
	s/\^(V-g{R-bV})([^ ]*) +<NP[^ ]*LOC +[^>]*-NONE- \*T\*[^>]*> +(<IP[^ ]* +[^>]*>)\^/\^\1\2 <V\2 \3>\^/&&($j=461)||
	s/\^(V-aN-g{R-bV}) +(<QP[^ ]*TMP +[^>]*-NONE- \*T\*[^>]*>) +(.*)\^/\^\1 <V-aN \3>\^/&&($j=863)||
	s/\^(V[^ ]*) +<(NP-LOC|DP-TMP|NP-PN-LOC) +([^>]*)> (.*)\^/\^\1 <R-bV [N \3]> <\1 \4>\^/&&($j=60)||
	#s/\^(V[^ ]*) +<(LCP-TMP) +([^>]*)> +(.*)\^/\^\1 <R-bV \3> <\1 \4>\^/&&($j=330)||
	s/\^(V[^ ]*) +(<VV[^>]*>) +(<FLR \[SP 呢\]>) +(.*) +(<IP-OBJ[^>]*>)(.*)\^/\^\1 <V-aN-bV \2 \3 \4> <V \5\6>\^/&&($j=946)||
	s/\^(V) +(<NP-SBJ[^>]*>) +(.*) +(<VP[^>]*>)(.*)\^/\^\1 <N \2> <V-aN \3 \4\5>\^/&&($j=947)||
	s/\^(V[^ ]*) +(.*)(<FLR \[SP 呢\]>) +(.*)\^/\^\1 <R-bV \2\3> <\1 \4>\^/&&($j=854)||
	s/\^(R-bV) +(<ADVP[^>]*>)(.*) +(<FLR \[SP 的话\]>)\^/\^\1 <\1 \2\3> <R-bV-b{\1} \4>\^/&&($j=855)||
	s/\^(V[^ ]*) +(.*) +(<FLR \[SP 的话\]>) +(.*)\^/\^\1 <R-bV \2 \3> <\1 \4>\^/&&($j=856)||
	s/\^(R-bV[^ ]*) +<(FLR|SP) +([^>]*)>\^/<\1 \3>/&&($j=856)||
	s/\^(V[^ ]*) +<(LCP-TMP) +([^>]*)> +(.*)\^/\^\1 <R-bV \3> <\1 \4>\^/&&($j=330)||
	s/\^(V-aN) +(<VV +[^>]*>) +(<AS +[^>]*>) +<(LCP-EXT) +([^>]*)>\^/\^\1 <\1 \2 \3> <R-bV \5>\^/&&($j=330)||
	s/\^(V-aN) +(<VV +[^>]*>) +(<AS +[^>]*>) +(<QP-EXT +[^>]*>)\^/\^\1 <\1 \2 \3> <R-bV \4>\^/&&($j=474)||
	s/\^(V-aN) +(<VV +[^>]*>) +(<QP-EXT +[^>]*>)\^/\^\1 <\1 \2> <R-bV \3>\^/&&($j=820)||
	s/\^(V-aN)-c{V-aN} +<(PU +[^>]*)> +(.*)\^/\^\1-c{\1} <\2> <\1 \3>\^/&&($j=23)||
	s/\^(V-c{V}|V-cV) +<(PU +[^>]*)> +(<IP +[^>]*>)(.*)\^/\^\1 <\2> <V \3\4>\^/&&($j=405)||
	s/\^(V) +<(CP[^ ]*|IP[^ ]*) +([^>]*)> +(<PU[^>]*>) +(<IP[^ ]* +[^>]*>|<CP[^ ]* +[^>]*>)(.*)\^/\^\1 <V \3> <V-cV \4 \5\6>\^/&&($j=546)||
	s/\^(V) +<IP[^ ]* +([^>]*)> <SP +([^>]*)>\^/\^\1 <V \2> <R-bV \3>\^/&&($j=547)||
	s/\^(V-aN) +(<VV[^ ]* +[^>]*>.*|<VA[^ ]* +[^>]*>.*) <SP +(了)>\^/\^\1 <\1 \2> <R-bV \3>\^/&&($j=548)||
	s/\^(V-aN) +(<VV[^ ]* +[^>]*>)(.*) (<SP[^>]*>)\^/\^\1 <\1 \2\3> <R-bV \4>\^/&&($j=918)||
	...
	s/\^(V-c{V}|V-cV) +<(PU +[^>]*)> +(<CP[^ ]* +[^>]*>|<IP[^ ]* +[^>]*>)(.*)\^/\^\1 <\2> <V \3\4>\^/&&($j=406)||
	s/\^(V-cV|V-c{V}) +<(PU +[^>]*)> +(<CP[^ ]* +[^>]*>|<IP[^ ]* +[^>]*>)(.*)\^/\^\1 <\2> <V \3\4>\^/&&($j=406)||
	s/\^(V-cV|V-c{V}) +(<PU 、>) +(.*)\^/\^\1 \2 <V \3>\^/&&($j=952)||
	s/\^(V[^ ]*) +<(PU +[^>]*)> +(.*)\^/\^\1 <\2> <\1 \3>\^/&&($j=79)||
	s/\^(V-aN[^ ]*) +<VP[^ ]* +(.*\[ADVP +\[AD 一[^>]*)> (<VP[^>]*>)\^/\^\1 <R-bV \2> <\1 \3>\^/&&($j=68)||
	s/\^(V-aN[^ ]*) +(<VV[^ ]* [^>]*>) +(<ADVP[^>]*>)(.*) +(<NP-OBJ[^>]*>)\^/\^\1 <V-aN-bN \2 \3\4> <N \5>\^/&&($j=821)||
	s/\^(V-aN[^ ]*) +<VV[^ ]* +(没有)> (<VP[^>]*>)\^/\^\1 <R-bV \2> <\1 \3>\^/&&($j=70)||
	s/\^(V-aN[^ ]*) +(<VV[^ ]*[^>]*>)(.*) +(<PU[^>]*>)\^/\^\1 <\1 \2\3> \4\^/&&($j=114)||
	s/\^(V-aN) +(<VV +[^>]*>|<VP +[^>]*>|<VSB +[^>]*>|<VRD +[^>]*>) +(<PU +[^>]*>) +<IP[^ ]* +([^>]*)>\^/\^\1 <V-aN-bV \2 \3> <V \4>\^/&&($j=173)||
	s/\^(V-aN) +(<VV +[^>]*>|<VSB +[^>]*>|<VRD +[^>]*>) +(<PU +[^>]*>) +(<NP[^ ]*OBJ +[^>]*>)\^/\^\1 <V-aN-bN \2 \3> <N \4>\^/&&($j=818)||
	s/\^(V-aN) +(<VV +[^>]*>|<VSB +[^>]*>|<VRD +[^>]*>) +(<PU +[^>]*>) +(<VP +[^>]*>)\^/\^\1 <V-aN-b{V-aN} \2 \3> <V-aN \4>\^/&&($j=819)||
	s/\^(V-aN) +(<VC +[^>]*>) +(<PU +[^>]*>) +(<NP[^>]*PRD +[^>]*>)\^/\^\1 <V-aN-bN \2 \3> <N \4>\^/&&($j=820)||
	s/\^(V-aN) +(<VCP +[^>]*>) +(<QP-OBJ +[^>]*>)\^/\^\1 <V-aN-bN \2> <N \3>\^/&&($j=821)||
	s/\^(V-aN) +(<VC +[^>]*>) +(<LCP-PRD +[^>]*>)\^/\^\1 <V-aN-bN \2> <N \3>\^/&&($j=822)||

	s/\^(V-aN|B-aN[^ ]*|E-aN[^ ]*) +(<VV +[^>]*>)(.*) +<PP[^ ]* +([^>]*)>\^/\^\1 <\1 \2\3> <R-bV \4>\^/&&($j=194)||
...
#	s/\^(V-aN-bV) +<VV +([^>]*)> +<VV +([^>]*)>\^/\^\1 <V-aN-bN \2> <\1-a{\1} \3>\^/&&($j=219)||
	...
	s/ \^(N|N-gN|N-gN-\d+|N-\d+|Q|R-bV|Q-aC) +(<-NONE- \*pro\*>|<-NONE- \*PRO\*>|<-NONE- \*-\d>|<-NONE- \*T[^>]*>|<-NONE- \*RNR[^>]*>)\^//&&($j=156)||
	s/ \^R-bV +<Q \[-NONE- \*RNR\*-\d\]>\^//&&($j=508)||
	s/ \^R-bV +<N \[-NONE- \*pro\*\]>\^//&&($j=864)||
	#s/ \^Q-aC +<-NONE- \*T\*[^>]*>\^//&&($j=529)||

	s/ \^(N[^ ]*) +<N \[N[^ ]* \[-NONE- \*(pro|T)\*[^ ]*\^//&&($j=444)||
	
	#misc
        s/\^(V[^ ]*) +(<LST +[^>]*>) +(<PU[^>]*>) +(.*)\^/\^\1 <R-bV \2 \3> <\1 \4>\^/&&($j=307)||
	s/\^(R-bV) +<LST +([^>]*)> +(<PU +[^>]*>)\^/\^\1 <\1 \2> \3\^/&&($j=308)||
        s/\^(V[^ ]*) +(<LST +[^>]*>) +(.*)\^/\^\1 <R-bV \2> <\1 \3>\^/&&($j=307)||
        s/\^(LST) +<PU +([^>]*)>\^/<PU \2>/&&($j=308)||
	# exceptions
	s/\^(N) +<NP ([^>]*)> +<ADJP ([^>]*)>\^/\^\1 <A-bN \[N  \2\]> <N \3>\^/&&($j=e1)||
	s/\^(N) +<JJ ([^>]*)>\^/\^\1 \2\^/&&($j=e2)||
	#some gaps are not annotated 
	s/\^(V-gN) +<(VP) +([^>]*)>\^/<\1 \3>/&&($j=813)||
	s/\^(V-gN) +<(VCD|VRD|VSB) +([^>]*)> <(QP-EXT) +([^>]*)>\^/\^\1 <\1 [V-aN \3]> <R-bV [Q \5]>\^/&&($j=814)||
	s/\^(V-aN-gN) +<(VP|VC) +([^>]*)> <NP[^ ]* +\[-NONE- \*T[^>]*>\^/\^\1 <V-aN-bN \3>\^/&&($j=942)||

	#too general rules are at bottom
	s/\^(V) +(<WHNP[^ ]*[^>]*>) +<IP +([^>]*)>\^/<\1 \3>/&&($j=835)||
	s/\^([^ ]*) +(.*) +(<PU +[^>]*>)\^/\^\1 <\1 \2> \3\^/&&($j=PU)||
	s/\^(N) +(<DNP +[^>]*>)\^/\^\1 <A-bN \2>\^/&&($j=835)||
	s/\^(N) +(<IP +[^>]*>) +<SP ([^>]*的[^>]*)>\^/\^\1 <V \2> <N-aV \3>\^/&&($j=836)||
	s/\^(N) +(<VA +[^>]*>|<VV +[^>]*>)(.*) +<SP ([^>]*的[^>]*)>\^/\^\1 <V-aN \2\3> <N-a{V-aN} \4>\^/&&($j=841)||
	s/\^(N) +(<PU +[^>]*>) +(.*)\^/\^\1 \2 <\1 \3>\^/&&($j=839)||
	s/\^(N) +(<QP +[^>]*>) +(<NP +[^>]*>) +(<PRN +[^>]*>)\^/\^\1 <\1 \2 \3> <A-bN \4>\^/&&($j=840)||
	s/\^(N) +(<N[^>]*>)(.*) +(<PRN +[^>]*>)\^/\^\1 <\1 \2\3> <A-bN \4>\^/&&($j=852)||
	s/\^(N) +(.*) +(<PRN +[^>]*>)\^/\^\1 <N \2> <A-bN \3>\^/&&($j=858)||
	s/\^(N) +<(VV) +([^>]*)>\^/<\1 \3>/&&($j=859)||
	s/\^(N) +<(VV) +([^>]*)> (<N[^>]*>)\^/\^\1 <A-bN \3> <\1 \4>\^/&&($j=860)||
	s/\^(N) +(<VV +[^>]*>) (<VV[^>]*>)\^/\^\1 <\1 \2> <N-c{N} \[N \3\]>\^/&&($j=861)||
        s/\^(N[^ ]*) +<CC +([^>]*)> +(<NP[^>]*>|<PN[^>]*>|<NN[^>]*>) +(.*)\^/\^\1 <R-bV \2> <\1 \3 \4>\^/&&($j=857)||
        s/\^(N) +<DP +([^>]*)> +(<NP[^>]*>) +(<PRN[^>]*>)\^/\^\1 <A-bN \2> <\1 \3 \4>\^/&&($j=860)||
        s/\^(N) +(<NP +[^>]*>) +(<FLR \[SP 呀[^>]*>|<FLR \[SP 呢[^>]*>|<FLR \[SP 嘛[^>]*>)\^/\^\1 <N \2> <R-bV \3>\^/&&($j=861)||
	# annotate FLR as \1-UNF
        s/\^([^ ]*) +(<[^ ]* +[^>]*>)(.*) +(<FLR[^>]*>)\^/\^\1 <\1 \2\3> <\1-UNF \4>\^/&&($j=919)||
        s/\^([^ ]*) +(<FLR[^>]*>) +(<[^ ]* +[^>]*>)(.*)\^/\^\1 <\1-UNF \2> <\1 \3\4>\^/&&($j=920)||
#        s/\^([^ ]*) +<FLR ([^>]*)>\^/<\1 \2>/&&($j=924)||
        s/\^([^ ]*-UNF) +<([^ ]*) ([^>]*)>\^/<\1 \3>/&&($j=924)||
	# DFL --> ADVP
	s/\^([^ ]*) (.*) +<DFL ([^>]*)> +(.*)\^/<\1 \2 <ADVP \3> \4>/&&($j=921)||
	s/\^([^ ]*) +<DFL ([^>]*)> +(.*)\^/<\1 <ADVP \2> \3>/&&($j=922)||
	s/\^([^ ]*) (.*) +<DFL ([^>]*)>\^/<\1 \2 <ADVP \3>>/&&($j=923)||
	# IJ and INTJ
	s/\^([^ ]*) +(<INTJ[^>]*>|<IJ[^>]*>) +(<PU[^>]*>) +(.*)\^/\^\1 <\1 \2> <\1-c{\1} \3 \4>\^/&&($j=924)||
	
	# for cases where V and V-aN are coordinated
	s/\^(V-aN) +(<NP-SBJ [^>]*>|<IP-SBJ [^>]*>) +(<VP[^>]*>)\^/<V \2 \3>/&&($j=926)||
	# deletel empty categories
	s/\^[^ ]* +<-NONE-[^>]*>\^//&&($j=925)||
...
#        		while( s/\^(.*)<NN(S|P)? (.*)\^/\^\1<NP\2 \3\^/ && ($j=0.2) ) {}  #(this is to fix sent 7919)
  ...
  # unify N-c{N} N-cN V-c{V}
  s/([NV])-c{([NV])}-d{([NV])}/\1-c\2-d\3/g;
  s/([NV])-c{([NV])}/\1-c\2/g;
  s/ \)/\)/g;
#  s/ \(/\(/g;
