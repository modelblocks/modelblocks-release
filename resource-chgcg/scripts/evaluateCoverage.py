...
stopNum = sys.argv[5]
annotTB = open(sys.argv[6], "wb")


#diffSen = [179, 503, 3205, 3362, 4746, 5345, 6312, 6313, 7752, 10934, 18670, 39332, 47280, 50064]
diffSen = []
unannotList = []
annotList =[]
lineNum = 0
...
chtbF = sys.argv[7]
tbline = 0
for line in file(sys.argv[7]):
    tbline += 1
    if tbline in unannotList:
        unannotF.write(line)
    elif tbline in annotList:
        annotTB.write(line)
