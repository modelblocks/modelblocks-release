...
# NOTE: tensorflow-gpu<2.0 because of CDR
conda install -c conda-forge compilers libblas liblapack arpack superlu mkl python scipy pandas librosa r-base r-lme4 r-languageR r-optimx r-ggplot2 r-optparse tensorflow-gpu"<2.0" pytorch torchvision cudatoolkit=10.1 -c pytorch
