...
#WORSE:        s/\^(SS|VS\-iNS|QS|CS|ES|[VIBLAG]S|VP|IP|BP|LP)([^ ]*?)($CODA) <([^ ]*-TMP)([^>]*)> (?!<CC)(<.*)\^/\^\1\2\3 <RP-t-lM-f\4\5> <\1\2-lI-fNIL \6>\^/ ||
        ...
        (s/\^(C(?!(?:-)?r)|[SQFVIBLAG](?!-a)|[VIBLG]-aN)((?!-[cp])[^ ]*?)($CODA) <(DT|PP|RB|IN|ADVP|CC|FRAG|[^ ]*-ADV|[^ ]*-LOC|[^ ]*-TMP)([^>]*)> (?!<CC)(<.*)\^/\^\1\2\3 <R-aN-lM-f\4\5> <\1\2-lI-fNIL \6>\^/ && ($j=34)) ||
...
#        (s/\^(V-a\{.-aN\})($CODA) (<.*) <(NP)([^>]*)>\^/\^\1\2 <Q-b\{A-aN\}-bN-lI-fNIL \3> <N-lA-f\4\5>\^/ && ($j=84.5)) ||
        # there propagation
        (s/\^(V-a\{.-aN\})($CODA) (<.*) <(NP)([^>]*)>\^/\^\1\2 <\1-bN-lI-fNIL \3> <N-lA-f\4\5>\^/ && ($j=84.5)) ||
        ...
        (s/\^([VIBLAGR]-aN(?!-x)|N(?!-a))([^ ]*?)($CODA) (<.*) <([^>\]]*-NONE- \*EXP\*[^>\[]*)>\^/\^\1e\2\3 <\1e\2-lI-fNIL \4> <\5>\^/ && ($j=100)) ||
...
#        s/\^([VIBLA])S([^ ]*?)($CODA) <(SBAR(?!-ADV)[^\]]*(?:whether|if)|SBAR[^ ]* \[WH(?![^\]]*that))([^>]*)> (<.*)\^/\^\1S\2\3 <VS-iNS-lA-f\4\5> <\1P\2-lI-fNIL \6>\^/ ||
        ...
        (s/\^N(-aD)?([^ ]*?)(-[ir][^- \}]*)?([^ \}]*?)($CODA) <((?:NN|NML)[^>]*)> (.*<(?:DT|NN|NX|NP|VB|VP|JJ|ADJP|CD|\$|QP \[\$).*)\^/\^N\1\2\3\4\5 <A-aN-x-lM-fNIL <N-aD-lI-f\6>> <N-aD\3\4-lI-fNIL \7>\^/ && ($j=161.2)) ||
        ...
        (s/\^(N-aD|N|A-aN-x)([^ ]*?)($CODA) <QP ([^>]*)\[([^ ]* [^ ]*[\$\#][^ ]*)\] ([^>]*)>(?: <-NONE- \*U\*>)?\^/<\1\2\3 \4\[\5\] \[QP \6\]>/ && ($j=164)) ||
        # branch off currency unit followed by non-final *U*
        (s/\^(N-aD|N|A-aN-x)([^ ]*?)($CODA) (<[^ ]* [\$\#][^ ]*>.*) <-NONE- \*U\*> (<.*)\^/\^\1\2\3 <A-aN-x-lM-fNIL \4> <N-aD-lI-fNIL \5>\^/ && ($j=165)) ||
        # rebinarize currency unit followed by QP
        (s/\^(N-aD|N|A-aN-x)([^ ]*?)($CODA) <([^ ]* [\$\#][^ ]*)> (.*?)( <-NONE- \*U\*>)?\^/\^\1\2\3 <\1-lI-f\4> <A-aN-x-lM-fNIL \5>\^/ && ($j=166)) ||
