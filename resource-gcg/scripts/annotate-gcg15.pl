...
#        (s/\^(N)([^ ]*?)($CODA) (.*<VBG.*) <(NP)([^>]*)>\^/\^\1\2\3 <\1\2-bN-lI-fNIL \4> <N-lA-fNS\6>\^/ && ($j=98.5)) ||
#        (s/\^(N)([^ ]*?)($CODA) (.*<VBG.*) <(S[^ ]*-NOM)([^>]*)>\^/\^\1\2\3 <\1\2-bN-lI-fNIL \4> <N-lA-f\5\6>\^/ && ($j=99)) ||
...
#	(s/\^(N)([^ ]*?)($CODA) (.*<VBG.*) <(SBAR[^ ]*-NOM)([^>]*)>\^/\^\1\2\3 <\1\2-bN-lI-fNIL \4> <N-lA-f\5\6>\^/ && ($j=118)) ||
