...
#  s/\((NNPS|NNP|NNS|NN)/\(NN/g;
  ...
  $CODA = '(?:-[fghl0-9][^ \{\}]*|-[fghl0-9]\{[^ \{\}]*\})+';     ### '-[fghl](?:[^ {}\^]|{[^ {}\^]*})*'; # stuff that arguments get to cut in front of
...
#        s/\^(SS)([^ ]*?)($CODA) (<.*\[-NONE- *\*ICH\*(-[0-9]+)(?![0-9]).*) <: :> <(S)([^ ]*)\5([^>]*)>\^/\^\1\2\3 <VS-hSS\5\2-lI-fNIL \4> <SSmod-lI-f\6\7 <: :> <SS-lI-f\6\7\5\8>>\^/ ||
        ...
        (s/\^([SQCEVIBLAGR])([^ ]*?)($CODA) (<.*\[-NONE- \*ICH\*(-[0-9]+)\].*) <(SBAR[^ ]*\5 $SUITABLE_REL_CLAUSE)>\^/\^\1\2\3 <\1\2-g{C-rN}\5-lI-fNIL \4> <C-rN-lN-f\6>\^/ && ($j=5)) ||
        ...
        (s/\^([SQCEVIBLAGR])([^ x]*?)($CODA) (<.*\[-NONE- \*ICH\*(-[0-9]+)\].*) <(SBAR[^ ]*\5) \[WH[^ ]*(-[0-9]+) \[-NONE- 0\]\] \[S[^ ]* \[NP[^ ]* \[-NONE- \*\]\] ([^>]*) \[ADVP \[-NONE- \*T\*\7\]\]([^>]*)\]>\^/\^\1\2\3 <\1\2-g{C-rN}\5-lI-fNIL \4> <I-aN-lN-f\6 \8\9>\^/ && ($j=6)) ||
        # branch off final SBAR as extraposed modifier CS complement:                {VP ... t#' ... <SBAR#' [WH# which/who/that/nil] ... t# ...>} => {<VP-g{C-rN} ...> <CS ...>}
        (s/\^([SQCEVIBLAGR])([^ ]*?)($CODA) (<.*\[-NONE- \*ICH\*(-[0-9]+)\].*) <(SBAR[^ ]*\5 \[IN that\][^>]*)>\^/\^\1\2\3 <\1\2-gC\5-lI-fNIL \4> <C-lN-f\6>\^/ && ($j=7)) ||
        # inverted sentence: branch off final raised complement SS (possibly quoted)
        (s/\^(S)([^ ]*?)($CODA) (<.*\[-NONE- \*ICH\*(-[0-9]+)\].*) <(S)([^ ]*)\5([^>]*)>\^/\^\1\2\3-modeverused? <V-gS\5\2-lI-fNIL \4> <S-lN-f\6\7\5\8>\^/ && ($j=8)) ||
...
#        (s/\^([SQCEVIBLAGR](?!-a)r?|[VIBLAGR]-aNr?|[AR]-aN-x|N)([^ ]*?)($CODA) (<.*) <(?!POS)([^ ]*) ($FINAL_PUNCT)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <\5-lM-f\5 \6>\^/ && ($j=9)) ||
        (s/\^([SQCEVIBLAGRN]r?)([^ ]*?)($CODA) (<.*) <(?!POS)([^ ]*) ($FINAL_PUNCT)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <\5-lM-f\5 \6>\^/ && ($j=9)) ||
        ...
        (s/\^([^ ]*)(-c[^ ]*-pP[cs])(-[ghj][^ ]*?)(-[fl][^ ]*) <((?:CC|ADVP \[RB then|ADVP \[RB not)[^>]*)> (<.*)\^/\^\1\2\3\4 <X-cX-dX-lI-f\5> <\1\3-lC-fNIL \6>\^/ && ($j=72)) ||
...
#        (s/\^([^ ]*?)-c(({?\1}?)(-pP[sc]))(-[ghj][^ ]*?)(-[fl][^ ]*) (<.*?) (<(?:CC|ADVP \[RB then|ADVP \[RB not|. ;)[^>]*> <.*)\^/\^\1-c\2\5\6 <\1\5-lC-fNIL \7> <\1\4-c\3\5-lI-fNIL \8>\^/ && ($j=76)) ||
        (s/\^([^ ]*?)(-c{?\1}?)(-pP[sc])(-[ghj][^ ]*?)(-[fl][^ ]*) (<.*?) (<(?:CC|ADVP \[RB then|ADVP \[RB not|. ;)[^>]*> <.*)\^/\^\1\2\3\4\5 <\1\4-lC-fNIL \6> <\1\3\2\4-lI-fNIL \7>\^/ && ($j=76)) ||
...
#        (s/\^(SS|VS\-iNS|QS|CS|ES|Cr|RC|[VIBLAGR][SP]r?|NS|A-aN-x|R-aN-x|NP)([^ ]*?)($CODA) <([^ ]*) ($INIT_PUNCT)> (<.*)\^/\^\1\2\3 <\4-lM-f\4 \5> <\1\2-lI-fNIL \6>\^/ && ($j=11)) ||
        (s/\^([SQCEVIBLAGRN](?!-[ar])r?|[VIBLAGRN]-a.(?!-x)r?|A-aN-x|R-aN-x)((?!-[cp])[^ ]*?)($CODA) <([^ ]*) ($INIT_PUNCT)> (<.*)\^/\^\1\2\3 <\4-lM-f\4 \5> <\1\2-lI-fNIL \6>\^/ && ($j=11)) ||
...
##           s/\^(AP|RP)([^ ]*)(-f[^ ]*) (<TO.*<VP.*)\^/\^\1\2\3 <IP\2-fNIL \4>\^/ ||
        ...
        (s/\^([SCEV](?!-a))((?!-[cp])[^ ]*?)($CODA) (?!<[^ ]*-SBJ)<(S)([^ ]*)(-[0-9]+)((?![0-9])[^>]*)> (<.*\[-NONE- *\*T\*\6\].*)\^/\^\1\2\3 <S-lN-f\4\5\6\7> <V\2-gS\6-lI-fNIL \8>\^/ && ($j=19)) ||
        # topicalized sentence: branch off initial topic NS   ***<[^ ]* \[-NONE- [^\]]*\]>|
        (s/\^([SCEV](?!-a))((?!-[cp])[^ ]*?)($CODA) (?!<[^ ]*-SBJ)<(NP)([^ ]*)(-[0-9]+)((?![0-9])[^>]*)> (<.*\[-NONE- *\*T\*\6\].*)\^/\^\1\2\3 <N-lN-f\4\5\6\7> <V\2-gN\6-lI-fNIL \8>\^/ && ($j=20)) ||
        # topicalized sentence: branch off initial topic AP
        (s/\^([SCEV](?!-a))((?!-[cp])[^ ]*?)($CODA) (?!<[^ ]*-SBJ)<(ADJP)([^ ]*)(-[0-9]+)((?![0-9])[^>]*)> (<.*\[-NONE- *\*T\*\6\].*)\^/\^\1\2\3 <A-aN-lN-f\4\5\6\7> <V\2-g{A-aN}\6-lI-fNIL \8>\^/ && ($j=21)) ||
        # topicalized sentence: branch off initial topic RP
        (s/\^([SCEV](?!-a))((?!-[cp])[^ ]*?)($CODA) (?!<[^ ]*-SBJ)<((?!WH)[A-Z]*)([^ ]*)(-[0-9]+)((?![0-9])[^>]*)> (<.*\[-NONE- *\*T\*\6\].*)\^/\^\1\2\3 <R-aN-lN-f\4\5\6\7> <V\2-g{R-aN}\6-lI-fNIL \8>\^/ && ($j=22)) ||
...
#        s/\^(V|I)E([^ ]*?)($CODA) <(IN[^>]*)> (<.*)\^/\^\1E\2\3 <\1E\2-b\1S-lM-f\4> <\1S-lI-fNIL \5>\^/ ||
        (s/\^C(?!r)((?!-[cp])[^ ]*?)($CODA) <(IN[^>]*)> (<.*)\^/\^C\1\2 <C\1-bV-lM-f\3> <V-lI-fNIL \4>\^/ && ($j=24)) ||
        (s/\^E((?!-[cp])[^ ]*?)($CODA) <(IN[^>]*)> (<.*)\^/\^E\1\2 <E\1-bI-lM-f\3> <I-lI-fNIL \4>\^/ && ($j=25)) ||
        # embedded noun: branch off initial preposition
#        s/\^(N)E([^ ]*?)(-[ir][A-Z])?($CODA) <(IN[^>]*)> (<.*)\^/\^\1E\2\3\4 <\1E\2-b\1P-lM-f\5> <\1P\3-lI-fNIL \6>\^/ ||
        (s/\^O((?!-[cp])[^ ]*?)(-[ir][A-Z]+)?($CODA) <(IN[^>]*)> (<.*)\^/\^O\1\2\3 <O\1-bN-lM-f\4> <N\2-lI-fNIL \5>\^/ && ($j=26)) ||
        # embedded question: branch off initial interrogative RP whether/if
        ...
        (s/\^([SQCEVIBLAG](?!-a))((?!-[cp])[^ ]*?)($CODA) <(PP|RB|ADVP|CC|FRAG|NP|[^ ]*-ADV|[^ ]*-LOC|[^ ]*-TMP|SBAR[^ ]* \[IN (?!that))([^>]*)> <([^ ]*) (:)> (<.*)\^/\^\1\2\3 <R-aN-lM-fNIL <R-aN-lI-f\4\5> <\6 \7>> <\1\2-lI-fNIL \8>\^/ && ($j=28)) ||
        # branch off initial modifier RP IP
        (s/\^([SQCEVIBLAG](?!-a)|[VIBLG]-aN)((?!-[cp])[^ ]*?)($CODA) <S[^ ]* \[NP[^ ]* \[-NONE- \*(?:-[0-9]*)?\]\] ($NO_AP_HEAD\[TO[^>]*)> (<.*)\^/\^\1\2\3 <R-aN-lM-fNIL <I-aN-lI-fNIL \4>> <\1\2-lI-fNIL \5>\^/ && ($j=29)) ||
        # branch off initial modifier RP AP
        (s/\^([SQCEVIBLAG](?!-a)|[VIBLG]-aN)((?!-[cp])[^ ]*?)($CODA) <S[^ ]* \[NP[^ ]* \[-NONE- \*(?:-[0-9]*)?\]\] ([^>]*)> (<.*)\^/\^\1\2\3 <R-aN-lM-fNIL \4> <\1\2-lI-fNIL \5>\^/ && ($j=30)) ||
        # branch off initial modifier RP from SBAR
        (s/\^([SQCEVIBLAG](?!-a)|[VIBLG]-aN)((?!-[cp])[^ ]*?)($CODA) <(SBAR(?![^ ]*-SBJ)[^ ]* (?!\[IN that|\[IN for|\[IN where|\[IN when)(?!\[WH[^  ]*))([^>]*)> (<.*)\^/\^\1\2\3 <R-aN-lM-f\4\5> <\1\2-lI-fNIL \6>\^/ && ($j=31)) ||
        # branch off initial modifier RC from SBAR-ADV
        (s/\^([SQCEVIBLAG](?!-a)|[VIBLG]-aN)((?!-[cp])[^ ]*?)($CODA) <(SBAR(?:-ADV|-TMP)[^ ]* \[WH)([^>]*)> (<.*)\^/\^\1\2\3 <V-rN-lN-f\4\5> <\1\2-lI-fNIL \6>\^/ && ($j=32)) ||
        # branch off initial RB + JJS as modifier RP  (e.g. "at least/most/strongest/weakest")
        (s/\^([SQCEVIBLAGN](?!-a)|[VIBLG]-aN)((?!-[cp])[^ ]*?)($CODA) (<IN[^>]*> <JJ[^>]*>) (?!<CC)(<.*)\^/\^\1\2\3 <R-aN-lM-fNIL \4> <\1\2-lI-fNIL \5>\^/ && ($j=33)) ||
...
#WORSE:        s/\^(SS|VS\-iNS|QS|CS|ES|[VIBLAG]S|VP|IP|BP|LP)([^ ]*?)($CODA) <([^ ]*-TMP)([^>]*)> (?!<CC)(<.*)\^/\^\1\2\3 <RP-t-lM-f\4\5> <\1\2-lI-fNIL \6>\^/ ||
        (s/\^(C(?!r)|[SQEVIBLAG](?!-a)|[VIBLG]-aN)((?!-[cp])[^ ]*?)($CODA) <(NP-TMP)([^>]*)> (?!<CC)(<.*)\^/\^\1\2\3 <R-aN-lM-fNS-TMP\5> <\1\2-lI-fNIL \6>\^/ && ($j=33.5)) ||
        (s/\^(C(?!(?:-)?r)|[SQEVIBLAG](?!-a|r)|[VIBLG]-aN)((?!-[cp])[^ ]*?)($CODA) <(DT|PP|RB|IN|ADVP|CC|FRAG|[^ ]*-ADV|[^ ]*-LOC|[^ ]*-TMP)([^>]*)> (?!<CC)(<.*)\^/\^\1\2\3 <R-aN-lM-f\4\5> <\1\2-lI-fNIL \6>\^/ && ($j=34)) ||
...
#        s/\^(SS|VS\-iNS|QS|CS|ES|[VIBLAG]S|VP|IP|BP|LP)([^ ]*?)($CODA) <(S)([^ ]* \[NP[^ ]* \[-NONE- \*-[^>]*)> (<.*)\^/\^\1\2\3 <RP-lM-f\4\5> <\1\2-lI-fNIL \6>\^/ ||
        ...
        (s/\^([SQCEVIBLAGR](?:-aN)?)((?!-[cp])[^ a]*?)($CODA) <(PRN|S(?![A-Z]))([^>]* \[S[^>]*\[-NONE- \*INTERNAL\*(-[0-9]+)[^>]*)> (<.*)\^/\^\1\2\3 <V-gS\6-lN-f\4\5> <\1\2-lI-fNIL \7>\^/ && ($j=40)) ||
...
#        (s/\^(S|C)((?!-[cp])[^ ]*?)($CODA) (<(?:NP|[^ ]*-SBJ).*<VP.*|<VP.*<(?:NP|[^ ]*-SBJ))\^/\^\1\2\3 <V\2-lI-fNIL \4>\^/ && ($j=43)) ||
        ...
        (s/\^(C)(?!r)([^ ]*?)($CODA) <WH[^ ]*(-[0-9]+)[^ ]* \[-NONE- [^>]*> (<.*)\^/\^\1\2\3 <V\2-gN\4-lI-fNIL \5>\^/ && ($j=55)) ||
        ...
        (s/\^([^ ]*?)(-[fghjlp][^ ]*) (<.*\[-NONE- \*RNR\*(-[0-9]*)\].*) <NP([^ ]*\4[^>]*)>\^/\^\1\2 <\1-hN\4-lI-fNIL \3> <N-lA-fNS\5>\^/ && ($j=63)) ||
        ...
        # branch off initial conjunct prior to semicolon delimiter
        (s/\^([A-Z]-[abri].(?:-x)?)([^ cp]*?)($CODA)(?!.*\|) (<.*?) (<[^ ]* ;> .*<(?:CC|ADVP \[RB then|ADVP \[RB not|. ;)[^>]*> <.*)\^/\^\1\2\3 <\1\2-lC-fNIL \4> <\1\2-pPs-c{\1\2}-lI-fNIL \5>\^/ && ($j=66.6)) ||
        (s/\^([^ \-cp]*)($CODA)(?!.*\|) (<.*?) (<[^ ]* ;> .*<(?:CC|ADVP \[RB then|ADVP \[RB not|. ;)[^>]*> <.*)\^/\^\1\2 <\1-lC-fNIL \3> <\1-pPs-c\1-lI-fNIL \4>\^/ && ($j=67)) ||
        # branch off initial conjunct prior to comma delimiter
        (s/\^([A-Z]-[abri].(?:-x)?)([^ cp]*?)(-[fghjlr][^ ]*)(?!.*\|) (<.*?) (<[^ ]* ,> .*<(?:CC|ADVP \[RB then|ADVP \[RB not)[^>]*> <.*)\^/\^\1\2\3 <\1\2-lC-fNIL \4> <\1\2-pPc-c{\1\2}-lI-fNIL \5>\^/ && ($j=67.6)) ||
        ...
        (s/\^([A-Z]-[abri].(?:-x)?)([^ cp]*?)(-[fghjlr][^ ]*)(?!.*\|) (<.*?) (<CC[^>]*> <.*)\^/\^\1\2\3 <\1\2-lC-fNIL \4> <\1\2-c{\1\2}-lI-fNIL \5>\^/ && ($j=68.8)) ||
...
#        s/\^([^C][A-Z]S[^ ]*?)(-[fghjlp][^ ]*) <([^- ]*)([^>]*)> (<[^ ]* ,> <\3[^>]*>)\^/\^\1mod\2 <\1-lC-f\3\4> <C\1-lI-fNIL \5>\^/ ||
        ...
        (s/\^([SQCEVIBLAGRN])([^ ]*?)($CODA) (<.*) <(PRN|S(?![A-Z]))([^>]* \[S[^>]*\[-NONE- \*INTERNAL\*(-[0-9]+)[^>]*)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <V-gS\7-lN-f\5\6>\^/ && ($j=78)) ||

        # branch NS -> DS A-aN-x: 'the best' construction
        (s/\^(N(?!-a))([^ ]*?)($CODA) <(?:DT)([^>]*)> <(?:RB|ADJP)([^>]*)>\^/\^\1\2\3 <D-lM-f\4> <A-aN-x-lI-f\5>\^/ && ($j=79)) ||

        #### final VP|IP|BP|LP|AP (following auxiliary) -- raising verbs, pass subject to complement
        # branch off final VP as argument BP
        (s/\^([VIBLAGR])(-aN(?!-x))([^ ]*?)($CODA) (<.*(?:TO |MD | do[\]>]| does[\]>]| did[\]>]).*?) (<RB.*)?(<VP.*>)\^/\^\1\2\3\4 <\1\2-b{B\2}-lM-fNIL \5> <B\2\3-lI-fNIL \6\7>\^/ && ($j=80)) ||
        # branch off final VP as argument LP (w. special cases b/c 's ambiguous between 'has' and 'is')
        (s/\^([VIBLAG])(-aN(?!-x))([^ ]*?)($CODA) (.*(?: have| having| has| had| 've|VBD 'd)>.*?) (<RB.*)?(<VP.*>)\^/\^\1\2\3\4 <\1\2-b{L\2}-lM-fNIL \5> <L\2\3-lI-fNIL \6\7>\^/ && ($j=81)) ||
        (s/\^([VIBLAG])(-aN(?!-x))([^ ]*?)($CODA) (.*<VBZ *'s>.*?) (<RB.*)?(<VP[^\]]* (?:$LP_FIRST).*>)\^/\^\1\2\3\4 <\1\2-b{L\2}-lM-fNIL \5> <L\2\3-lI-fNIL \6\7>\^/ && ($j=82)) ||
        # branch off final PRT as argument AP particle
        (s/\^([VIBLAGRN](?=-a[ND](?!-x))|N(?!-a))([^ ]*?)($CODA) (<.*) <(PRT)([^ ]*) \[RP ([^ ]*)\]>\^/\^\1\2\3 <\1\2-bP\7-lI-fNIL \4> <P\7-lA-f\5\6 \7>\^/ && ($j=83)) ||
        # branch off final modifier RP (extraposed from argument)    **TO PRESERVE EXTRAPOSN: /{\1\2\3 <\1\2-gRP\5-lI-fNIL \4> <RP-lM-f\5\6\7>\^/ ||
        (s/\^([VIBLAGR])(-aN(?!-x))([^ ]*?)($CODA) (<VB.*<.*\[-NONE- \*ICH\*(-[0-9]+)(?![0-9]).*) <(VP[^ ]*)\6((?![0-9])[^>]*)>\^/\^\1\2\3\4 <\1\2\3-lI-fNIL \5> <R\2-lM-f\7\6\8>\^/ && ($j=84)) ||
        # branch off final VP|ADJP as argument AP
        (s/\^([VIBLAGR])(-aN(?!-x))([^ ]*?)($CODA) (.*(?: be| being| been| is| was|VBZ 's| are| were| 're)>.*?) (<RB.*)?(<(?:VP|VB[DNG]|ADJP|JJ|CD|PP[^ ]*-PRD|IN|UCP|ADVP[^ ]*-PRD|SBAR[^ ]*-PRD (?!\[WH|\[IN that)).*>)\^/\^\1\2\3\4 <\1\2-b{A\2}-lM-fNIL \5> <A\2\3-lI-fNIL \6\7>\^/ && ($j=85)) ||
        (s/\^([VIBLAGR])(-aN(?!-x))([^ ]*?)($CODA) (.*(?: be| being| been| is| was|VBZ 's| are| were| 're)>.*?) (<RB.*)?(<(?:NP|NN|S[^ ]*-NOM|SBAR[^ ]*-NOM|SBAR[^ ]*-PRD).*>)\^/\^\1\2\3\4 <\1\2-b{A\2}-lM-fNIL \5> <A\2\3-lI-fNIL <N-lI-fNIL \6\7>>\^/ && ($j=86)) ||
        (s/\^(N)([^ ]*?)($CODA) (.*(?: be| being| been| is| was|VBZ 's| are| were| 're)>.*?) (<RB.*)?(<(?:VP|VB[DNG]|ADJP|JJ|CD|PP[^ ]*-PRD|IN|UCP|ADVP[^ ]*-PRD|SBAR[^ ]*-PRD (?!\[WH|\[IN that)).*>)\^/\^\1\2\3 <\1\2-b{A-aN}-lM-fNIL \4> <A-aN-lI-fNIL \5\6>\^/ && ($j=85.5)) ||
        (s/\^(N)([^ ]*?)($CODA) (.*(?: be| being| been| is| was|VBZ 's| are| were| 're)>.*?) (<RB.*)?(<(?:NP|NN|S[^ ]*-NOM|SBAR[^ ]*-NOM|SBAR[^ ]*-PRD).*>)\^/\^\1\2\3 <\1\2-b{A-aN}-lM-fNIL \4> <A-aN-lI-fNIL <N-lI-fNIL \5\6>>\^/ && ($j=86.5)) ||
        (s/\^([VIBLAGR])(-aN(?!-x))([^ ]*?)($CODA) (<.*) <(ADJP|PRT|ADVP[^ ]*-PRD|PP[^ ]*-PRD|VP$NO_VP_HEAD \[VB[NG])([^>]*)>\^/\^\1\2\3\4 <\1\2-b{A\2}-lI-fNIL \5> <A\2\3-lA-f\6\7>\^/ && ($j=87)) ||
        ...
        (s/\^([VIBLAGR]-aN(?!-x))([^ ]*?)($CODA) (<.*) <(SBARQ[^>]*)>\^/\^\1\2\3 <\1\2-bS-lI-fNIL \4> <S-lA-f\5>\^/ && ($j=89)) ||
        ...
        (s/\^([VIBLAGR]-aN(?!-x))([^ ]*?)($CODA) (<.*) (<(?:IN|TO)[^>]*> <NP[^>]*>)\^/\^\1\2\3 <\1\2-lI-fNIL \4> <R-aN-lN-fNIL \5>\^/ && ($j=92)) ||
        ...
        (s/\^(R-aN(?!-x))([^ ]*?)(-i[^- \}]*)($CODA) (<DT [Nn]o>) <(NP|DT|NN|WHNP|S[^ ]*-NOM)(?![^ ]*-TMP)([^>]*matter)>\^/\^\1\2\3\4 <\1\2\3-bN-lI-fNIL \5> <N-lA-f\6\7>\^/ && ($j=97.4)) ||
        (s/\^([RA]-aN(?!-x))([^ ]*?)(-[ir][^- \}]*)?($CODA) (<.*) <(NN)(?![^ ]*-TMP)([^>]*)>\^/\^\1\2\3\4 <\1\2-bN-lI-fNIL \5> <N\3-lA-fNP\7>\^/ && ($j=97.45)) ||
        (s/\^([LVGB]-aN(?!-x))([^ ]*?)(-[ir][^- \}]*)?($CODA) (<.*) <(NP)(?![^ ]*-TMP)([^>]*)>\^/\^\1\2\3\4 <\1\2\3-bN-lI-fNIL \5> <N-lA-fNS\7>\^/ && ($j=97.46)) ||
        (s/\^([IAR]-aN(?!-x))([^ ]*?)(-[ir][^- \}]*)?($CODA) (<.*) <(NP)(?![^ ]*-TMP)([^>]*)>\^/\^\1\2\3\4 <\1\2-bN-lI-fNIL \5> <N\3-lA-fNS\7>\^/ && ($j=97.47)) ||
        (s/\^(R-aN(?!-x))([^ ]*?)(-[ir][^- \}]*)?($CODA) (<.*) <(DT|WHNP|S[^ ]*-NOM)(?![^ ]*-TMP)([^>]*)>\^/\^\1\2\3\4 <\1\2-bN-lI-fNIL \5> <N\3-lA-f\6\7>\^/ && ($j=97.5)) ||
        (s/\^([VIBLAGR]-aN(?!-x))([^ ]*?)(-[ir][^- \}]*)?($CODA) (<.*) <(NP|DT|NN|WHNP|S[^ ]*-NOM)(?![^ ]*-TMP)([^>]*)>\^/\^\1\2\3\4 <\1\2-bN-lI-fNIL \5> <N\3-lA-f\6\7>\^/ && ($j=98)) ||
        ...
        (s/\^([VIBLAGR]-aN(?!-x)|N(?!-a))([^ ]*?)($CODA) (<.*) <([^>\]]*-NONE- \*EXP\*[^>\[]*)>\^/\^\1e\2\3 <\1\2-lI-fNIL \4> <\5>\^/ && ($j=100)) ||

        #### final S
        # branch off final S-ADV with empty subject as modifier RP
        (s/\^([SQCEVIBLAGRN])([^ x]*?)($CODA) (<.*) <(S-TOBE[I]S[^ ]*(?:-ADV|-PRP)[^ ]*) $EMPTY_SUBJ ([^>]*)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <R-aN-lM-fNIL <I-aN-lI-f\5 \6>>\^/ && ($j=101)) ||
        (s/\^([SQCEVIBLAGRN])([^ x]*?)($CODA) (<.*) <(S-TOBE[A]S[^ ]*(?:-ADV|-PRP)[^ ]*) $EMPTY_SUBJ ([^>]*)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <R-aN-lM-f\5 \6>\^/ && ($j=102)) ||
        (s/\^([SQCEVIBLAGRN])([^ x]*?)($CODA) (<.*) <(S-TOBE[I]P[^ ]*(?:-ADV|-PRP)[^ ]*) ([^>]*)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <R-aN-lM-fNIL <I-aN-lI-f\5 \6>>\^/ && ($j=103)) ||
        (s/\^([SQCEVIBLAGRN])([^ x]*?)($CODA) (<.*) <(S-TOBE[A]P[^ ]*(?:-ADV|-PRP)[^ ]*) ([^>]*)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <R-aN-lM-f\5 \6>\^/ && ($j=104)) ||
        # branch off final S with empty subject as argument BP|IP|AP|VP
        (s/\^(C(?!r)|[SQEVIBLAGRN])([^ x]*?)($CODA) (<.*) <(S-TOBE([VIBA])S[^ ]*) $EMPTY_SUBJ ([^>]*)>\^/\^\1\2\3 <\1\2-b{\6-aN}-lI-fNIL \4> <\6-aN-lA-f\5 \7>\^/ && ($j=105)) ||
        # try not to take [AR]-aN-x by having [^ x]* instead of normal [^ ]*
        (s/\^(C(?!r)|[SQEVIBLAGRN](?!r))([^ x]*?)($CODA) (<.*) <(S-TOBE([VIBA])P[^ ]*) ([^>]*)>\^/\^\1\2\3 <\1\2-b{\6-aN}-lI-fNIL \4> <\6-aN-lA-f\5 \7>\^/ && ($j=106)) ||
        # branch off final 'so' + S as modifier RP
        (s/\^([SQCEVIBLAGR])([^ x]*?)($CODA) (<.*) (<[^>\]]* so\]*> <S-TOBE[V]S[^>]*>)\^/\^\1\2\3 <\1\2-lI-fNIL \4> <R-aN-lN-fNIL \5>\^/ && ($j=107)) ||
        # branch off final IN|TO + S as modifier RP
        (s/\^([SQCEVIBLAGR])([^ x]*?)($CODA) (<.*) (<(?:IN)[^ ]*> <S-TOBE[V]S[^>]*>)\^/\^\1\2\3 <\1\2-lI-fNIL \4> <R-aN-lN-fNIL \5>\^/ && ($j=108)) ||
        # branch off final IN|TO + S as modifier AP
        (s/\^(N)([^ ]*?)($CODA) (<.*) (<(?:IN|TO)[^>]*> <S-TOBE[V]S[^>]*>)\^/\^\1\2\3 <\1\2-lI-fNIL \4> <A-aN-lN-fNIL \5>\^/ && ($j=109)) ||
        # branch off final S-ADV as modifier RP
        (s/\^([SQCEVIBLAGR])([^ x]*?)($CODA) (<.*) <(S-TOBE([IA])S[^ ]*(?:-ADV|-PRP)[^>]*)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <R-aN-lN-fNIL <\6-lI-fS\5>>\^/ && ($j=110)) ||
        # branch off final S as argument VS
        (s/\^(C)(?!r)([^ ]*?)($CODA) (<.*) <(S-TOBE([V])S[^>]*)>\^/\^\1\2\3 <\1\2-b\6-lM-fNIL \4> <\6-lI-f\5>\^/ && ($j=111)) ||
        # branch off final ADVP + S as modifier VS|IS|BS|AS
        (s/\^(S|V\-iN|Q|[VIBLAG](?!-a))([^ ]*?)($CODA) (<.*) (<ADVP[^>]*>) <(S-TOBE([VIBA])S[^>]*)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <\7-lN-fNIL \5 <\7-lI-f\6>>\^/ && ($j=112)) ||
        # branch off final S as modifier VS|IS|BS|AS
        (s/\^(S|V\-iN|Q|[VIBLAG](?!-aN(?!e))(?!r))([^ ]*?)($CODA) (<.*) <(S-TOBE([VIBA])S[^>]*)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <\6-lN-f\5>\^/ && ($j=113)) ||
        # branch off final S as argument VS|IS|BS|AS
#        (s/\^([VIBLAGR]P|NS|NP)([^ ]*?)($CODA) (<.*) <(S-TOBE([VIBA])S[^>]*)>\^/\^\1\2\3 <\1\2-b\6S-lI-fNIL \4> <\6S-lA-f\5>\^/ && ($j=114)) ||
        (s/\^(N(?!-a))([^ ]*?)(-[fghjlpi][^ \}]*) (<.*) <(S-TOBE([VIBA])S[^>]*)>\^/\^\1\2\3 <\1\2-b\6-lI-fNIL \4> <\6-lA-f\5>\^/ && ($j=114)) ||
        (s/\^([VIBLAGR]-aN(?!-x)|N-aD)([^ ]*?)($CODA) (<.*) <(S-TOBE([VIBA])S[^>]*)>\^/\^\1\2\3 <\1\2-b\6-lI-fNIL \4> <\6-lA-f\5>\^/ && ($j=114.5)) ||
...
#        s/\^([VIBLAGR]P)([^ ]*?)($CODA) (<.*) <(SBAR[^ ]* \[WHADVP(-[0-9]+) [^>]*) \[ADVP[^ ]* \[-NONE- \*T\*\6\]\]([\]]*)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <RP-lI-f\5\7>\^/ ||
        ...
        (s/\^(A-aN(?!-x))([^ ]*?)($CODA) (<.*) <SBAR[^ ]* \[WHNP(-[0-9]+) \[-NONE- 0\]\] (\[IN for\] [^>]* \[NP[^ ]* \[-NONE- \*T\*\5\]\][^>]*)>\^/\^\1\2\3 <\1\2-b{E-gN}-lI-fNIL \4> <E-gN\5-lM-fNIL \6>\^/ && ($j=120)) ||
        ...
        (s/\^(C(?!r)|[SQEVIBLAGR])([^ ]*?)($CODA) (<.*) <(SBAR(?![^ ]*-NOM)[^\]]* (?:where|when))([^>]*)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <V-rN-lN-f\5\6>\^/ && ($j=125)) ||
        ...
        (s/\^([SQCEVIBLAGR])([^ ]*?)($CODA) (<.*) <(SBAR)([^ ]* \[WH[^ ]*-[0-9]+[^>]*which[^>]*)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <V-rN-lN-f\5\6>\^/ && ($j=127)) ||
...
#        s/\^(SS|VS\-iNS|QS|CS|ES|[VIBLAGR])([^ ]*?)($CODA) (<.*) <(SBAR)([^ ]* \[WH[^ ]*-[0-9]+(?![^\]]*what|[^\]]*why)[^>]*)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <RC-lN-f\5\6>\^/ ||
        ...
        (s/\^([SQCEVIBLAGR])([^ ]*?)($CODA) ((?!<[^ ]*-ADV[^>]*> <[^ ]* :>)<.*) (<[^ ]* :> <.*<SBAR[^>]*>)\^/\^\1\2\3 <\1\2-lI-fNIL \4> <R-aN-lM-fNIL \5>\^/ && ($j=130)) ||
        ...
        (s/\^([SQCEVIBLAGRN])([^ ]*?)($CODA) (<.*) <(SBAR[^ ]* \[[^ ]* for\] [^>]*)>\^/\^\1\2\3 <\1\2-bE-lI-fNIL \4> <E-lA-f\5>\^/ && ($j=132)) ||
...
#WORSE:        s/\^(SS|VS\-iNS|QS|CS|ES|[VIBLAGR])([^ ]*?)($CODA) (<.*) <(?![^ ]*-PRD)(SBAR[^ ]*-TMP)([^>]*)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <RP-t-lM-f\5\6>\^/ ||
        (s/\^([SQCEVIBLAGR])([^ ]*?)($CODA) (<.*) <(?![^ ]*-PRD)(SBAR[^ ]*(?:-ADV|-LOC|-TMP|-CLR)|SBAR[^ ]* \[IN (?!that))([^>]*)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <R-aN-lM-f\5\6>\^/ && ($j=133)) ||
        ...
        (s/\^(N)([^ ]*?)($CODA) (.* being>.*) <(SBAR-NOM|SBAR-PRD)([^>]*)>\^/\^\1\2\3 <\1\2-b{A-aN}-lM-fNIL \4> <A-aN-lI-fNIL <N-lI-f\5\6>>\^/ && ($j=135)) ||
#        # branch off final SBAR as argument QC:                                        {XP ... <SBAR [WH# what/whichN/who/where/why/when/how/if/whether] ... t# ...>} => {XP <XP-bQC ...> <QC ... t# ...>}   ****SHOULD BE QC****
#        s/\^([VIBLAGR]P|NS|NP)([^ ]*?)($CODA) (<.*) <(SBAR[^ ]* \[WH(?![^\]]*that))([^>]*)>\^/\^\1\2\3 <\1\2-bVS-iNS-lI-fNIL \4> <VS-iNS-lA-f\5\6>\^/ ||
        ...
        (s/\^([SQCEVIBLAGRN])(-g{C-rN})(-[0-9]+)([^ ]*) (<.*) <SBAR[^>\]]*\[-NONE- \*(?:T|ICH)\*\3\][^>\[]*>\^/<\1\2\3\4 \5>/ && ($j=136)) ||
        ...
        (s/\^([SQCEVIBLAGR](?![^ ]*-x))([^ ]*?)($CODA) ((?!<[^ ]*-ADV[^>]*> <[^ ]* :>)<.*) (<[^ ]* :> <.*)\^/\^\1\2\3 <\1\2-lI-fNIL \4> <R-aN-lM-fNIL \5>\^/ && ($j=138)) ||
        # branch off final modifier RP
        (s/\^([SQCEVIBLAGR](?![^ ]*-x))([^ ]*?)($CODA) (<.*) <(?![^ ]*-PRD)(NP-TMP)([^>]*)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <R-aN-lM-fNS-TMP\6>\^/ && ($j=138.5)) ||
        (s/\^([SQCEVIBLAGR](?![^ ]*-x)(?!r))([^ ]*?)($CODA) (<.*) <(?![^ ]*-PRD)(RB|ADVP|PP|UCP|FRAG|[^ ]*-ADV|[^ ]*-LOC|[^ ]*-TMP)([^>]*)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <R-aN-lM-f\5\6>\^/ && ($j=139)) ||
        ...
        (s/\^([VIBLAGR]-aN(?!-x))([^ ]*?)($CODA) (<VBD had>) (.*<NP.*<VP.*)\^/\^\1\2\3 <\1\2-bL-lM-fNIL \4> <L-lI-fNIL \5>\^/ && ($j=142)) ||
...
#        s/\^(NS)([^ ]*?)($CODA) (<.*) (<[^ ]* ;>) (<.*)\^/\^\1\2\3 <\1\2-lI-fNIL \4> <C\1 \5 <\1\2-lI-fNIL \6>>\^/ ||
        ...
        (s/\^(N)([^ ]*?)($CODA) (.* having>.*) <(VP)([^>]*)>\^/\^\1\2\3 <\1\2-b{L-aN}-lM-fNIL \4> <L-aN-lI-f\5\6>\^/ && ($j=148)) ||
        ...
        (s/\^([SQCEVIBLAG](?!-a))([^ ]*?)($CODA) (<.*) (<[^ ]* so> <S(?![A-Z])[^>]*>)\^/\^\1\2\3 <\1\2-lI-fNIL \4> <R-aN-lM-fNIL \5>\^/ && ($j=150)) ||
...
#        s/\^([VIBLA])S([^ ]*?)($CODA) <(SBAR(?!-ADV)[^\]]*(?:whether|if)|SBAR[^ ]* \[WH(?![^\]]*that))([^>]*)> (<.*)\^/\^\1S\2\3 <VS-iNS-lA-f\4\5> <\1P\2-lI-fNIL \6>\^/ ||
        ...
        (s/\^([VIBLAG](?!-aN(?!e)))([^ ]*?)($CODA) <(SBAR[^ ]*-SBJ[^\]]*for)([^>]*)> (<.*)\^/\^\1\2\3 <E-lA-f\4\5> <\1-aN\2-lI-fNIL \6>\^/ && ($j=153)) ||
        ...
        (s/\^([VIBLAG](?!-aN(?!e)))([^ ]*?)($CODA) <(NP)(-SBJ)?([^>]*)> (<.*)\^/\^\1\2\3 <N-lA-fNS\5\6> <\1-aN\2-lI-fNIL \7>\^/ && ($j=154.5)) ||
        ...
        (s/\^(N(?!-aD))([^ ]*?)(-[ir][^- ]*)?([^ \}]*?)($CODA) <(PDT|RB)([^>]*)> (<.*)\^/\^\1\2\3\4\5 <D-lM-f\6\7> <N\2\3\4-lI-fNIL \8>\^/ && ($j=158)) ||
        # branch off initial determiner (wh)
        (s/\^(N(?!-aD))([^ ]*?)(-[ir][^- ]*)?([^ \}]*?)($CODA) <(WDT|WP\$)([^>]*)> (<.*)\^/\^\1\2\3\4\5 <D\3-lM-f\6\7> <N-aD\2\4-lI-fNIL \8>\^/ && ($j=159)) ||
        # branch off initial determiner (non-wh)
        (s/\^(N(?!-aD))([^ ]*?)(-[ir][^- ]*)?([^ \}]*?)($CODA) <NP([^>]*\[POS 's?\])([^>]*)> (<.*)\^/\^\1\2\3\4\5 <D-lM-fNS\6\7> <N-aD\2\3\4-lI-fNIL \8>\^/ && ($j=159.5)) ||
        (s/\^(N(?!-aD))([^ ]*?)(-[ir][^- ]*)?([^ \}]*?)($CODA) <(DT|PRP\$|PRP|NP[^>]*\[POS 's?\])([^>]*)> (<.*)\^/\^\1\2\3\4\5 <D-lM-f\6\7> <N-aD\2\3\4-lI-fNIL \8>\^/ && ($j=160)) ||
        ...
        # branch off initial modifier A-aN-x
        (s/\^(N-aD)([^ ]*?)(-[fghjlrp][^ \}]*?)N-aD <(NN)([^>]*)> (.*<(?:DT|NN|NX|NP|VB|VP|JJ|ADJP|CD|\$|QP \[\$).*)\^/\^\1\2\3N <A-aN-x-lM-fNP\5> <\1\2-lI-fNIL \6>\^/ && ($j=161.39)) ||
        (s/\^(N)([^ ]*?)(-[fghjlrp][^ \}]*?)N-aD <(NN)([^>]*)> (.*<(?:DT|NN|NX|NP|VB|VP|JJ|ADJP|CD|\$|QP \[\$).*)\^/\^\1\2\3N <A-aN-x-lM-fNP\5> <\1-aD\2-lI-fNIL \6>\^/ && ($j=161.4)) ||
        (s/\^N(-aD)?([^ ]*?)((?:-[fghjlrp0-9][^ \{\}]*|-[fghjlrp]\{[^ \{\}]*\})*) <(NN)([^>]*)> (.*<(?:DT|NN|NX|NP|VB|VP|JJ|ADJP|CD|\$|QP \[\$).*)\^/\^N\1\2\3 <A-aN-x-lM-fNP\5> <N-aD\2-lI-fNIL \6>\^/ && ($j=161.5)) ||
        ...
        (s/\^(A-aN-x)([^ ]*?)(-[ir][^- \}]*)?([^ ]*) <NN([^>]*)> (<.*)\^/\^\1\2\3\4 <R-aN-x-lM-fNP\5> <A-aN-x\3-lI-fNIL \6>\^/ && ($j=167.5)) ||
...
#        s/\^([VIBLAGR]P|NS|NP)([^ ]*?)($CODA) (<.*) <(?!-NONE-)([^ ]*) (..?.?.?)>\^/\^\1\2\3 <\1\2-bAP\6-fNIL \4> <AP\6-lA-f\5 \6>\^/ ||
    ...
    while (
	   debug($step, "?? $_") ||
           ...
           (s/\^([^ ]*)(-h[^- ]*)(-[0-9]+)((?![0-9]).*) <((?![^ ]*\2\3)[^ ]*?)(-[fghjl][^>]*\[-NONE- *\*(?:RNR)\*\3\][^>]*)>(.*)\^/\^\1\2\3\4 <\5\2\3\6>\7\^/  && ($k=3)) ||
...
#  s/(-a[A-Z]+)?-j([A-Z]+)/-a\2/g;
  ...
  s/\((A-aN|A-aN-x|R-aN|R-aN-x|N)([^ ]*)-fVB[G]/\(\1\2-o-fVBG-o/g;   ## mark progressive/gerund
