...
#        s/\^(.*) <S(?!-NOM)(?!head)(?![A-Z])([^>]*)>(.*)\^/<\1 \|S\2\|\3>/ ||
        ...
        #### it-cleft
        (s/\^([SQCEV](?=[^ ]*-fS[^ ]*-CLF)[^ ]*)($CODA) (.*)<NP-SBJ([^>]*)>(.*)\^/<\1\2 \3<NP-CLF\4>\5>/ && ($j=1.5)) ||
...
#        (s/\^([V][^ ]*?)($CODA) (<.*) <((?:ADVP|PP)(?![^ ]*-PRD)[^ ]*)>\^/\^\1\2 <\1-lI-fNIL \3> <R-aN-lM-f\4>\^/ && ($j=3.7)) ||
        ...
        (s/\^([SQCEVIBLAGR][^ ]*?)(-g{R-aN})(-[0-9]+)($CODA) (<.*) <(ADVP(?![^ ]*-PRD)[^ ]* \[-NONE- \*T\*\3\])>\^/\^\1\2\3\4 <\1-lI-fNIL \5> <R-aN-lM-f\6>\^/ && ($j=3.7)) ||
...
#        s/\^(SS)([^ ]*?)($CODA) (<.*\[-NONE- *\*ICH\*(-[0-9]+)(?![0-9]).*) <: :> <(S)([^ ]*)\5([^>]*)>\^/\^\1\2\3 <VS-hSS\5\2-lI-fNIL \4> <SSmod-lI-f\6\7 <: :> <SS-lI-f\6\7\5\8>>\^/ ||
        ...
        (s/\^([SQCEVIBLAGRN])([^ ]*?)($CODA) (<.*\[-NONE- \*ICH\*(-[0-9]+)\].*) <(SBAR[^ ]*\5 \[(?:IN|DT) that\][^>]*)>\^/\^\1\2\3 <\1\2-hC\5-lI-fNIL \4> <C-lN-f\6>\^/ && ($j=7)) ||
...
#SSSBJ   (s/\^([SCEV](?!-a))((?!-[cp])[^ ]*?)($CODA) <(S)([^ ]*)(-[0-9]+)((?![0-9])[^>]*)> (<.*\[-NONE- *\*T\*\6\].*)\^/\^\1\2\3 <S-lN-f\4\5\6\7> <V\2-gS\6-lI-fNIL \8>\^/ && ($j=19)) ||
...
#SSSBJ   (s/\^([SCEV](?!-a))((?!-[cp])[^ ]*?)($CODA) <(NP)([^ ]*)(-[0-9]+)((?![0-9])[^>]*)> (<.*\[-NONE- *\*T\*\6\].*)\^/\^\1\2\3 <N-lN-f\4\5\6\7> <V\2-gN\6-lI-fNIL \8>\^/ && ($j=20)) ||
        # expletive there
        (s/\^([SCEV](?!-a))((?!-[cp])[^ ]*?)($CODA) <NP[^ ]* \[EX ([^\]\[]*)\]> (<.*)\^/\^\1\2\3 <A-aN-lA-fEX \4> <V\2-a{A-aN}-lI-fNIL \5>\^/ && ($j=21)) ||
# SAI    # topicalized sentence: branch off initial topic AP
# SAI    (s/\^([SCEV](?!-a))((?!-[cp])[^ ]*?)($CODA) (?!<[^ ]*-SBJ)<(ADJP)([^ ]*)(-[0-9]+)((?![0-9])[^>]*)> (<.*\[-NONE- *\*T\*\6\].*)\^/\^\1\2\3 <A-aN-lN-f\4\5\6\7> <V\2-g{A-aN}\6-lI-fNIL \8>\^/ && ($j=21)) ||
...
#        s/\^(N)E([^ ]*?)(-[ir][A-Z])?($CODA) <(IN[^>]*)> (<.*)\^/\^\1E\2\3\4 <\1E\2-b\1P-lM-f\5> <\1P\3-lI-fNIL \6>\^/ ||
        ...
        (s/\^([SQCEVIBLAG](?!-a)|[VIBLG]-aN)((?!-[cp])[^ ]*?)($CODA) <S(?![^ ]*-SBJ)[^ ]* \[NP[^ ]* \[-NONE- \*(?:-[0-9]*)?\]\] ($NO_AP_HEAD\[TO[^>]*)> (<.*)\^/\^\1\2\3 <R-aN-lM-fNIL <I-aN-lI-fNIL \4>> <\1\2-lI-fNIL \5>\^/ && ($j=29)) ||
        # branch off initial modifier RP AP
        (s/\^([SQCEVIBLAG](?!-a)|[VIBLG]-aN)((?!-[cp])[^ ]*?)($CODA) <S(?![^ ]*-SBJ)[^ ]* \[NP[^ ]* \[-NONE- \*(?:-[0-9]*)?\]\] ([^>]*)> (<.*)\^/\^\1\2\3 <R-aN-lM-fNIL \4> <\1\2-lI-fNIL \5>\^/ && ($j=30)) ||
...
#WORSE:        s/\^(SS|VS\-iNS|QS|CS|ES|[VIBLAG]S|VP|IP|BP|LP)([^ ]*?)($CODA) <([^ ]*-TMP)([^>]*)> (?!<CC)(<.*)\^/\^\1\2\3 <RP-t-lM-f\4\5> <\1\2-lI-fNIL \6>\^/ ||
        (s/\^([SQCEVIBLAG](?!-a)|[VIBLG]-aN)((?!-[cp])[^ ]*?)($CODA) <(NP-ADV|NP-TMP)([^>]*)> (?!<CC)(<.*)\^/\^\1\2\3 <R-aN-lM-fNS-TMP\5> <\1\2-lI-fNIL \6>\^/ && ($j=33.5)) ||
...
#        (s/\^(S|C)((?!-[cp])[^ ]*?)($CODA) (<(?:NP|[^ ]*-SBJ).*<VP.*|<VP.*<(?:NP|[^ ]*-SBJ))\^/\^\1\2\3 <V\2-lI-fNIL \4>\^/ && ($j=43)) ||
        ...
        (s/\^(V)(-aNe-b(?:C|E|{I-aN}|{V-iN}|N))($CODA) (.*)\^/\^\1\2\3 <\1-aN-lI-fNIL \4>\^/ && ($j=43.5)) ||
...
#        s/\^([^C][A-Z]S[^ ]*?)(-[fghjlp][^ ]*) <([^- ]*)([^>]*)> (<[^ ]* ,> <\3[^>]*>)\^/\^\1mod\2 <\1-lC-f\3\4> <C\1-lI-fNIL \5>\^/ ||
        ...
        (s/\^([SQCEVIBLAGRN])-aNc([^ ]*?)($CODA) (<.*) <(SBAR$SUITABLE_REL_CLAUSE)>\^/\^\1-aNc\2\3 <\1-aN\2-lI-fNIL \4> <C-rN-lA-f\5>\^/ && ($j=116)) ||
...
# SAI    (s/\^(Q-b[^ ]*?)($CODA) (<.*) <(NP-SBJ)([^>]*)>\^/\^\1\2 <\1-bN-lI-fNIL \3> <N\2-lA-f\4\5>\^/ && ($j=84.5)) ||
        ...
        (s/\^([RA]-aN(?!-x))([^ ]*?)(-[ir][^- \}]*)?($CODA) (<.*) <(NN)(?![^ ]*-ADV|[^ ]*-TMP)([^>]*)>\^/\^\1\2\3\4 <\1\2-bN-lI-fNIL \5> <N\3-lA-fNP\7>\^/ && ($j=97.45)) ||
        (s/\^([LVGB]-aN(?!-x))([^ ]*?)(-[ir][^- \}]*)?($CODA) (<.*) <(NP)(?![^ ]*-ADV|[^ ]*-TMP)([^>]*)>\^/\^\1\2\3\4 <\1\2\3-bN-lI-fNIL \5> <N-lA-fNS\7>\^/ && ($j=97.46)) ||
        (s/\^([IAR]-aN(?!-x))([^ ]*?)(-[ir][^- \}]*)?($CODA) (<.*) <(NP)(?![^ ]*-ADV|[^ ]*-TMP)([^>]*)>\^/\^\1\2\3\4 <\1\2-bN-lI-fNIL \5> <N\3-lA-fNS\7>\^/ && ($j=97.47)) ||
        ...
        (s/\^([SQCEVIBLAGR])([^ x]*?)($CODA) (<.*) (<[^>\]]* so\]*> <S-TOBE[V]S[^>]*>)\^/\^\1\2\3 <\1\2-lI-fNIL \4> <R-aN-lM-fNIL \5>\^/ && ($j=107)) ||
        # branch off final IN|TO + S as modifier RP
        (s/\^([SQCEVIBLAGR])([^ x]*?)($CODA) (<.*) (<(?:IN)[^ ]*> <S-TOBE[V]S[^>]*>)\^/\^\1\2\3 <\1\2-lI-fNIL \4> <R-aN-lM-fNIL \5>\^/ && ($j=108)) ||
        ...
        (s/\^([SQCEVIBLAGR])([^ x]*?)($CODA) (<.*) <(S-TOBE([IA])S[^ ]*(?:-ADV|-PRP)[^>]*)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <R-aN-lM-fNIL <\6-lI-fS\5>>\^/ && ($j=110)) ||
...
#        s/\^([VIBLAGR]P|NS|NP)([^ ]*?)($CODA) (<.*) <(SBAR[^ ]* \[WH(?![^\]]*that))([^>]*)>\^/\^\1\2\3 <\1\2-bVS-iNS-lI-fNIL \4> <VS-iNS-lA-f\5\6>\^/ ||
        ...
        (s/\^([SQCEVIBLAGR](?![^ ]*-x))([^ ]*?)($CODA) (<.*) <(?![^ ]*-PRD)(NP-ADV|NP-TMP)([^>]*)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <R-aN-lM-fNS-TMP\6>\^/ && ($j=138.5)) ||
...
# BUGBUGBUG??
        (s/\^N(-aD)?([^ ]*?)(-[ir][^- \}]*)?([^ \}]*?)($CODA) <(NN[^>]*)> (.*<(?:DT|NN|NX|NP|VB|VP|JJ|ADJP|CD|\$|QP \[\$).*)\^/\^N\1\2\3\4\5 <A-aN-x-lM-fNIL <N-aD-x-lI-f\6>> <N-aD\3\4-lI-fNIL \7>\^/ && ($j=161.2)) ||
