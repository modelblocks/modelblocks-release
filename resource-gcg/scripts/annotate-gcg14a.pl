...
#        s/\^(.*) <S(?!-NOM)(?!head)(?![A-Z])([^>]*)>(.*)\^/<\1 \|S\2\|\3>/ ||
        ...
        (s/\^Q-b(\{.-aN\})-bN([^ ]*) ([^ ]*)\^/\^Q-b\1-bN\2 <V-aN-b\1-lI-fNIL \3>\^/ && ($j=3.5)) ||
...
#        s/\^(SS)([^ ]*?)($CODA) (<.*\[-NONE- *\*ICH\*(-[0-9]+)(?![0-9]).*) <: :> <(S)([^ ]*)\5([^>]*)>\^/\^\1\2\3 <VS-hSS\5\2-lI-fNIL \4> <SSmod-lI-f\6\7 <: :> <SS-lI-f\6\7\5\8>>\^/ ||
        ...
        (s/\^([SQCEVIBLAGR])([^ ]*?)($CODA) (<.*\[-NONE- \*ICH\*(-[0-9]+)\].*) <(SBAR[^ ]*\5 $SUITABLE_REL_CLAUSE)>\^/\^\1\2\3 <\1\2-h{C-rN}\5-lI-fNIL \4> <C-rN-lN-f\6>\^/ && ($j=5)) ||
        ...
        (s/\^([SQCEVIBLAGR])([^ x]*?)($CODA) (<.*\[-NONE- \*ICH\*(-[0-9]+)\].*) <(SBAR[^ ]*\5) \[WH[^ ]*(-[0-9]+) \[-NONE- 0\]\] \[S[^ ]* \[NP[^ ]* \[-NONE- \*\]\] ([^>]*) \[ADVP \[-NONE- \*T\*\7\]\]([^>]*)\]>\^/\^\1\2\3 <\1\2-h{C-rN}\5-lI-fNIL \4> <I-aN-lN-f\6 \8\9>\^/ && ($j=6)) ||
        # branch off final SBAR as extraposed modifier CS complement:                {VP ... t#' ... <SBAR#' [WH# which/who/that/nil] ... t# ...>} => {<VP-g{C-rN} ...> <CS ...>}
        (s/\^([SQCEVIBLAGR])([^ ]*?)($CODA) (<.*\[-NONE- \*ICH\*(-[0-9]+)\].*) <(SBAR[^ ]*\5 \[IN that\][^>]*)>\^/\^\1\2\3 <\1\2-hC\5-lI-fNIL \4> <C-lN-f\6>\^/ && ($j=7)) ||
...
#        (s/\^([SQCEVIBLAGR](?!-a)r?|[VIBLAGR]-aNr?|[AR]-aN-x|N)([^ ]*?)($CODA) (<.*) <(?!POS)([^ ]*) ($FINAL_PUNCT)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <\5-lM-f\5 \6>\^/ && ($j=9)) ||
        (s/\^([SQCEVIBLAGRN])([^ ]*?)($CODA) (<.*) <(?!POS)([^ ]*) ($FINAL_PUNCT)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <\5-lM-f\5 \6>\^/ && ($j=9)) ||
...
#        (s/\^(SS|VS\-iNS|QS|CS|ES|Cr|RC|[VIBLAGR][SP]r?|NS|A-aN-x|R-aN-x|NP)([^ ]*?)($CODA) <([^ ]*) ($INIT_PUNCT)> (<.*)\^/\^\1\2\3 <\4-lM-f\4 \5> <\1\2-lI-fNIL \6>\^/ && ($j=11)) ||
        (s/\^([SQCEVIBLAGRN](?!-[ar])|[VIBLAGRN]-a.(?!-x)|A-aN-x|R-aN-x)((?!-[cp])[^ ]*?)($CODA) <([^ ]*) ($INIT_PUNCT)> (<.*)\^/\^\1\2\3 <\4-lM-f\4 \5> <\1\2-lI-fNIL \6>\^/ && ($j=11)) ||
...
#        s/\^(V|I)E([^ ]*?)($CODA) <(IN[^>]*)> (<.*)\^/\^\1E\2\3 <\1E\2-b\1S-lM-f\4> <\1S-lI-fNIL \5>\^/ ||
        (s/\^C((?!-[cp])[^ ]*?)($CODA) <(IN[^>]*)> (<.*)\^/\^C\1\2 <C\1-bV-lM-f\3> <V-lI-fNIL \4>\^/ && ($j=24)) ||
...
#WORSE:        s/\^(SS|VS\-iNS|QS|CS|ES|[VIBLAG]S|VP|IP|BP|LP)([^ ]*?)($CODA) <([^ ]*-TMP)([^>]*)> (?!<CC)(<.*)\^/\^\1\2\3 <RP-t-lM-f\4\5> <\1\2-lI-fNIL \6>\^/ ||
        (s/\^([SQCEVIBLAG](?!-a)|[VIBLG]-aN)((?!-[cp])[^ ]*?)($CODA) <(NP-TMP)([^>]*)> (?!<CC)(<.*)\^/\^\1\2\3 <R-aN-lM-fNS-TMP\5> <\1\2-lI-fNIL \6>\^/ && ($j=33.5)) ||
        (s/\^(C(?!(?:-)?r)|[SQEVIBLAG](?!-a)|[VIBLG]-aN)((?!-[cp])[^ ]*?)($CODA) <(DT|PP|RB|IN|ADVP|CC|FRAG|[^ ]*-ADV|[^ ]*-LOC|[^ ]*-TMP)([^>]*)> (?!<CC)(<.*)\^/\^\1\2\3 <R-aN-lM-f\4\5> <\1\2-lI-fNIL \6>\^/ && ($j=34)) ||
...
#        s/\^([^C][A-Z]S[^ ]*?)(-[fghjlp][^ ]*) <([^- ]*)([^>]*)> (<[^ ]* ,> <\3[^>]*>)\^/\^\1mod\2 <\1-lC-f\3\4> <C\1-lI-fNIL \5>\^/ ||
        ...
        (s/\^(Q-b[^ ]*?)($CODA) (<.*) <(NP-SBJ)([^>]*)>\^/\^\1\2 <\1-bN-lI-fNIL \3> <N\2-lA-f\4\5>\^/ && ($j=84.5)) ||
        ...
        (s/\^(Q|[VIBLAGR]-aN(?!-x))([^ ]*?)($CODA) (.*(?: be| being| been| [Ii]s| [Ww]as|VBZ 's| [Aa]re| [Ww]ere| 're)>.*?) ((?:<RB[^>]*> |<ADVP[^>]*> )*)(<(?:NP(?![^ ]*-SBJ)|NN|S[^ ]*-NOM|SBAR[^ ]*-NOM|SBAR[^ ]*-PRD).*>)\^/\^\1\2\3 <\1-b{A-aN}-lI-fNIL \4> <A-aN\2-lA-fNIL <N-lI-fNIL \5\6>>\^/ && ($j=86)) ||
        ...
        #### final NS
        # initiate passive - must have A/R-aN starting with VBN and fist -NONE- in last <...> 
        ...
        (s/\^(?![^ ]*-v)([SQCEVIBLAGRN])([^ x]*?)($CODA) (<.*) <(S-TOBE([VIBA])S[^ ]*) $EMPTY_SUBJ ([^>]*)>\^/\^\1\2\3 <\1\2-b{\6-aN}-lI-fNIL \4> <\6-aN-lA-f\5 \7>\^/ && ($j=105)) ||
        (s/\^([SQCEVIBLAGRN])([^ x]*?)($CODA) (<.*-NONE-.*) <(S-TOBE([VIBA])S[^ ]*) $EMPTY_SUBJ ([^>]*)>\^/\^\1\2\3 <\1\2-b{\6-aN}-lI-fNIL \4> <\6-aN-lA-f\5 \7>\^/ && ($j=105.1)) ||
        #(s/\^([SQCEVIBLAGRN])([^ x]*?)($CODA) (<.*-NONE-.*) <(S-TOBE([VIBA])S[^ ]*) $EMPTY_SUBJ ([^>]*)>\^/\^\1\2\3 <\1\2-b{\6-aN}-lI-fNIL \4> <\6-aN-lA-f\5 \7>\^/ && ($j=105)) ||
        # try not to take [AR]-aN-x by having [^ x]* instead of normal [^ ]*
        (s/\^(?![^ ]*-v)([SQCEVIBLAGRN])([^ x]*?)($CODA) (<.*) <(S-TOBE([VIBA])P[^ ]*) ([^>]*)>\^/\^\1\2\3 <\1\2-b{\6-aN}-lI-fNIL \4> <\6-aN-lA-f\5 \7>\^/ && ($j=106)) ||
        (s/\^([SQCEVIBLAGRN])([^ x]*?)($CODA) (<.*-NONE-.*) <(S-TOBE([VIBA])P[^ ]*) ([^>]*)>\^/\^\1\2\3 <\1\2-b{\6-aN}-lI-fNIL \4> <\6-aN-lA-f\5 \7>\^/ && ($j=106.1)) ||
        ...
        (s/\^(C)([^ ]*?)($CODA) (<.*) <(S-TOBE([V])S[^>]*)>\^/\^\1\2\3 <\1\2-b\6-lM-fNIL \4> <\6-lI-f\5>\^/ && ($j=111)) ||
        ...
        (s/\^(S|V\-iN|Q|[VIBLAG](?!-aN(?!e)))([^ ]*?)($CODA) (<.*) <(S-TOBE([VIBA])S[^>]*)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <\6-lN-f\5>\^/ && ($j=113)) ||
        # branch off final S as argument VS|IS|BS|AS
#        (s/\^([VIBLAGR]P|NS|NP)([^ ]*?)($CODA) (<.*) <(S-TOBE([VIBA])S[^>]*)>\^/\^\1\2\3 <\1\2-b\6S-lI-fNIL \4> <\6S-lA-f\5>\^/ && ($j=114)) ||
        (s/\^(N(?!-a))([^ ]*?)(-[fghjlpi][^ \}]*) (<.*) <(S-TOBE([VIBA])[SP][^>]*)>\^/\^\1\2\3 <\1\2-b\6-lI-fNIL \4> <\6-lA-f\5>\^/ && ($j=114)) ||
...
#        s/\^([VIBLAGR]P)([^ ]*?)($CODA) (<.*) <(SBAR[^ ]* \[WHADVP(-[0-9]+) [^>]*) \[ADVP[^ ]* \[-NONE- \*T\*\6\]\]([\]]*)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <RP-lI-f\5\7>\^/ ||
        ...
        (s/\^([SQCEVIBLAGR])([^ ]*?)($CODA) (<.*) <(SBAR(?![^ ]*-NOM)[^\]]* (?:where|when))([^>]*)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <V-rN-lN-f\5\6>\^/ && ($j=125)) ||
...
#        s/\^([VIBLAGR]P|NS|NP)([^ ]*?)($CODA) (<.*) <(SBAR[^ ]* \[WH(?![^\]]*that))([^>]*)>\^/\^\1\2\3 <\1\2-bVS-iNS-lI-fNIL \4> <VS-iNS-lA-f\5\6>\^/ ||
        ...
        (s/\^([SQCEVIBLAGRN])(-h{C-rN})(-[0-9]+)([^ ]*) (<.*) <SBAR[^>\]]*\[-NONE- \*(?:T|ICH)\*\3\][^>\[]*>\^/<\1\2\3\4 \5>/ && ($j=136)) ||
        ...
        (s/\^([SQCEVIBLAGR](?![^ ]*-x))([^ ]*?)($CODA) (<.*) <(?![^ ]*-PRD)(RB|ADVP|PP|UCP|FRAG|[^ ]*-ADV|[^ ]*-LOC|[^ ]*-TMP)([^>]*)>\^/\^\1\2\3 <\1\2-lI-fNIL \4> <R-aN-lM-f\5\6>\^/ && ($j=139)) ||
...
#        s/\^([VIBLAGR]P|NS|NP)([^ ]*?)($CODA) (<.*) <(?!-NONE-)([^ ]*) (..?.?.?)>\^/\^\1\2\3 <\1\2-bAP\6-fNIL \4> <AP\6-lA-f\5 \6>\^/ ||
    ...
    while (
	   debug($step, "?? $_") ||
           ...
           (s/\^([^ ]*)(-h[^- ]*)(-[0-9]+)((?![0-9]).*) <((?![^ ]*\2\3)[^ ]*?)(-[fghjl][^>]*\[-NONE- *\*(?:RNR|ICH)\*\3\][^>]*)>(.*)\^/\^\1\2\3\4 <\5\2\3\6>\7\^/  && ($k=3)) ||
           (s/\^([^ ]*)(-h{[VC]-rN})(-[0-9]+)((?![0-9]).*) <((?![^ ]*\2\3)[^ ]*?)(-[fghjl][^>]*\[-NONE- *\*(?:RNR|ICH)\*\3\][^>]*)>(.*)\^/\^\1\2\3\4 <\5\2\3\6>\7\^/  && ($k=3)) ||
