...
#  elif expr == 'SelfStore':  return( [ '\\v', '\\q', '\\r', '\\s', 'q', Univ, [ '\\x'+?????
  ...
  elif re.search( '@K\w*-[ab]\w+:', expr ):  return( [ '\\q', '\\r', '\\s', 'q', [ '\\n'+sVar, 'True' ], [ '\\n'+sVar, 'All', [ '\\m'+sVar, '^', [ 'r', 'm'+sVar ], [ expr[1:], 'n'+sVar, 'm'+sVar ] ], 's' ] ] )
  elif re.search( '@K\w*-[ab]\w+-[ab]\w+:', expr ):  return( [ '\\p', '\\q', '\\r', '\\s', 'q', [ '\\n'+sVar, 'True' ], [ '\\n'+sVar, 'p', [ '\\o'+sVar, 'True' ], [ '\\o'+sVar, 'Some', [ '\\m'+sVar, '^', [ 'r', 'm'+sVar ], [ expr[1:], 'o'+sVar, 'n'+sVar, 'm'+sVar ] ], 's' ] ] ] )
  ## Possessive marker...
