...
public class GrammarTrainer {
  ...
  public static Random RANDOM = new Random(0);
	...
	public static class Options {
		...
		@Option(name = "-treebank", usage = "Language:  WSJ, CHNINESE, GERMAN, CONLL, LINETREES, SINGLEFILE (Default: ENGLISH)")
		...
		@Option(name = "-validation", usage = "Use the given file for the validation set (Default: infer validation set from treebank type)")
		public String validationPath = null;
...
//    int lang = opts.lang;
    ...
    Corpus corpus = new Corpus(path,opts.treebank,trainingFractionToKeep,false, opts.skipSection, opts.validationPath);
    ...
    Numberer tagNumberer =  Numberer.getGlobalNumberer("tags");
		...
		//System.out.println(validationTrees.toString());
...
//		System.out.println("Variable splitGrammarFile is null, about to run once.... grammar.totalSubStates() = " + grammar.totalSubStates());
...
//		if (unparsable>0) System.out.print("Number of unparsable trees: "+unparsable+".");
  ...
  public static short[] initializeSubStateArray(List<Tree<String>> trainTrees,
		...
		System.out.printf("Entering initializeSubStateArray... trainTrees length is %d, valTrees length is %d, nSubStates is %d\n",
				trainTrees.size(), validationTrees.size(), nSubStates);
		System.out.printf("Info about tagNumberer size: %d, total: %d\n", tagNumberer.size(), tagNumberer.total());
//			boolean dontSplitTags) {
    ...
    StateSetTreeList.initializeTagNumberer(validationTrees, tagNumberer);
		System.out.printf("Info about tagNumberer size: %d, total: %d\n", tagNumberer.size(), tagNumberer.total());
		System.out.println(tagNumberer.toString());
