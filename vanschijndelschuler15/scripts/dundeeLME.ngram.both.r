...
####
if (OPTIM == "bobyqa"){
  if ('gcgtotsurp' %in% colnames(test)) {
    print("Regressing Base")
    write("Regressing Base",stderr())
    baseinteg <- lmer(update.formula(bform,.~.+(1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob)+z.(cumwdelta) + z.(gcgtotsurp) + z.(ptbtotsurp) |subject)), test, REML=F, control = lmerControl(optimizer="bobyqa",optCtrl=list(maxfun=50000)))
    print("Regressing for GCG")
    write("Regressing for GCG",stderr())
    gcginteg <- lmer(update.formula(bform,.~.+z.(gcgtotsurp) + (1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob)+z.(cumwdelta) + z.(gcgtotsurp) + z.(ptbtotsurp) |subject)), test, REML=F, control = lmerControl(optimizer="bobyqa",optCtrl=list(maxfun=50000)))
    print("Regressing for PTB")
    write("Regressing for PTB",stderr())
    ptbinteg <- lmer(update.formula(bform,.~.+z.(ptbtotsurp) + (1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob)+z.(cumwdelta) + z.(gcgtotsurp) + z.(ptbtotsurp)|subject)), test, REML=F, control = lmerControl(optimizer="bobyqa",optCtrl=list(maxfun=50000)))
    print("Regressing Both")
    write("Regressing Both",stderr())
    bothinteg <- lmer(update.formula(bform,.~.+z.(gcgtotsurp) + z.(ptbtotsurp) + (1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob)+z.(cumwdelta) + z.(gcgtotsurp) + z.(ptbtotsurp) |subject)), test, REML=F, control = lmerControl(optimizer="bobyqa",optCtrl=list(maxfun=50000)))
  }
  else {
...
if (OPTIM == "nlminb"){
  if ('gcgtotsurp' %in% colnames(test)) {
     print("Regressing Base")
     write("Regressing Base",stderr())
     baseinteg <- lmer(update.formula(bform,.~.+(1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob)+z.(cumwdelta) + z.(gcgtotsurp) + z.(ptbtotsurp) |subject)), test, REML=F, control = lmerControl(optimizer="optimx",optCtrl=list(method=c("nlminb"),maxit=50000)))
     print("Regressing GCG")
     write("Regressing GCG",stderr())
     gcginteg <- lmer(update.formula(bform,.~.+z.(gcgtotsurp) + (1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob)+z.(cumwdelta) + z.(gcgtotsurp) + z.(ptbtotsurp) |subject)), test, REML=F, control = lmerControl(optimizer="optimx",optCtrl=list(method=c("nlminb"),maxit=50000)))
     print("Regressing PTB")
     write("Regressing PTB",stderr())
     ptbinteg <- lmer(update.formula(bform,.~.+z.(ptbtotsurp) + (1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob)+z.(cumwdelta) + z.(gcgtotsurp) + z.(ptbtotsurp) |subject)), test, REML=F, control = lmerControl(optimizer="optimx",optCtrl=list(method=c("nlminb"),maxit=50000)))
     print("Regressing Both")
     write("Regressing Both",stderr())
     bothinteg <- lmer(update.formula(bform,.~.+z.(gcgtotsurp) + z.(ptbtotsurp) + (1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob)+z.(cumwdelta) + z.(gcgtotsurp) + z.(ptbtotsurp) |subject)), test, REML=F, control = lmerControl(optimizer="optimx",optCtrl=list(method=c("nlminb"),maxit=50000)))
  }
  else {
