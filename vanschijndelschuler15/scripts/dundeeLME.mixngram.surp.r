...
run.test <- function(dev,test) {
  ...
  test$totsurp <- as.numeric(as.character(test$totsurp))
  ...
  if (SIMPLIFY || !RERESID) {
    bc <- ~ (z.(sentpos) + z.(wlen) + z.(previsfix) + z.(nextisfix) + z.(uprob) + 
                           z.(fwprob) + z.(bwprob))^2
    bl <- ~ (z.(lagsentpos) + z.(lagwlen) + z.(lagprevisfix) + z.(lagnextisfix) + z.(laguprob) +
                            z.(lagfwprob) + z.(lagbwprob))^2

    if (CMCL2013) {
      r.cw <- residuals(lm(update.formula(bc,z.(cumwdelta)~.), test))
      r.lcw <- residuals(lm(update.formula(bl,z.(lagcumwdelta)~.) , test))

      r.csurp <- residuals(lm(z.(cumtotsurp) ~ (z.(sentpos) + z.(wlen) + z.(previsfix) + z.(nextisfix) + z.(uprob) + 
                             z.(fwprob) + z.(bwprob) + z.(r.cw))^2, test))
      r.lcsurp <- residuals(lm(z.(lagcumtotsurp) ~ (z.(lagsentpos) + z.(lagwlen) + z.(lagprevisfix) + z.(lagnextisfix) + z.(laguprob) +
                              z.(lagfwprob) + z.(lagbwprob) + z.(r.lcw))^2, test))
      r.tsurp <- residuals(lm(z.(totsurp) ~ (z.(sentpos) + z.(wlen) + z.(previsfix) + z.(nextisfix) + z.(uprob) + 
                             z.(fwprob) + z.(bwprob) + z.(r.cw) + z.(r.csurp))^2, test))
      r.ltsurp <- residuals(lm(z.(lagtotsurp) ~ (z.(lagsentpos) + z.(lagwlen) + z.(lagprevisfix) + z.(lagnextisfix) + z.(laguprob) +
                              z.(lagfwprob) + z.(lagbwprob) + z.(r.lcw) + z.(r.lcsurp))^2, test))

      r.ent <- residuals(lm(z.(cumentred) ~ (z.(sentpos) + z.(wlen) + z.(previsfix) + z.(nextisfix) + z.(uprob) + 
                             z.(fwprob) + z.(bwprob) + z.(r.cw) + z.(r.csurp)+z.(r.tsurp))^2 , test))
      r.lent <- residuals(lm(z.(lagcumentred) ~ (z.(lagsentpos) + z.(lagwlen) + z.(lagprevisfix) + z.(lagnextisfix) + z.(laguprob) +
                              z.(lagfwprob) + z.(lagbwprob) + z.(r.lcw) + z.(r.lcsurp)+z.(r.ltsurp))^2, test))

      rform <- ~(z.(sentpos) + z.(wlen) + z.(previsfix) + z.(nextisfix) + z.(uprob) +
                               z.(fwprob) + z.(bwprob) + z.(r.cw) + z.(r.csurp)+z.(r.tsurp)+z.(r.ent))^2 
      lrform <- ~(z.(lagsentpos) + z.(lagwlen) + z.(lagprevisfix) + z.(lagnextisfix) + z.(laguprob) +
                              z.(lagfwprob) + z.(lagbwprob) + z.(r.lcw) +z.(r.lcsurp)+z.(r.ltsurp)+z.(r.lent))^2

      bform <- clfdur ~ (z.(sentpos) + z.(wlen) + z.(previsfix) + z.(nextisfix) + z.(uprob) + z.(fwprob) +
                                z.(bwprob) + z.(r.cw)+ z.(r.csurp)+z.(r.tsurp)+z.(r.ent))^2 +
                                (z.(lagsentpos) + z.(lagwlen) + z.(lagprevisfix) + z.(laguprob) + z.(lagfwprob) +
                                z.(lagbwprob) + z.(r.lcw)+z.(r.lcsurp)+z.(r.ltsurp)+z.(r.lent))^2 + (1|word) #+ (1|subject)
    }
    else {
...
if (OPTIM == "bobyqa"){
    ...
    baseinteg <- lmer(update.formula(bform,.~.+(1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob) + z.(cumfwprob) +z.(cumwdelta) + z.(totsurp) + z.(cumtotsurp) |subject)), test, REML=F, control = lmerControl(optimizer="bobyqa",optCtrl=list(maxfun=50000)))
    print("Regressing for TOT")
    write("Regressing for TOT",stderr())
    totinteg <- lmer(update.formula(bform,.~.+z.(totsurp) + (1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob) + z.(cumfwprob) +z.(cumwdelta) + z.(totsurp) + z.(cumtotsurp) |subject)), test, REML=F, control = lmerControl(optimizer="bobyqa",optCtrl=list(maxfun=50000)))
    print("Regressing for CUM")
    write("Regressing for CUM",stderr())
    cuminteg <- lmer(update.formula(bform,.~.+z.(cumtotsurp) + (1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob)+ z.(cumfwprob)+z.(cumwdelta) + z.(totsurp) + z.(cumtotsurp)|subject)), test, REML=F, control = lmerControl(optimizer="bobyqa",optCtrl=list(maxfun=50000)))
    print("Regressing Both")
    write("Regressing Both",stderr())
    bothinteg <- lmer(update.formula(bform,.~.+z.(totsurp) + z.(cumtotsurp) + (1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob)+ z.(cumfwprob)+z.(cumwdelta) + z.(totsurp) + z.(cumtotsurp) |subject)), test, REML=F, control = lmerControl(optimizer="bobyqa",optCtrl=list(maxfun=50000)))
  }
#    baseinteg <- lmer(update.formula(bform,.~.+(1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob)+z.(cumwdelta) + z.(cumtotsurp)|subject)), test, REML=F, control = lmerControl(optimizer="Nelder_Mead",optCtrl=list(maxfun=50000)))
...
if (OPTIM == "nlminb"){
     print("Regressing Base")
     write("Regressing Base",stderr())
     baseinteg <- lmer(update.formula(bform,.~.+(1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob)+ z.(cumfwprob)+z.(cumwdelta) + z.(totsurp) + z.(cumtotsurp) |subject)), test, REML=F, control = lmerControl(optimizer="optimx",optCtrl=list(method=c("nlminb"),maxit=50000)))
     print("Regressing TOT")
     write("Regressing TOT",stderr())
     totinteg <- lmer(update.formula(bform,.~.+z.(totsurp) + (1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob)+ z.(cumfwprob)+z.(cumwdelta) + z.(totsurp) + z.(cumtotsurp) |subject)), test, REML=F, control = lmerControl(optimizer="optimx",optCtrl=list(method=c("nlminb"),maxit=50000)))
     print("Regressing CUM")
     write("Regressing CUM",stderr())
     cuminteg <- lmer(update.formula(bform,.~.+z.(cumtotsurp) + (1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob)+ z.(cumfwprob)+z.(cumwdelta) + z.(totsurp) + z.(cumtotsurp) |subject)), test, REML=F, control = lmerControl(optimizer="optimx",optCtrl=list(method=c("nlminb"),maxit=50000)))
     print("Regressing Both")
     write("Regressing Both",stderr())
     bothinteg <- lmer(update.formula(bform,.~.+z.(totsurp) + z.(cumtotsurp) + (1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob)+ z.(cumfwprob)+z.(cumwdelta) + z.(totsurp) + z.(cumtotsurp) |subject)), test, REML=F, control = lmerControl(optimizer="optimx",optCtrl=list(method=c("nlminb"),maxit=50000)))
  }
...
#  baseinteg <- lmer(update.formula(bform,.~.+z.(cuminteg)+(1|subject)), test, REML=F)
    ...
    print("CUM Summary")
    print(summary(cuminteg))
    print("CUM Log Likelihood")
    print(logLik(cuminteg))
    relgrad <- with(cuminteg@optinfo$derivs,solve(Hessian,gradient))
    print("Relative Gradient (<0.001?)") #check for convergence even if warned that convergence failed
    print(max(abs(relgrad)))
    print("CUM AIC")
    print(AIC(logLik(cuminteg)))

    print("TOT Summary")
    print(summary(totinteg))
    print("TOT Log Likelihood")
    print(logLik(totinteg))
    relgrad <- with(totinteg@optinfo$derivs,solve(Hessian,gradient))
    print("Relative Gradient (<0.001?)") #check for convergence even if warned that convergence failed
    print(max(abs(relgrad)))
    print("TOT AIC")
    print(AIC(logLik(totinteg)))
    ...
    print("Base vs CUM")
    print(anova(baseinteg,cuminteg))
    print("Base vs TOT")
    print(anova(baseinteg,totinteg))
    print("CUM vs Both")
    print(anova(cuminteg,bothinteg))
    print("TOT vs Both")
    print(anova(totinteg,bothinteg))
