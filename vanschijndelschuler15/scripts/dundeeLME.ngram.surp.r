...
#                                z.(lagbwprob) + z.(lagcumwdelta))^2 + (1|word)
      if (! NOGRAMMAR & ! 'gcgtotsurp' %in% colnames(test) ) {
             bform <- clfdur ~ z.(sentpos) + z.(wlen) + z.(prevwasfix) + z.(fwprob) +
                                z.(cumwdelta) + (1|word) + z.(totsurp)
				}
      else {
             bform <- clfdur ~ z.(sentpos) + z.(wlen) + z.(prevwasfix) + z.(fwprob) +
                                z.(cumwdelta) + (1|word)
...
if (OPTIM == "bobyqa"){
    ...
    baseinteg <- lmer(update.formula(bform,.~.+(1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob)+z.(cumwdelta) + z.(totsurp) + z.(cumtotsurp) |subject)), test, REML=F, control = lmerControl(optimizer="bobyqa",optCtrl=list(maxfun=50000)))
    print("Regressing for TOT")
    write("Regressing for TOT",stderr())
    totinteg <- lmer(update.formula(bform,.~.+z.(totsurp) + (1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob)+z.(cumwdelta) + z.(totsurp) + z.(cumtotsurp) |subject)), test, REML=F, control = lmerControl(optimizer="bobyqa",optCtrl=list(maxfun=50000)))
    print("Regressing for CUM")
    write("Regressing for CUM",stderr())
    cuminteg <- lmer(update.formula(bform,.~.+z.(cumtotsurp) + (1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob)+z.(cumwdelta) + z.(totsurp) + z.(cumtotsurp)|subject)), test, REML=F, control = lmerControl(optimizer="bobyqa",optCtrl=list(maxfun=50000)))
    print("Regressing Both")
    write("Regressing Both",stderr())
    bothinteg <- lmer(update.formula(bform,.~.+z.(totsurp) + z.(cumtotsurp) + (1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob)+z.(cumwdelta) + z.(totsurp) + z.(cumtotsurp) |subject)), test, REML=F, control = lmerControl(optimizer="bobyqa",optCtrl=list(maxfun=50000)))
  }
...
if (OPTIM == "nlminb"){
     print("Regressing Base")
     write("Regressing Base",stderr())
     baseinteg <- lmer(update.formula(bform,.~.+(1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob)+z.(cumwdelta) + z.(totsurp) + z.(cumtotsurp) |subject)), test, REML=F, control = lmerControl(optimizer="optimx",optCtrl=list(method=c("nlminb"),maxit=50000)))
     print("Regressing TOT")
     write("Regressing TOT",stderr())
     totinteg <- lmer(update.formula(bform,.~.+z.(totsurp) + (1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob)+z.(cumwdelta) + z.(totsurp) + z.(cumtotsurp) |subject)), test, REML=F, control = lmerControl(optimizer="optimx",optCtrl=list(method=c("nlminb"),maxit=50000)))
     print("Regressing CUM")
     write("Regressing CUM",stderr())
     cuminteg <- lmer(update.formula(bform,.~.+z.(cumtotsurp) + (1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob)+z.(cumwdelta) + z.(totsurp) + z.(cumtotsurp) |subject)), test, REML=F, control = lmerControl(optimizer="optimx",optCtrl=list(method=c("nlminb"),maxit=50000)))
     print("Regressing Both")
     write("Regressing Both",stderr())
     bothinteg <- lmer(update.formula(bform,.~.+z.(totsurp) + z.(cumtotsurp) + (1+z.(sentpos)+z.(wlen)+z.(prevwasfix)+z.(fwprob)+z.(cumwdelta) + z.(totsurp) + z.(cumtotsurp) |subject)), test, REML=F, control = lmerControl(optimizer="optimx",optCtrl=list(method=c("nlminb"),maxit=50000)))
  }
