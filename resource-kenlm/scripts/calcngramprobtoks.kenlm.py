...
for ix in range(0,len(fwlines)):
  corpus.append( {'word':fwlines[ix][0], 'uprob':0.0, 'fwprob':fwlines[ix][1], 'bwprob':0.0, 'sentpos':fwlines[ix][4], 'startofsentence':fwlines[ix][2], 'endofsentence':fwlines[ix][3], 'sentid':fwlines[ix][5]} )
  if 'uprobs' in OPTS:
...
header = ['word','uprob','bwprob','fwprob','startofsentence','endofsentence','sentpos','sentid']
